System.register(['./coordinates-converts-utils-fa8f5fc5.js', './renderable-component-7d3cd284.js', './json-asset-17eaf8ce.js', './texture-buffer-pool-36a70aeb.js', './mesh-dc73eca6.js'], function (exports) {
    'use strict';
    var _inheritsLoose, Enum, ccclass, formerlySerializedAs, _createClass, _applyDecoratedDescriptor, editable, type, tooltip, visible, executeInEditMode, _initializerDefineProperty, _assertThisInitialized, legacyCC, assertIsTrue, disallowAnimation, serializable, Vec4, help, executionOrder, menu, Model, TransformBit, RenderableComponent, builtinResMgr, Mesh;
    return {
