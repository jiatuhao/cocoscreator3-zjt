System.register(['./coordinates-converts-utils-fa8f5fc5.js', './renderable-component-7d3cd284.js', './find-c704a59e.js', './json-asset-17eaf8ce.js', './texture-buffer-pool-36a70aeb.js', './transform-utils-c1853224.js', './create-mesh-4e3ca30e.js', './mesh-dc73eca6.js', './mesh-renderer-46fd0b14.js', './skeleton-a4f2c933.js'], function (exports) {
    'use strict';
    var Mat4, removeProperty, legacyCC, js, Enum, Vec3, ccclass, _createClass, _applyDecoratedDescriptor, editable, tooltip, range, type, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, Component, slide, serializable, Color, unit, executeInEditMode, help, menu, toRadian, Quat, Filter, Address, FormatInfos, Feature, Format, BufferInfo, BufferUsageBit, MemoryUsageBit, UBOSkinningAnimation, _createForOfIteratorHelperLoose, AABBPool, AABBView, UBOSkinning, UBOSkinningTexture, UNIFORM_JOINT_TEXTURE_BINDING, INST_JOINT_ANIM_INFO, executionOrder, Attribute, AttributeName, CCString, visible, BufferTextureCopy, Vec2, Type, LightType, Light$1, DirectionalLight$1, SphereLight$1, nt2lm, SpotLight$1, ModelType, Node, find, AABB, readBuffer, writeBuffer, mapBuffer, genSamplerHash, samplerLib, Material, Texture2D, Filter$1, PixelFormat, override, TextureBufferPool, getWorldTransformUntilRoot, SkelAnimDataHub, deleteTransform, getTransform, getWorldMatrix, AnimationState, Animation, readMesh, createMesh, Mesh, MeshRenderer, MorphModel, Skeleton;
    return {
        setters: [function (module) {
            ...
            SphereLight$1 = module.m;
            nt2lm = module.n;
            SpotLight$1 = module.o;
            ModelType = module.M;
            Node = module.N;
        }, function (module) {
            find = module.f;
