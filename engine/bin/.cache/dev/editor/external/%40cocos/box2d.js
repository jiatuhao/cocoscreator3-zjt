...
var _commonjsHelpers = require('../_commonjsHelpers-610b73d6.js');
var _rollupPluginBabelHelpers = require('../_rollupPluginBabelHelpers-c6b52eee.js');

var box2d_umd=_commonjsHelpers.createCommonjsModule(function(module,exports){(function(global,factory){factory(exports);})(_commonjsHelpers.commonjsGlobal,function(exports){/*
...
throw _rollupPluginBabelHelpers._construct(Error,args);}}function b2Maybe(value,def){return value!==undefined?value:def;}var b2_maxFloat=1E+37;// FLT_MAX instead of Number.MAX_VALUE;
...
var b2Version=/*#__PURE__*/function(){function b2Version(){var major=arguments.length>0&&arguments[0]!==undefined?arguments[0]:0;var minor=arguments.length>1&&arguments[1]!==undefined?arguments[1]:0;var revision=arguments.length>2&&arguments[2]!==undefined?arguments[2]:0;_rollupPluginBabelHelpers._classCallCheck(this,b2Version);this.major=0;///< significant changes
this.minor=0;///< incremental changes
this.revision=0;///< bug fixes
this.major=major;this.minor=minor;this.revision=revision;}_rollupPluginBabelHelpers._createClass(b2Version,[{key:"toString",value:function toString(){return this.major+"."+this.minor+"."+this.revision;}}]);return b2Version;}();/// Current version.
...
var b2Sweep=/*#__PURE__*/function(){function b2Sweep(){_rollupPluginBabelHelpers._classCallCheck(this,b2Sweep);this.localCenter=new b2Vec2();this.c0=new b2Vec2();this.c=new b2Vec2();this.a0=0;this.a=0;this.alpha0=0;}_rollupPluginBabelHelpers._createClass(b2Sweep,[{key:"Clone",value:function Clone(){return new b2Sweep().Copy(this);}},{key:"Copy",value:function Copy(other){this.localCenter.Copy(other.localCenter);this.c0.Copy(other.c0);this.c.Copy(other.c);this.a0=other.a0;this.a=other.a;this.alpha0=other.alpha0;return this;}},{key:"GetTransform",value:function GetTransform(xf,beta){var one_minus_beta=1-beta;xf.p.x=one_minus_beta*this.c0.x+beta*this.c.x;xf.p.y=one_minus_beta*this.c0.y+beta*this.c.y;var angle=one_minus_beta*this.a0+beta*this.a;xf.q.SetAngle(angle);xf.p.SelfSub(b2Rot.MulRV(xf.q,this.localCenter,b2Vec2.s_t0));return xf;}},{key:"Advance",value:function Advance(alpha){// DEBUG: b2Assert(this.alpha0 < 1);
...
var b2Timer=/*#__PURE__*/function(){function b2Timer(){_rollupPluginBabelHelpers._classCallCheck(this,b2Timer);this.m_start=Date.now();}/// Reset the timer.
_rollupPluginBabelHelpers._createClass(b2Timer,[{key:"Reset",value:function Reset(){this.m_start=Date.now();return this;}/// Get the time since construction or the last reset.
},{key:"GetMilliseconds",value:function GetMilliseconds(){return Date.now()-this.m_start;}}]);return b2Timer;}();var b2Counter=/*#__PURE__*/function(){function b2Counter(){_rollupPluginBabelHelpers._classCallCheck(this,b2Counter);this.m_count=0;this.m_min_count=0;this.m_max_count=0;}_rollupPluginBabelHelpers._createClass(b2Counter,[{key:"GetCount",value:function GetCount(){return this.m_count;}},{key:"GetMinCount",value:function GetMinCount(){return this.m_min_count;}},{key:"GetMaxCount",value:function GetMaxCount(){return this.m_max_count;}},{key:"ResetCount",value:function ResetCount(){var count=this.m_count;this.m_count=0;return count;}},{key:"ResetMinCount",value:function ResetMinCount(){this.m_min_count=0;}},{key:"ResetMaxCount",value:function ResetMaxCount(){this.m_max_count=0;}},{key:"Increment",value:function Increment(){this.m_count++;if(this.m_max_count<this.m_count){this.m_max_count=this.m_count;}}},{key:"Decrement",value:function Decrement(){this.m_count--;if(this.m_min_count>this.m_count){this.m_min_count=this.m_count;}}}]);return b2Counter;}();/*
...
var b2GrowableStack=/*#__PURE__*/function(){function b2GrowableStack(N){_rollupPluginBabelHelpers._classCallCheck(this,b2GrowableStack);this.m_stack=[];this.m_count=0;this.m_stack=b2MakeArray(N,function(index){return null;});this.m_count=0;}_rollupPluginBabelHelpers._createClass(b2GrowableStack,[{key:"Reset",value:function Reset(){this.m_count=0;return this;}},{key:"Push",value:function Push(element){this.m_stack[this.m_count]=element;this.m_count++;}},{key:"Pop",value:function Pop(){// DEBUG: b2Assert(this.m_count > 0);
this.m_count--;var element=this.m_stack[this.m_count];this.m_stack[this.m_count]=null;if(element===null){throw new Error();}return element;}},{key:"GetCount",value:function GetCount(){return this.m_count;}}]);return b2GrowableStack;}();/*
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2BlockAllocator=function b2BlockAllocator(){_rollupPluginBabelHelpers._classCallCheck(this,b2BlockAllocator);};/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2StackAllocator=function b2StackAllocator(){_rollupPluginBabelHelpers._classCallCheck(this,b2StackAllocator);};/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
...
var b2DistanceProxy=/*#__PURE__*/function(){function b2DistanceProxy(){_rollupPluginBabelHelpers._classCallCheck(this,b2DistanceProxy);this.m_buffer=b2Vec2.MakeArray(2);this.m_vertices=this.m_buffer;this.m_count=0;this.m_radius=0;}_rollupPluginBabelHelpers._createClass(b2DistanceProxy,[{key:"Copy",value:function Copy(other){if(other.m_vertices===other.m_buffer){this.m_vertices=this.m_buffer;this.m_buffer[0].Copy(other.m_buffer[0]);this.m_buffer[1].Copy(other.m_buffer[1]);}else {this.m_vertices=other.m_vertices;}this.m_count=other.m_count;this.m_radius=other.m_radius;return this;}},{key:"Reset",value:function Reset(){this.m_vertices=this.m_buffer;this.m_count=0;this.m_radius=0;return this;}},{key:"SetShape",value:function SetShape(shape,index){shape.SetupDistanceProxy(this,index);}},{key:"SetVerticesRadius",value:function SetVerticesRadius(vertices,count,radius){this.m_vertices=vertices;this.m_count=count;this.m_radius=radius;}},{key:"GetSupport",value:function GetSupport(d){var bestIndex=0;var bestValue=b2Vec2.DotVV(this.m_vertices[0],d);for(var i=1;i<this.m_count;++i){var value=b2Vec2.DotVV(this.m_vertices[i],d);if(value>bestValue){bestIndex=i;bestValue=value;}}return bestIndex;}},{key:"GetSupportVertex",value:function GetSupportVertex(d){var bestIndex=0;var bestValue=b2Vec2.DotVV(this.m_vertices[0],d);for(var i=1;i<this.m_count;++i){var value=b2Vec2.DotVV(this.m_vertices[i],d);if(value>bestValue){bestIndex=i;bestValue=value;}}return this.m_vertices[bestIndex];}},{key:"GetVertexCount",value:function GetVertexCount(){return this.m_count;}},{key:"GetVertex",value:function GetVertex(index){// DEBUG: b2Assert(0 <= index && index < this.m_count);
return this.m_vertices[index];}}]);return b2DistanceProxy;}();var b2SimplexCache=/*#__PURE__*/function(){function b2SimplexCache(){_rollupPluginBabelHelpers._classCallCheck(this,b2SimplexCache);this.metric=0;this.count=0;this.indexA=[0,0,0];this.indexB=[0,0,0];}_rollupPluginBabelHelpers._createClass(b2SimplexCache,[{key:"Reset",value:function Reset(){this.metric=0;this.count=0;return this;}}]);return b2SimplexCache;}();var b2DistanceInput=/*#__PURE__*/function(){function b2DistanceInput(){_rollupPluginBabelHelpers._classCallCheck(this,b2DistanceInput);this.proxyA=new b2DistanceProxy();this.proxyB=new b2DistanceProxy();this.transformA=new b2Transform();this.transformB=new b2Transform();this.useRadii=false;}_rollupPluginBabelHelpers._createClass(b2DistanceInput,[{key:"Reset",value:function Reset(){this.proxyA.Reset();this.proxyB.Reset();this.transformA.SetIdentity();this.transformB.SetIdentity();this.useRadii=false;return this;}}]);return b2DistanceInput;}();var b2DistanceOutput=/*#__PURE__*/function(){function b2DistanceOutput(){_rollupPluginBabelHelpers._classCallCheck(this,b2DistanceOutput);this.pointA=new b2Vec2();this.pointB=new b2Vec2();this.distance=0;this.iterations=0;///< number of GJK iterations used
}_rollupPluginBabelHelpers._createClass(b2DistanceOutput,[{key:"Reset",value:function Reset(){this.pointA.SetZero();this.pointB.SetZero();this.distance=0;this.iterations=0;return this;}}]);return b2DistanceOutput;}();/// Input parameters for b2ShapeCast
var b2ShapeCastInput=function b2ShapeCastInput(){_rollupPluginBabelHelpers._classCallCheck(this,b2ShapeCastInput);this.proxyA=new b2DistanceProxy();this.proxyB=new b2DistanceProxy();this.transformA=new b2Transform();this.transformB=new b2Transform();this.translationB=new b2Vec2();};/// Output results for b2ShapeCast
var b2ShapeCastOutput=function b2ShapeCastOutput(){_rollupPluginBabelHelpers._classCallCheck(this,b2ShapeCastOutput);this.point=new b2Vec2();this.normal=new b2Vec2();this.lambda=0.0;this.iterations=0;};exports.b2_gjkCalls=0;exports.b2_gjkIters=0;exports.b2_gjkMaxIters=0;function b2_gjk_reset(){exports.b2_gjkCalls=0;exports.b2_gjkIters=0;exports.b2_gjkMaxIters=0;}var b2SimplexVertex=/*#__PURE__*/function(){function b2SimplexVertex(){_rollupPluginBabelHelpers._classCallCheck(this,b2SimplexVertex);this.wA=new b2Vec2();// support point in proxyA
...
}_rollupPluginBabelHelpers._createClass(b2SimplexVertex,[{key:"Copy",value:function Copy(other){this.wA.Copy(other.wA);// support point in proxyA
...
return this;}}]);return b2SimplexVertex;}();var b2Simplex=/*#__PURE__*/function(){function b2Simplex(){_rollupPluginBabelHelpers._classCallCheck(this,b2Simplex);this.m_v1=new b2SimplexVertex();this.m_v2=new b2SimplexVertex();this.m_v3=new b2SimplexVertex();this.m_vertices=[/*3*/];this.m_count=0;this.m_vertices[0]=this.m_v1;this.m_vertices[1]=this.m_v2;this.m_vertices[2]=this.m_v3;}_rollupPluginBabelHelpers._createClass(b2Simplex,[{key:"ReadCache",value:function ReadCache(cache,proxyA,transformA,proxyB,transformB){// DEBUG: b2Assert(0 <= cache.count && cache.count <= 3);
...
var b2ManifoldPoint=/*#__PURE__*/function(){function b2ManifoldPoint(){_rollupPluginBabelHelpers._classCallCheck(this,b2ManifoldPoint);this.localPoint=new b2Vec2();///< usage depends on manifold type
...
/// This structure is stored across time steps, so we keep it small.
var b2Manifold=/*#__PURE__*/function(){function b2Manifold(){_rollupPluginBabelHelpers._classCallCheck(this,b2Manifold);this.points=b2ManifoldPoint.MakeArray(b2_maxManifoldPoints);this.localNormal=new b2Vec2();this.localPoint=new b2Vec2();this.type=exports.b2ManifoldType.e_unknown;this.pointCount=0;}_rollupPluginBabelHelpers._createClass(b2Manifold,[{key:"Reset",value:function Reset(){for(var i=0;i<b2_maxManifoldPoints;++i){// DEBUG: b2Assert(this.points[i] instanceof b2ManifoldPoint);
...
var b2ClipVertex=/*#__PURE__*/function(){function b2ClipVertex(){_rollupPluginBabelHelpers._classCallCheck(this,b2ClipVertex);this.v=new b2Vec2();this.id=new b2ContactID();}_rollupPluginBabelHelpers._createClass(b2ClipVertex,[{key:"Copy",value:function Copy(other){this.v.Copy(other.v);this.id.Copy(other.id);return this;}}],[{key:"MakeArray",value:function MakeArray(length){return b2MakeArray(length,function(i){return new b2ClipVertex();});}}]);return b2ClipVertex;}();/// Ray-cast input data. The ray extends from p1 to p1 + maxFraction * (p2 - p1).
var b2RayCastInput=/*#__PURE__*/function(){function b2RayCastInput(){_rollupPluginBabelHelpers._classCallCheck(this,b2RayCastInput);this.p1=new b2Vec2();this.p2=new b2Vec2();this.maxFraction=1;}_rollupPluginBabelHelpers._createClass(b2RayCastInput,[{key:"Copy",value:function Copy(o){this.p1.Copy(o.p1);this.p2.Copy(o.p2);this.maxFraction=o.maxFraction;return this;}}]);return b2RayCastInput;}();/// Ray-cast output data. The ray hits at p1 + fraction * (p2 - p1), where p1 and p2
/// come from b2RayCastInput.
var b2RayCastOutput=/*#__PURE__*/function(){function b2RayCastOutput(){_rollupPluginBabelHelpers._classCallCheck(this,b2RayCastOutput);this.normal=new b2Vec2();this.fraction=0;}_rollupPluginBabelHelpers._createClass(b2RayCastOutput,[{key:"Copy",value:function Copy(o){this.normal.Copy(o.normal);this.fraction=o.fraction;return this;}}]);return b2RayCastOutput;}();/// An axis aligned bounding box.
var b2AABB=/*#__PURE__*/function(){function b2AABB(){_rollupPluginBabelHelpers._classCallCheck(this,b2AABB);this.lowerBound=new b2Vec2();///< the lower vertex
...
}_rollupPluginBabelHelpers._createClass(b2AABB,[{key:"Copy",value:function Copy(o){this.lowerBound.Copy(o.lowerBound);this.upperBound.Copy(o.upperBound);return this;}/// Verify that the bounds are sorted.
...
},{key:"Combine2",value:function Combine2(aabb1,aabb2){this.lowerBound.x=b2Min(aabb1.lowerBound.x,aabb2.lowerBound.x);this.lowerBound.y=b2Min(aabb1.lowerBound.y,aabb2.lowerBound.y);this.upperBound.x=b2Max(aabb1.upperBound.x,aabb2.upperBound.x);this.upperBound.y=b2Max(aabb1.upperBound.y,aabb2.upperBound.y);return this;}},{key:"Contains",/// Does this aabb contain the provided AABB.
value:function Contains(aabb){if(this.lowerBound.x<=aabb.lowerBound.x){return false;}if(this.lowerBound.y<=aabb.lowerBound.y){return false;}if(aabb.upperBound.x<=this.upperBound.x){return false;}if(aabb.upperBound.y<=this.upperBound.y){return false;}return true;}// From Real-time Collision Detection, p179.
...
var b2TreeNode=/*#__PURE__*/function(){function b2TreeNode(){var id=arguments.length>0&&arguments[0]!==undefined?arguments[0]:0;_rollupPluginBabelHelpers._classCallCheck(this,b2TreeNode);this.m_id=0;this.aabb=new b2AABB();this._userData=null;this.parent=null;// or next
this.child1=null;this.child2=null;this.height=0;// leaf = 0, free node = -1
this.m_id=id;}_rollupPluginBabelHelpers._createClass(b2TreeNode,[{key:"Reset",value:function Reset(){this._userData=null;}},{key:"IsLeaf",value:function IsLeaf(){return this.child1===null;}},{key:"userData",get:function get(){if(this._userData===null){throw new Error();}return this._userData;},set:function set(value){if(this._userData!==null){throw new Error();}this._userData=value;}}]);return b2TreeNode;}();var b2DynamicTree=/*#__PURE__*/function(){function b2DynamicTree(){_rollupPluginBabelHelpers._classCallCheck(this,b2DynamicTree);this.m_root=null;// b2TreeNode* public m_nodes;
...
_rollupPluginBabelHelpers._createClass(b2BroadPhase,[{key:"CreateProxy",value:function CreateProxy(aabb,userData){var proxy=this.m_tree.CreateProxy(aabb,userData);++this.m_proxyCount;this.BufferMove(proxy);return proxy;}/// Destroy a proxy. It is up to the client to remove any pairs.
...
var _loop=function _loop(_i3){var queryProxy=_this.m_moveBuffer[_i3];if(queryProxy===null){return "continue";}// This is called from box2d.b2DynamicTree::Query when we are gathering pairs.
...
var b2TOIInput=function b2TOIInput(){_rollupPluginBabelHelpers._classCallCheck(this,b2TOIInput);this.proxyA=new b2DistanceProxy();this.proxyB=new b2DistanceProxy();this.sweepA=new b2Sweep();this.sweepB=new b2Sweep();this.tMax=0;// defines sweep interval [0, tMax]
};(function(b2TOIOutputState){b2TOIOutputState[b2TOIOutputState["e_unknown"]=0]="e_unknown";b2TOIOutputState[b2TOIOutputState["e_failed"]=1]="e_failed";b2TOIOutputState[b2TOIOutputState["e_overlapped"]=2]="e_overlapped";b2TOIOutputState[b2TOIOutputState["e_touching"]=3]="e_touching";b2TOIOutputState[b2TOIOutputState["e_separated"]=4]="e_separated";})(exports.b2TOIOutputState||(exports.b2TOIOutputState={}));var b2TOIOutput=function b2TOIOutput(){_rollupPluginBabelHelpers._classCallCheck(this,b2TOIOutput);this.state=exports.b2TOIOutputState.e_unknown;this.t=0;};(function(b2SeparationFunctionType){b2SeparationFunctionType[b2SeparationFunctionType["e_unknown"]=-1]="e_unknown";b2SeparationFunctionType[b2SeparationFunctionType["e_points"]=0]="e_points";b2SeparationFunctionType[b2SeparationFunctionType["e_faceA"]=1]="e_faceA";b2SeparationFunctionType[b2SeparationFunctionType["e_faceB"]=2]="e_faceB";})(exports.b2SeparationFunctionType||(exports.b2SeparationFunctionType={}));var b2SeparationFunction=/*#__PURE__*/function(){function b2SeparationFunction(){_rollupPluginBabelHelpers._classCallCheck(this,b2SeparationFunction);this.m_sweepA=new b2Sweep();this.m_sweepB=new b2Sweep();this.m_type=exports.b2SeparationFunctionType.e_unknown;this.m_localPoint=new b2Vec2();this.m_axis=new b2Vec2();}_rollupPluginBabelHelpers._createClass(b2SeparationFunction,[{key:"Initialize",value:function Initialize(cache,proxyA,sweepA,proxyB,sweepB,t1){this.m_proxyA=proxyA;this.m_proxyB=proxyB;var count=cache.count;// DEBUG: b2Assert(0 < count && count < 3);
...
var b2MassData=function b2MassData(){_rollupPluginBabelHelpers._classCallCheck(this,b2MassData);/// The mass of the shape, usually in kilograms.
...
var b2Shape=/*#__PURE__*/function(){function b2Shape(type,radius){_rollupPluginBabelHelpers._classCallCheck(this,b2Shape);this.m_type=exports.b2ShapeType.e_unknown;/// Radius of a shape. For polygonal shapes this must be b2_polygonRadius. There is no support for
/// making rounded polygons.
this.m_radius=0;this.m_type=type;this.m_radius=radius;}_rollupPluginBabelHelpers._createClass(b2Shape,[{key:"Copy",value:function Copy(other){// DEBUG: b2Assert(this.m_type === other.m_type);
...
/// @return the shape type.
  ...
  * 3. This notice may not be removed or altered from any source distribution.
  */ /// A circle shape.
var b2CircleShape=/*#__PURE__*/function(_b2Shape){_rollupPluginBabelHelpers._inherits(b2CircleShape,_b2Shape);function b2CircleShape(){var _this2;var radius=arguments.length>0&&arguments[0]!==undefined?arguments[0]:0;_rollupPluginBabelHelpers._classCallCheck(this,b2CircleShape);_this2=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2CircleShape).call(this,exports.b2ShapeType.e_circleShape,radius));_this2.m_p=new b2Vec2();return _this2;}_rollupPluginBabelHelpers._createClass(b2CircleShape,[{key:"Set",value:function Set(position){var radius=arguments.length>1&&arguments[1]!==undefined?arguments[1]:this.m_radius;this.m_p.Copy(position);this.m_radius=radius;return this;}/// Implement b2Shape.
},{key:"Clone",value:function Clone(){return new b2CircleShape().Copy(this);}},{key:"Copy",value:function Copy(other){_rollupPluginBabelHelpers._get(_rollupPluginBabelHelpers._getPrototypeOf(b2CircleShape.prototype),"Copy",this).call(this,other);// DEBUG: b2Assert(other instanceof b2CircleShape);
...
var b2PolygonShape=/*#__PURE__*/function(_b2Shape2){_rollupPluginBabelHelpers._inherits(b2PolygonShape,_b2Shape2);function b2PolygonShape(){var _this3;_rollupPluginBabelHelpers._classCallCheck(this,b2PolygonShape);_this3=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2PolygonShape).call(this,exports.b2ShapeType.e_polygonShape,b2_polygonRadius));_this3.m_centroid=new b2Vec2(0,0);_this3.m_vertices=[];_this3.m_normals=[];_this3.m_count=0;return _this3;}/// Implement b2Shape.
_rollupPluginBabelHelpers._createClass(b2PolygonShape,[{key:"Clone",value:function Clone(){return new b2PolygonShape().Copy(this);}},{key:"Copy",value:function Copy(other){_rollupPluginBabelHelpers._get(_rollupPluginBabelHelpers._getPrototypeOf(b2PolygonShape.prototype),"Copy",this).call(this,other);// DEBUG: b2Assert(other instanceof b2PolygonShape);
...
var b2EdgeShape=/*#__PURE__*/function(_b2Shape3){_rollupPluginBabelHelpers._inherits(b2EdgeShape,_b2Shape3);function b2EdgeShape(){var _this4;_rollupPluginBabelHelpers._classCallCheck(this,b2EdgeShape);_this4=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2EdgeShape).call(this,exports.b2ShapeType.e_edgeShape,b2_polygonRadius));_this4.m_vertex1=new b2Vec2();_this4.m_vertex2=new b2Vec2();_this4.m_vertex0=new b2Vec2();_this4.m_vertex3=new b2Vec2();_this4.m_hasVertex0=false;_this4.m_hasVertex3=false;return _this4;}/// Set this as an isolated edge.
_rollupPluginBabelHelpers._createClass(b2EdgeShape,[{key:"Set",value:function Set(v1,v2){this.m_vertex1.Copy(v1);this.m_vertex2.Copy(v2);this.m_hasVertex0=false;this.m_hasVertex3=false;return this;}/// Implement b2Shape.
},{key:"Clone",value:function Clone(){return new b2EdgeShape().Copy(this);}},{key:"Copy",value:function Copy(other){_rollupPluginBabelHelpers._get(_rollupPluginBabelHelpers._getPrototypeOf(b2EdgeShape.prototype),"Copy",this).call(this,other);// DEBUG: b2Assert(other instanceof b2EdgeShape);
...
var b2ChainShape=/*#__PURE__*/function(_b2Shape4){_rollupPluginBabelHelpers._inherits(b2ChainShape,_b2Shape4);function b2ChainShape(){var _this5;_rollupPluginBabelHelpers._classCallCheck(this,b2ChainShape);_this5=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2ChainShape).call(this,exports.b2ShapeType.e_chainShape,b2_polygonRadius));_this5.m_vertices=[];_this5.m_count=0;_this5.m_prevVertex=new b2Vec2();_this5.m_nextVertex=new b2Vec2();_this5.m_hasPrevVertex=false;_this5.m_hasNextVertex=false;return _this5;}_rollupPluginBabelHelpers._createClass(b2ChainShape,[{key:"CreateLoop",value:function CreateLoop(){for(var _len6=arguments.length,args=new Array(_len6),_key7=0;_key7<_len6;_key7++){args[_key7]=arguments[_key7];}if(typeof args[0][0]==="number"){var vertices=args[0];if(vertices.length%2!==0){throw new Error();}return this._CreateLoop(function(index){return {x:vertices[index*2],y:vertices[index*2+1]};},vertices.length/2);}else {var _vertices2=args[0];var count=args[1]||_vertices2.length;return this._CreateLoop(function(index){return _vertices2[index];},count);}}},{key:"_CreateLoop",value:function _CreateLoop(vertices,count){// DEBUG: b2Assert(count >= 3);
...
},{key:"Clone",value:function Clone(){return new b2ChainShape().Copy(this);}},{key:"Copy",value:function Copy(other){_rollupPluginBabelHelpers._get(_rollupPluginBabelHelpers._getPrototypeOf(b2ChainShape.prototype),"Copy",this).call(this,other);// DEBUG: b2Assert(other instanceof b2ChainShape);
...
var b2Filter=/*#__PURE__*/function(){function b2Filter(){_rollupPluginBabelHelpers._classCallCheck(this,b2Filter);/// The collision category bits. Normally you would just set one bit.
...
this.groupIndex=0;}_rollupPluginBabelHelpers._createClass(b2Filter,[{key:"Clone",value:function Clone(){return new b2Filter().Copy(this);}},{key:"Copy",value:function Copy(other){// DEBUG: b2Assert(this !== other);
...
var b2FixtureDef=function b2FixtureDef(){_rollupPluginBabelHelpers._classCallCheck(this,b2FixtureDef);/// Use this to store application specific fixture data.
...
var b2Fixture=/*#__PURE__*/function(){function b2Fixture(body,def){_rollupPluginBabelHelpers._classCallCheck(this,b2Fixture);this.m_density=0;this.m_next=null;this.m_friction=0;this.m_restitution=0;this.m_proxies=[];this.m_filter=new b2Filter();this.m_isSensor=false;this.m_userData=null;this.m_body=body;this.m_shape=def.shape.Clone();this.m_userData=b2Maybe(def.userData,null);this.m_friction=b2Maybe(def.friction,0.2);this.m_restitution=b2Maybe(def.restitution,0);this.m_filter.Copy(b2Maybe(def.filter,b2Filter.DEFAULT));this.m_isSensor=b2Maybe(def.isSensor,false);this.m_density=b2Maybe(def.density,0);}_rollupPluginBabelHelpers._createClass(b2Fixture,[{key:"Reset",value:function Reset(){// The proxies must be destroyed before calling this.
...
var _iterator=_rollupPluginBabelHelpers._createForOfIteratorHelper(this.m_proxies),_step;try{for(_iterator.s();!(_step=_iterator.n()).done;){var proxy=_step.value;proxy.Reset();}}catch(err){_iterator.e(err);}finally{_iterator.f();}this.m_proxies.length=0;}},{key:"TouchProxies",value:function TouchProxies(){var _iterator2=_rollupPluginBabelHelpers._createForOfIteratorHelper(this.m_proxies),_step2;try{for(_iterator2.s();!(_step2=_iterator2.n()).done;){var proxy=_step2.value;proxy.Touch();}}catch(err){_iterator2.e(err);}finally{_iterator2.f();}}},{key:"SynchronizeProxies",value:function SynchronizeProxies(transform1,transform2,displacement){var _iterator3=_rollupPluginBabelHelpers._createForOfIteratorHelper(this.m_proxies),_step3;try{for(_iterator3.s();!(_step3=_iterator3.n()).done;){var proxy=_step3.value;proxy.Synchronize(transform1,transform2,displacement);}}catch(err){_iterator3.e(err);}finally{_iterator3.f();}}},{key:"m_proxyCount",get:function get(){return this.m_proxies.length;}}]);return b2Fixture;}();/*
...
var b2BodyDef=function b2BodyDef(){_rollupPluginBabelHelpers._classCallCheck(this,b2BodyDef);/// The body type: static, kinematic, or dynamic.
...
function b2Body(bd,world){_rollupPluginBabelHelpers._classCallCheck(this,b2Body);this.m_type=exports.b2BodyType.b2_staticBody;this.m_islandFlag=false;this.m_awakeFlag=false;this.m_autoSleepFlag=false;this.m_bulletFlag=false;this.m_fixedRotationFlag=false;this.m_activeFlag=false;this.m_toiFlag=false;this.m_islandIndex=0;this.m_xf=new b2Transform();// the body origin transform
...
this.joint=joint;}_rollupPluginBabelHelpers._createClass(b2JointEdge,[{key:"Reset",value:function Reset(){this._other=null;this.prev=null;this.next=null;}},{key:"other",get:function get(){if(this._other===null){throw new Error();}return this._other;},set:function set(value){if(this._other!==null){throw new Error();}this._other=value;}}]);return b2JointEdge;}();/// Joint definitions are used to construct joints.
var b2JointDef=function b2JointDef(type){_rollupPluginBabelHelpers._classCallCheck(this,b2JointDef);/// The joint type is set automatically for concrete joint types.
...
var b2Joint=/*#__PURE__*/function(){function b2Joint(def){_rollupPluginBabelHelpers._classCallCheck(this,b2Joint);// DEBUG: b2Assert(def.bodyA !== def.bodyB);
...
_rollupPluginBabelHelpers._createClass(b2Joint,[{key:"GetType",value:function GetType(){return this.m_type;}/// Get the first body attached to this joint.
...
var b2DistanceJointDef=/*#__PURE__*/function(_b2JointDef){_rollupPluginBabelHelpers._inherits(b2DistanceJointDef,_b2JointDef);function b2DistanceJointDef(){var _this6;_rollupPluginBabelHelpers._classCallCheck(this,b2DistanceJointDef);_this6=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2DistanceJointDef).call(this,exports.b2JointType.e_distanceJoint));_this6.localAnchorA=new b2Vec2();_this6.localAnchorB=new b2Vec2();_this6.length=1;_this6.frequencyHz=0;_this6.dampingRatio=0;return _this6;}_rollupPluginBabelHelpers._createClass(b2DistanceJointDef,[{key:"Initialize",value:function Initialize(b1,b2,anchor1,anchor2){this.bodyA=b1;this.bodyB=b2;this.bodyA.GetLocalPoint(anchor1,this.localAnchorA);this.bodyB.GetLocalPoint(anchor2,this.localAnchorB);this.length=b2Vec2.DistanceVV(anchor1,anchor2);this.frequencyHz=0;this.dampingRatio=0;}}]);return b2DistanceJointDef;}(b2JointDef);var b2DistanceJoint=/*#__PURE__*/function(_b2Joint){_rollupPluginBabelHelpers._inherits(b2DistanceJoint,_b2Joint);function b2DistanceJoint(def){var _this7;_rollupPluginBabelHelpers._classCallCheck(this,b2DistanceJoint);_this7=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2DistanceJoint).call(this,def));_this7.m_frequencyHz=0;_this7.m_dampingRatio=0;_this7.m_bias=0;// Solver shared
...
var b2AreaJointDef=/*#__PURE__*/function(_b2JointDef2){_rollupPluginBabelHelpers._inherits(b2AreaJointDef,_b2JointDef2);function b2AreaJointDef(){var _this8;_rollupPluginBabelHelpers._classCallCheck(this,b2AreaJointDef);_this8=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2AreaJointDef).call(this,exports.b2JointType.e_areaJoint));_this8.bodies=[];_this8.frequencyHz=0;_this8.dampingRatio=0;return _this8;}_rollupPluginBabelHelpers._createClass(b2AreaJointDef,[{key:"AddBody",value:function AddBody(body){this.bodies.push(body);if(this.bodies.length===1){this.bodyA=body;}else if(this.bodies.length===2){this.bodyB=body;}}}]);return b2AreaJointDef;}(b2JointDef);var b2AreaJoint=/*#__PURE__*/function(_b2Joint2){_rollupPluginBabelHelpers._inherits(b2AreaJoint,_b2Joint2);function b2AreaJoint(def){var _this9;_rollupPluginBabelHelpers._classCallCheck(this,b2AreaJoint);_this9=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2AreaJoint).call(this,def));_this9.m_frequencyHz=0;_this9.m_dampingRatio=0;// Solver shared
...
var b2GearJointDef=/*#__PURE__*/function(_b2JointDef4){_rollupPluginBabelHelpers._inherits(b2GearJointDef,_b2JointDef4);function b2GearJointDef(){var _this12;_rollupPluginBabelHelpers._classCallCheck(this,b2GearJointDef);_this12=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2GearJointDef).call(this,exports.b2JointType.e_gearJoint));_this12.ratio=1;return _this12;}return b2GearJointDef;}(b2JointDef);var b2GearJoint=/*#__PURE__*/function(_b2Joint4){_rollupPluginBabelHelpers._inherits(b2GearJoint,_b2Joint4);function b2GearJoint(def){var _this13;_rollupPluginBabelHelpers._classCallCheck(this,b2GearJoint);_this13=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2GearJoint).call(this,def));_this13.m_typeA=exports.b2JointType.e_unknownJoint;_this13.m_typeB=exports.b2JointType.e_unknownJoint;// Solver shared
...
this.m_ratio=ratio;}},{key:"Dump",value:function Dump(log){var indexA=this.m_bodyA.m_islandIndex;var indexB=this.m_bodyB.m_islandIndex;var index1=this.m_joint1.m_index;var index2=this.m_joint2.m_index;log("  const jd: b2GearJointDef = new b2GearJointDef();\n");log("  jd.bodyA = bodies[%d];\n",indexA);log("  jd.bodyB = bodies[%d];\n",indexB);log("  jd.collideConnected = %s;\n",this.m_collideConnected?"true":"false");log("  jd.joint1 = joints[%d];\n",index1);log("  jd.joint2 = joints[%d];\n",index2);log("  jd.ratio = %.15f;\n",this.m_ratio);log("  joints[%d] = this.m_world.CreateJoint(jd);\n",this.m_index);}}]);return b2GearJoint;}(b2Joint);b2GearJoint.InitVelocityConstraints_s_u=new b2Vec2();b2GearJoint.InitVelocityConstraints_s_rA=new b2Vec2();b2GearJoint.InitVelocityConstraints_s_rB=new b2Vec2();b2GearJoint.InitVelocityConstraints_s_rC=new b2Vec2();b2GearJoint.InitVelocityConstraints_s_rD=new b2Vec2();b2GearJoint.SolvePositionConstraints_s_u=new b2Vec2();b2GearJoint.SolvePositionConstraints_s_rA=new b2Vec2();b2GearJoint.SolvePositionConstraints_s_rB=new b2Vec2();b2GearJoint.SolvePositionConstraints_s_rC=new b2Vec2();b2GearJoint.SolvePositionConstraints_s_rD=new b2Vec2();/*
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2MotorJointDef=/*#__PURE__*/function(_b2JointDef5){_rollupPluginBabelHelpers._inherits(b2MotorJointDef,_b2JointDef5);function b2MotorJointDef(){var _this14;_rollupPluginBabelHelpers._classCallCheck(this,b2MotorJointDef);_this14=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2MotorJointDef).call(this,exports.b2JointType.e_motorJoint));_this14.linearOffset=new b2Vec2(0,0);_this14.angularOffset=0;_this14.maxForce=1;_this14.maxTorque=1;_this14.correctionFactor=0.3;return _this14;}_rollupPluginBabelHelpers._createClass(b2MotorJointDef,[{key:"Initialize",value:function Initialize(bA,bB){this.bodyA=bA;this.bodyB=bB;// b2Vec2 xB = bodyB->GetPosition();
// linearOffset = bodyA->GetLocalPoint(xB);
this.bodyA.GetLocalPoint(this.bodyB.GetPosition(),this.linearOffset);var angleA=this.bodyA.GetAngle();var angleB=this.bodyB.GetAngle();this.angularOffset=angleB-angleA;}}]);return b2MotorJointDef;}(b2JointDef);var b2MotorJoint=/*#__PURE__*/function(_b2Joint5){_rollupPluginBabelHelpers._inherits(b2MotorJoint,_b2Joint5);function b2MotorJoint(def){var _this15;_rollupPluginBabelHelpers._classCallCheck(this,b2MotorJoint);_this15=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2MotorJoint).call(this,def));// Solver shared
...
var b2MouseJointDef=/*#__PURE__*/function(_b2JointDef6){_rollupPluginBabelHelpers._inherits(b2MouseJointDef,_b2JointDef6);function b2MouseJointDef(){var _this16;_rollupPluginBabelHelpers._classCallCheck(this,b2MouseJointDef);_this16=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2MouseJointDef).call(this,exports.b2JointType.e_mouseJoint));_this16.target=new b2Vec2();_this16.maxForce=0;_this16.frequencyHz=5;_this16.dampingRatio=0.7;return _this16;}return b2MouseJointDef;}(b2JointDef);var b2MouseJoint=/*#__PURE__*/function(_b2Joint6){_rollupPluginBabelHelpers._inherits(b2MouseJoint,_b2Joint6);function b2MouseJoint(def){var _this17;_rollupPluginBabelHelpers._classCallCheck(this,b2MouseJoint);_this17=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2MouseJoint).call(this,def));_this17.m_localAnchorB=new b2Vec2();_this17.m_targetA=new b2Vec2();_this17.m_frequencyHz=0;_this17.m_dampingRatio=0;_this17.m_beta=0;// Solver shared
...
var b2PrismaticJointDef=/*#__PURE__*/function(_b2JointDef7){_rollupPluginBabelHelpers._inherits(b2PrismaticJointDef,_b2JointDef7);function b2PrismaticJointDef(){var _this18;_rollupPluginBabelHelpers._classCallCheck(this,b2PrismaticJointDef);_this18=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2PrismaticJointDef).call(this,exports.b2JointType.e_prismaticJoint));_this18.localAnchorA=new b2Vec2();_this18.localAnchorB=new b2Vec2();_this18.localAxisA=new b2Vec2(1,0);_this18.referenceAngle=0;_this18.enableLimit=false;_this18.lowerTranslation=0;_this18.upperTranslation=0;_this18.enableMotor=false;_this18.maxMotorForce=0;_this18.motorSpeed=0;return _this18;}_rollupPluginBabelHelpers._createClass(b2PrismaticJointDef,[{key:"Initialize",value:function Initialize(bA,bB,anchor,axis){this.bodyA=bA;this.bodyB=bB;this.bodyA.GetLocalPoint(anchor,this.localAnchorA);this.bodyB.GetLocalPoint(anchor,this.localAnchorB);this.bodyA.GetLocalVector(axis,this.localAxisA);this.referenceAngle=this.bodyB.GetAngle()-this.bodyA.GetAngle();}}]);return b2PrismaticJointDef;}(b2JointDef);var b2PrismaticJoint=/*#__PURE__*/function(_b2Joint7){_rollupPluginBabelHelpers._inherits(b2PrismaticJoint,_b2Joint7);function b2PrismaticJoint(def){var _this19;_rollupPluginBabelHelpers._classCallCheck(this,b2PrismaticJoint);_this19=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2PrismaticJoint).call(this,def));// Solver shared
...
var b2PulleyJointDef=/*#__PURE__*/function(_b2JointDef8){_rollupPluginBabelHelpers._inherits(b2PulleyJointDef,_b2JointDef8);function b2PulleyJointDef(){var _this20;_rollupPluginBabelHelpers._classCallCheck(this,b2PulleyJointDef);_this20=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2PulleyJointDef).call(this,exports.b2JointType.e_pulleyJoint));_this20.groundAnchorA=new b2Vec2(-1,1);_this20.groundAnchorB=new b2Vec2(1,1);_this20.localAnchorA=new b2Vec2(-1,0);_this20.localAnchorB=new b2Vec2(1,0);_this20.lengthA=0;_this20.lengthB=0;_this20.ratio=1;_this20.collideConnected=true;return _this20;}_rollupPluginBabelHelpers._createClass(b2PulleyJointDef,[{key:"Initialize",value:function Initialize(bA,bB,groundA,groundB,anchorA,anchorB,r){this.bodyA=bA;this.bodyB=bB;this.groundAnchorA.Copy(groundA);this.groundAnchorB.Copy(groundB);this.bodyA.GetLocalPoint(anchorA,this.localAnchorA);this.bodyB.GetLocalPoint(anchorB,this.localAnchorB);this.lengthA=b2Vec2.DistanceVV(anchorA,groundA);this.lengthB=b2Vec2.DistanceVV(anchorB,groundB);this.ratio=r;// DEBUG: b2Assert(this.ratio > b2_epsilon);
}}]);return b2PulleyJointDef;}(b2JointDef);var b2PulleyJoint=/*#__PURE__*/function(_b2Joint8){_rollupPluginBabelHelpers._inherits(b2PulleyJoint,_b2Joint8);function b2PulleyJoint(def){var _this21;_rollupPluginBabelHelpers._classCallCheck(this,b2PulleyJoint);_this21=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2PulleyJoint).call(this,def));_this21.m_groundAnchorA=new b2Vec2();_this21.m_groundAnchorB=new b2Vec2();_this21.m_lengthA=0;_this21.m_lengthB=0;// Solver shared
...
_this21.m_ratio=b2Maybe(def.ratio,1);_this21.m_constant=b2Maybe(def.lengthA,0)+_this21.m_ratio*b2Maybe(def.lengthB,0);_this21.m_impulse=0;return _this21;}_rollupPluginBabelHelpers._createClass(b2PulleyJoint,[{key:"InitVelocityConstraints",value:function InitVelocityConstraints(data){this.m_indexA=this.m_bodyA.m_islandIndex;this.m_indexB=this.m_bodyB.m_islandIndex;this.m_localCenterA.Copy(this.m_bodyA.m_sweep.localCenter);this.m_localCenterB.Copy(this.m_bodyB.m_sweep.localCenter);this.m_invMassA=this.m_bodyA.m_invMass;this.m_invMassB=this.m_bodyB.m_invMass;this.m_invIA=this.m_bodyA.m_invI;this.m_invIB=this.m_bodyB.m_invI;var cA=data.positions[this.m_indexA].c;var aA=data.positions[this.m_indexA].a;var vA=data.velocities[this.m_indexA].v;var wA=data.velocities[this.m_indexA].w;var cB=data.positions[this.m_indexB].c;var aB=data.positions[this.m_indexB].a;var vB=data.velocities[this.m_indexB].v;var wB=data.velocities[this.m_indexB].w;// b2Rot qA(aA), qB(aB);
var qA=this.m_qA.SetAngle(aA),qB=this.m_qB.SetAngle(aB);// m_rA = b2Mul(qA, m_localAnchorA - m_localCenterA);
b2Vec2.SubVV(this.m_localAnchorA,this.m_localCenterA,this.m_lalcA);b2Rot.MulRV(qA,this.m_lalcA,this.m_rA);// m_rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
...
var b2RevoluteJointDef=/*#__PURE__*/function(_b2JointDef9){_rollupPluginBabelHelpers._inherits(b2RevoluteJointDef,_b2JointDef9);function b2RevoluteJointDef(){var _this22;_rollupPluginBabelHelpers._classCallCheck(this,b2RevoluteJointDef);_this22=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2RevoluteJointDef).call(this,exports.b2JointType.e_revoluteJoint));_this22.localAnchorA=new b2Vec2(0,0);_this22.localAnchorB=new b2Vec2(0,0);_this22.referenceAngle=0;_this22.enableLimit=false;_this22.lowerAngle=0;_this22.upperAngle=0;_this22.enableMotor=false;_this22.motorSpeed=0;_this22.maxMotorTorque=0;return _this22;}_rollupPluginBabelHelpers._createClass(b2RevoluteJointDef,[{key:"Initialize",value:function Initialize(bA,bB,anchor){this.bodyA=bA;this.bodyB=bB;this.bodyA.GetLocalPoint(anchor,this.localAnchorA);this.bodyB.GetLocalPoint(anchor,this.localAnchorB);this.referenceAngle=this.bodyB.GetAngle()-this.bodyA.GetAngle();}}]);return b2RevoluteJointDef;}(b2JointDef);var b2RevoluteJoint=/*#__PURE__*/function(_b2Joint9){_rollupPluginBabelHelpers._inherits(b2RevoluteJoint,_b2Joint9);function b2RevoluteJoint(def){var _this23;_rollupPluginBabelHelpers._classCallCheck(this,b2RevoluteJoint);_this23=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2RevoluteJoint).call(this,def));// Solver shared
...
var b2RopeJointDef=/*#__PURE__*/function(_b2JointDef10){_rollupPluginBabelHelpers._inherits(b2RopeJointDef,_b2JointDef10);function b2RopeJointDef(){var _this24;_rollupPluginBabelHelpers._classCallCheck(this,b2RopeJointDef);_this24=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2RopeJointDef).call(this,exports.b2JointType.e_ropeJoint));_this24.localAnchorA=new b2Vec2(-1,0);_this24.localAnchorB=new b2Vec2(1,0);_this24.maxLength=0;return _this24;}return b2RopeJointDef;}(b2JointDef);var b2RopeJoint=/*#__PURE__*/function(_b2Joint10){_rollupPluginBabelHelpers._inherits(b2RopeJoint,_b2Joint10);function b2RopeJoint(def){var _this25;_rollupPluginBabelHelpers._classCallCheck(this,b2RopeJoint);_this25=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2RopeJoint).call(this,def));// Solver shared
...
_this25.m_indexA=0;_this25.m_indexB=0;_this25.m_u=new b2Vec2();_this25.m_rA=new b2Vec2();_this25.m_rB=new b2Vec2();_this25.m_localCenterA=new b2Vec2();_this25.m_localCenterB=new b2Vec2();_this25.m_invMassA=0;_this25.m_invMassB=0;_this25.m_invIA=0;_this25.m_invIB=0;_this25.m_mass=0;_this25.m_state=exports.b2LimitState.e_inactiveLimit;_this25.m_qA=new b2Rot();_this25.m_qB=new b2Rot();_this25.m_lalcA=new b2Vec2();_this25.m_lalcB=new b2Vec2();_this25.m_localAnchorA.Copy(b2Maybe(def.localAnchorA,new b2Vec2(-1,0)));_this25.m_localAnchorB.Copy(b2Maybe(def.localAnchorB,new b2Vec2(1,0)));_this25.m_maxLength=b2Maybe(def.maxLength,0);return _this25;}_rollupPluginBabelHelpers._createClass(b2RopeJoint,[{key:"InitVelocityConstraints",value:function InitVelocityConstraints(data){this.m_indexA=this.m_bodyA.m_islandIndex;this.m_indexB=this.m_bodyB.m_islandIndex;this.m_localCenterA.Copy(this.m_bodyA.m_sweep.localCenter);this.m_localCenterB.Copy(this.m_bodyB.m_sweep.localCenter);this.m_invMassA=this.m_bodyA.m_invMass;this.m_invMassB=this.m_bodyB.m_invMass;this.m_invIA=this.m_bodyA.m_invI;this.m_invIB=this.m_bodyB.m_invI;var cA=data.positions[this.m_indexA].c;var aA=data.positions[this.m_indexA].a;var vA=data.velocities[this.m_indexA].v;var wA=data.velocities[this.m_indexA].w;var cB=data.positions[this.m_indexB].c;var aB=data.positions[this.m_indexB].a;var vB=data.velocities[this.m_indexB].v;var wB=data.velocities[this.m_indexB].w;var qA=this.m_qA.SetAngle(aA),qB=this.m_qB.SetAngle(aB);// this.m_rA = b2Mul(qA, this.m_localAnchorA - this.m_localCenterA);
...
var b2WeldJointDef=/*#__PURE__*/function(_b2JointDef11){_rollupPluginBabelHelpers._inherits(b2WeldJointDef,_b2JointDef11);function b2WeldJointDef(){var _this26;_rollupPluginBabelHelpers._classCallCheck(this,b2WeldJointDef);_this26=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2WeldJointDef).call(this,exports.b2JointType.e_weldJoint));_this26.localAnchorA=new b2Vec2();_this26.localAnchorB=new b2Vec2();_this26.referenceAngle=0;_this26.frequencyHz=0;_this26.dampingRatio=0;return _this26;}_rollupPluginBabelHelpers._createClass(b2WeldJointDef,[{key:"Initialize",value:function Initialize(bA,bB,anchor){this.bodyA=bA;this.bodyB=bB;this.bodyA.GetLocalPoint(anchor,this.localAnchorA);this.bodyB.GetLocalPoint(anchor,this.localAnchorB);this.referenceAngle=this.bodyB.GetAngle()-this.bodyA.GetAngle();}}]);return b2WeldJointDef;}(b2JointDef);var b2WeldJoint=/*#__PURE__*/function(_b2Joint11){_rollupPluginBabelHelpers._inherits(b2WeldJoint,_b2Joint11);function b2WeldJoint(def){var _this27;_rollupPluginBabelHelpers._classCallCheck(this,b2WeldJoint);_this27=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2WeldJoint).call(this,def));_this27.m_frequencyHz=0;_this27.m_dampingRatio=0;_this27.m_bias=0;// Solver shared
...
/// when the local anchor points coincide in world space. Using local
/// anchors and a local axis helps when saving and loading a game.
var b2WheelJointDef=/*#__PURE__*/function(_b2JointDef12){_rollupPluginBabelHelpers._inherits(b2WheelJointDef,_b2JointDef12);function b2WheelJointDef(){var _this28;_rollupPluginBabelHelpers._classCallCheck(this,b2WheelJointDef);_this28=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2WheelJointDef).call(this,exports.b2JointType.e_wheelJoint));_this28.localAnchorA=new b2Vec2(0,0);_this28.localAnchorB=new b2Vec2(0,0);_this28.localAxisA=new b2Vec2(1,0);_this28.enableMotor=false;_this28.maxMotorTorque=0;_this28.motorSpeed=0;_this28.frequencyHz=2;_this28.dampingRatio=0.7;return _this28;}_rollupPluginBabelHelpers._createClass(b2WheelJointDef,[{key:"Initialize",value:function Initialize(bA,bB,anchor,axis){this.bodyA=bA;this.bodyB=bB;this.bodyA.GetLocalPoint(anchor,this.localAnchorA);this.bodyB.GetLocalPoint(anchor,this.localAnchorB);this.bodyA.GetLocalVector(axis,this.localAxisA);}}]);return b2WheelJointDef;}(b2JointDef);var b2WheelJoint=/*#__PURE__*/function(_b2Joint12){_rollupPluginBabelHelpers._inherits(b2WheelJoint,_b2Joint12);function b2WheelJoint(def){var _this29;_rollupPluginBabelHelpers._classCallCheck(this,b2WheelJoint);_this29=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2WheelJoint).call(this,def));_this29.m_frequencyHz=0;_this29.m_dampingRatio=0;// Solver shared
...
function b2MixRestitution(restitution1,restitution2){return restitution1>restitution2?restitution1:restitution2;}var b2ContactEdge=/*#__PURE__*/function(){function b2ContactEdge(contact){_rollupPluginBabelHelpers._classCallCheck(this,b2ContactEdge);this._other=null;///< provides quick access to the other body attached.
...
this.contact=contact;}_rollupPluginBabelHelpers._createClass(b2ContactEdge,[{key:"Reset",value:function Reset(){this._other=null;this.prev=null;this.next=null;}},{key:"other",get:function get(){if(this._other===null){throw new Error();}return this._other;},set:function set(value){if(this._other!==null){throw new Error();}this._other=value;}}]);return b2ContactEdge;}();var b2Contact=/*#__PURE__*/function(){function b2Contact(){_rollupPluginBabelHelpers._classCallCheck(this,b2Contact);this.m_islandFlag=false;/// Used when crawling contact graph when forming islands.
...
for(var i=0;i<this.m_manifold.pointCount;++i){var mp2=this.m_manifold.points[i];mp2.normalImpulse=0;mp2.tangentImpulse=0;var id2=mp2.id;for(var j=0;j<this.m_oldManifold.pointCount;++j){var mp1=this.m_oldManifold.points[j];if(mp1.id.key===id2.key){mp2.normalImpulse=mp1.normalImpulse;mp2.tangentImpulse=mp1.tangentImpulse;break;}}}if(touching!==wasTouching){bodyA.SetAwake(true);bodyB.SetAwake(true);}}this.m_touchingFlag=touching;if(!wasTouching&&touching&&listener){listener.BeginContact(this);}if(wasTouching&&!touching&&listener){listener.EndContact(this);}if(!sensor&&touching&&listener){listener.PreSolve(this,this.m_oldManifold);}}},{key:"ComputeTOI",value:function ComputeTOI(sweepA,sweepB){var input=b2Contact.ComputeTOI_s_input;input.proxyA.SetShape(this.GetShapeA(),this.m_indexA);input.proxyB.SetShape(this.GetShapeB(),this.m_indexB);input.sweepA.Copy(sweepA);input.sweepB.Copy(sweepB);input.tMax=b2_linearSlop;var output=b2Contact.ComputeTOI_s_output;b2TimeOfImpact(output,input);return output.t;}}]);return b2Contact;}();b2Contact.ComputeTOI_s_input=new b2TOIInput();b2Contact.ComputeTOI_s_output=new b2TOIOutput();/*
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2CircleContact=/*#__PURE__*/function(_b2Contact){_rollupPluginBabelHelpers._inherits(b2CircleContact,_b2Contact);function b2CircleContact(){_rollupPluginBabelHelpers._classCallCheck(this,b2CircleContact);return _rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2CircleContact).apply(this,arguments));}_rollupPluginBabelHelpers._createClass(b2CircleContact,[{key:"Evaluate",value:function Evaluate(manifold,xfA,xfB){b2CollideCircles(manifold,this.GetShapeA(),xfA,this.GetShapeB(),xfB);}}],[{key:"Create",value:function Create(){return new b2CircleContact();}},{key:"Destroy",value:function Destroy(contact){}}]);return b2CircleContact;}(b2Contact);/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2PolygonContact=/*#__PURE__*/function(_b2Contact2){_rollupPluginBabelHelpers._inherits(b2PolygonContact,_b2Contact2);function b2PolygonContact(){_rollupPluginBabelHelpers._classCallCheck(this,b2PolygonContact);return _rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2PolygonContact).apply(this,arguments));}_rollupPluginBabelHelpers._createClass(b2PolygonContact,[{key:"Evaluate",value:function Evaluate(manifold,xfA,xfB){b2CollidePolygons(manifold,this.GetShapeA(),xfA,this.GetShapeB(),xfB);}}],[{key:"Create",value:function Create(){return new b2PolygonContact();}},{key:"Destroy",value:function Destroy(contact){}}]);return b2PolygonContact;}(b2Contact);/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2PolygonAndCircleContact=/*#__PURE__*/function(_b2Contact3){_rollupPluginBabelHelpers._inherits(b2PolygonAndCircleContact,_b2Contact3);function b2PolygonAndCircleContact(){_rollupPluginBabelHelpers._classCallCheck(this,b2PolygonAndCircleContact);return _rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2PolygonAndCircleContact).apply(this,arguments));}_rollupPluginBabelHelpers._createClass(b2PolygonAndCircleContact,[{key:"Evaluate",value:function Evaluate(manifold,xfA,xfB){b2CollidePolygonAndCircle(manifold,this.GetShapeA(),xfA,this.GetShapeB(),xfB);}}],[{key:"Create",value:function Create(){return new b2PolygonAndCircleContact();}},{key:"Destroy",value:function Destroy(contact){}}]);return b2PolygonAndCircleContact;}(b2Contact);/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2EdgeAndCircleContact=/*#__PURE__*/function(_b2Contact4){_rollupPluginBabelHelpers._inherits(b2EdgeAndCircleContact,_b2Contact4);function b2EdgeAndCircleContact(){_rollupPluginBabelHelpers._classCallCheck(this,b2EdgeAndCircleContact);return _rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2EdgeAndCircleContact).apply(this,arguments));}_rollupPluginBabelHelpers._createClass(b2EdgeAndCircleContact,[{key:"Evaluate",value:function Evaluate(manifold,xfA,xfB){b2CollideEdgeAndCircle(manifold,this.GetShapeA(),xfA,this.GetShapeB(),xfB);}}],[{key:"Create",value:function Create(){return new b2EdgeAndCircleContact();}},{key:"Destroy",value:function Destroy(contact){}}]);return b2EdgeAndCircleContact;}(b2Contact);/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2EdgeAndPolygonContact=/*#__PURE__*/function(_b2Contact5){_rollupPluginBabelHelpers._inherits(b2EdgeAndPolygonContact,_b2Contact5);function b2EdgeAndPolygonContact(){_rollupPluginBabelHelpers._classCallCheck(this,b2EdgeAndPolygonContact);return _rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2EdgeAndPolygonContact).apply(this,arguments));}_rollupPluginBabelHelpers._createClass(b2EdgeAndPolygonContact,[{key:"Evaluate",value:function Evaluate(manifold,xfA,xfB){b2CollideEdgeAndPolygon(manifold,this.GetShapeA(),xfA,this.GetShapeB(),xfB);}}],[{key:"Create",value:function Create(){return new b2EdgeAndPolygonContact();}},{key:"Destroy",value:function Destroy(contact){}}]);return b2EdgeAndPolygonContact;}(b2Contact);/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2ChainAndCircleContact=/*#__PURE__*/function(_b2Contact6){_rollupPluginBabelHelpers._inherits(b2ChainAndCircleContact,_b2Contact6);function b2ChainAndCircleContact(){_rollupPluginBabelHelpers._classCallCheck(this,b2ChainAndCircleContact);return _rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2ChainAndCircleContact).apply(this,arguments));}_rollupPluginBabelHelpers._createClass(b2ChainAndCircleContact,[{key:"Evaluate",value:function Evaluate(manifold,xfA,xfB){var edge=b2ChainAndCircleContact.Evaluate_s_edge;this.GetShapeA().GetChildEdge(edge,this.m_indexA);b2CollideEdgeAndCircle(manifold,edge,xfA,this.GetShapeB(),xfB);}}],[{key:"Create",value:function Create(){return new b2ChainAndCircleContact();}},{key:"Destroy",value:function Destroy(contact){}}]);return b2ChainAndCircleContact;}(b2Contact);b2ChainAndCircleContact.Evaluate_s_edge=new b2EdgeShape();/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
  ...
  * misrepresented as being the original software.
  * 3. This notice may not be removed or altered from any source distribution.
  */var b2ChainAndPolygonContact=/*#__PURE__*/function(_b2Contact7){_rollupPluginBabelHelpers._inherits(b2ChainAndPolygonContact,_b2Contact7);function b2ChainAndPolygonContact(){_rollupPluginBabelHelpers._classCallCheck(this,b2ChainAndPolygonContact);return _rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2ChainAndPolygonContact).apply(this,arguments));}_rollupPluginBabelHelpers._createClass(b2ChainAndPolygonContact,[{key:"Evaluate",value:function Evaluate(manifold,xfA,xfB){var edge=b2ChainAndPolygonContact.Evaluate_s_edge;this.GetShapeA().GetChildEdge(edge,this.m_indexA);b2CollideEdgeAndPolygon(manifold,edge,xfA,this.GetShapeB(),xfB);}}],[{key:"Create",value:function Create(){return new b2ChainAndPolygonContact();}},{key:"Destroy",value:function Destroy(contact){}}]);return b2ChainAndPolygonContact;}(b2Contact);b2ChainAndPolygonContact.Evaluate_s_edge=new b2EdgeShape();// DEBUG: import { b2Assert } from "../common/b2_settings.js";
var b2ContactRegister=function b2ContactRegister(){_rollupPluginBabelHelpers._classCallCheck(this,b2ContactRegister);this.pool=[];this.createFcn=null;this.destroyFcn=null;this.primary=false;};var b2ContactFactory=/*#__PURE__*/function(){function b2ContactFactory(){_rollupPluginBabelHelpers._classCallCheck(this,b2ContactFactory);this.m_registers=[];this.InitializeRegisters();}_rollupPluginBabelHelpers._createClass(b2ContactFactory,[{key:"AddType",value:function AddType(createFcn,destroyFcn,typeA,typeB){var pool=[];function poolCreateFcn(){return pool.pop()||createFcn();}function poolDestroyFcn(contact){pool.push(contact);}this.m_registers[typeA][typeB].pool=pool;this.m_registers[typeA][typeB].createFcn=poolCreateFcn;// createFcn;
...
var b2DestructionListener=/*#__PURE__*/function(){function b2DestructionListener(){_rollupPluginBabelHelpers._classCallCheck(this,b2DestructionListener);}_rollupPluginBabelHelpers._createClass(b2DestructionListener,[{key:"SayGoodbyeJoint",/// Called when any joint is about to be destroyed due
/// to the destruction of one of its attached bodies.
value:function SayGoodbyeJoint(joint){}/// Called when any fixture is about to be destroyed due
...
var b2ContactFilter=/*#__PURE__*/function(){function b2ContactFilter(){_rollupPluginBabelHelpers._classCallCheck(this,b2ContactFilter);}_rollupPluginBabelHelpers._createClass(b2ContactFilter,[{key:"ShouldCollide",/// Return true if contact calculations should be performed between these two shapes.
/// @warning for performance reasons this is only called when the AABBs begin to overlap.
value:function ShouldCollide(fixtureA,fixtureB){var bodyA=fixtureA.GetBody();var bodyB=fixtureB.GetBody();// At least one body should be dynamic or kinematic.
...
var b2ContactImpulse=function b2ContactImpulse(){_rollupPluginBabelHelpers._classCallCheck(this,b2ContactImpulse);this.normalImpulses=b2MakeNumberArray(b2_maxManifoldPoints);this.tangentImpulses=b2MakeNumberArray(b2_maxManifoldPoints);this.count=0;};/// Implement this class to get contact information. You can use these results for
...
var b2ContactListener=/*#__PURE__*/function(){function b2ContactListener(){_rollupPluginBabelHelpers._classCallCheck(this,b2ContactListener);}_rollupPluginBabelHelpers._createClass(b2ContactListener,[{key:"BeginContact",/// Called when two fixtures begin to touch.
value:function BeginContact(contact){}/// Called when two fixtures cease to touch.
...
/// See b2World::Query
var b2QueryCallback=/*#__PURE__*/function(){function b2QueryCallback(){_rollupPluginBabelHelpers._classCallCheck(this,b2QueryCallback);}_rollupPluginBabelHelpers._createClass(b2QueryCallback,[{key:"ReportFixture",/// Called for each fixture found in the query AABB.
/// @return false to terminate the query.
value:function ReportFixture(fixture){return true;}// #if B2_ENABLE_PARTICLE
...
/// See b2World::RayCast
var b2RayCastCallback=/*#__PURE__*/function(){function b2RayCastCallback(){_rollupPluginBabelHelpers._classCallCheck(this,b2RayCastCallback);}_rollupPluginBabelHelpers._createClass(b2RayCastCallback,[{key:"ReportFixture",/// Called for each fixture found in the query. You control how the ray cast
...
value:function ReportFixture(fixture,point,normal,fraction){return fraction;}// #if B2_ENABLE_PARTICLE
  ...
  * 3. This notice may not be removed or altered from any source distribution.
  */ // Delegate of b2World.
var b2ContactManager=/*#__PURE__*/function(){function b2ContactManager(){_rollupPluginBabelHelpers._classCallCheck(this,b2ContactManager);this.m_broadPhase=new b2BroadPhase();this.m_contactList=null;this.m_contactCount=0;this.m_contactFilter=b2ContactFilter.b2_defaultFilter;this.m_contactListener=b2ContactListener.b2_defaultListener;this.m_contactFactory=new b2ContactFactory();}// Broad-phase callback.
_rollupPluginBabelHelpers._createClass(b2ContactManager,[{key:"AddPair",value:function AddPair(proxyA,proxyB){// DEBUG: b2Assert(proxyA instanceof b2FixtureProxy);
...
var b2Profile=/*#__PURE__*/function(){function b2Profile(){_rollupPluginBabelHelpers._classCallCheck(this,b2Profile);this.step=0;this.collide=0;this.solve=0;this.solveInit=0;this.solveVelocity=0;this.solvePosition=0;this.broadphase=0;this.solveTOI=0;}_rollupPluginBabelHelpers._createClass(b2Profile,[{key:"Reset",value:function Reset(){this.step=0;this.collide=0;this.solve=0;this.solveInit=0;this.solveVelocity=0;this.solvePosition=0;this.broadphase=0;this.solveTOI=0;return this;}}]);return b2Profile;}();/// This is an internal structure.
var b2TimeStep=/*#__PURE__*/function(){function b2TimeStep(){_rollupPluginBabelHelpers._classCallCheck(this,b2TimeStep);this.dt=0;// time step
...
this.warmStarting=false;}_rollupPluginBabelHelpers._createClass(b2TimeStep,[{key:"Copy",value:function Copy(step){this.dt=step.dt;this.inv_dt=step.inv_dt;this.dtRatio=step.dtRatio;this.positionIterations=step.positionIterations;this.velocityIterations=step.velocityIterations;// #if B2_ENABLE_PARTICLE
this.particleIterations=step.particleIterations;// #endif
this.warmStarting=step.warmStarting;return this;}}]);return b2TimeStep;}();var b2Position=/*#__PURE__*/function(){function b2Position(){_rollupPluginBabelHelpers._classCallCheck(this,b2Position);this.c=new b2Vec2();this.a=0;}_rollupPluginBabelHelpers._createClass(b2Position,null,[{key:"MakeArray",value:function MakeArray(length){return b2MakeArray(length,function(i){return new b2Position();});}}]);return b2Position;}();var b2Velocity=/*#__PURE__*/function(){function b2Velocity(){_rollupPluginBabelHelpers._classCallCheck(this,b2Velocity);this.v=new b2Vec2();this.w=0;}_rollupPluginBabelHelpers._createClass(b2Velocity,null,[{key:"MakeArray",value:function MakeArray(length){return b2MakeArray(length,function(i){return new b2Velocity();});}}]);return b2Velocity;}();var b2SolverData=function b2SolverData(){_rollupPluginBabelHelpers._classCallCheck(this,b2SolverData);this.step=new b2TimeStep();};/*
  * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
  *
  * This software is provided 'as-is', without any express or implied
  * warranty.  In no event will the authors be held liable for any damages
...
var g_blockSolve=false;var b2VelocityConstraintPoint=/*#__PURE__*/function(){function b2VelocityConstraintPoint(){_rollupPluginBabelHelpers._classCallCheck(this,b2VelocityConstraintPoint);this.rA=new b2Vec2();this.rB=new b2Vec2();this.normalImpulse=0;this.tangentImpulse=0;this.normalMass=0;this.tangentMass=0;this.velocityBias=0;}_rollupPluginBabelHelpers._createClass(b2VelocityConstraintPoint,null,[{key:"MakeArray",value:function MakeArray(length){return b2MakeArray(length,function(i){return new b2VelocityConstraintPoint();});}}]);return b2VelocityConstraintPoint;}();var b2ContactVelocityConstraint=/*#__PURE__*/function(){function b2ContactVelocityConstraint(){_rollupPluginBabelHelpers._classCallCheck(this,b2ContactVelocityConstraint);this.points=b2VelocityConstraintPoint.MakeArray(b2_maxManifoldPoints);this.normal=new b2Vec2();this.tangent=new b2Vec2();this.normalMass=new b2Mat22();this.K=new b2Mat22();this.indexA=0;this.indexB=0;this.invMassA=0;this.invMassB=0;this.invIA=0;this.invIB=0;this.friction=0;this.restitution=0;this.tangentSpeed=0;this.pointCount=0;this.contactIndex=0;}_rollupPluginBabelHelpers._createClass(b2ContactVelocityConstraint,null,[{key:"MakeArray",value:function MakeArray(length){return b2MakeArray(length,function(i){return new b2ContactVelocityConstraint();});}}]);return b2ContactVelocityConstraint;}();var b2ContactPositionConstraint=/*#__PURE__*/function(){function b2ContactPositionConstraint(){_rollupPluginBabelHelpers._classCallCheck(this,b2ContactPositionConstraint);this.localPoints=b2Vec2.MakeArray(b2_maxManifoldPoints);this.localNormal=new b2Vec2();this.localPoint=new b2Vec2();this.indexA=0;this.indexB=0;this.invMassA=0;this.invMassB=0;this.localCenterA=new b2Vec2();this.localCenterB=new b2Vec2();this.invIA=0;this.invIB=0;this.type=exports.b2ManifoldType.e_unknown;this.radiusA=0;this.radiusB=0;this.pointCount=0;}_rollupPluginBabelHelpers._createClass(b2ContactPositionConstraint,null,[{key:"MakeArray",value:function MakeArray(length){return b2MakeArray(length,function(i){return new b2ContactPositionConstraint();});}}]);return b2ContactPositionConstraint;}();var b2ContactSolverDef=function b2ContactSolverDef(){_rollupPluginBabelHelpers._classCallCheck(this,b2ContactSolverDef);this.step=new b2TimeStep();this.count=0;};var b2PositionSolverManifold=/*#__PURE__*/function(){function b2PositionSolverManifold(){_rollupPluginBabelHelpers._classCallCheck(this,b2PositionSolverManifold);this.normal=new b2Vec2();this.point=new b2Vec2();this.separation=0;}_rollupPluginBabelHelpers._createClass(b2PositionSolverManifold,[{key:"Initialize",value:function Initialize(pc,xfA,xfB,index){var pointA=b2PositionSolverManifold.Initialize_s_pointA;var pointB=b2PositionSolverManifold.Initialize_s_pointB;var planePoint=b2PositionSolverManifold.Initialize_s_planePoint;var clipPoint=b2PositionSolverManifold.Initialize_s_clipPoint;// DEBUG: b2Assert(pc.pointCount > 0);
...
// normal = -normal;
this.normal.SelfNeg();break;}}}}]);return b2PositionSolverManifold;}();b2PositionSolverManifold.Initialize_s_pointA=new b2Vec2();b2PositionSolverManifold.Initialize_s_pointB=new b2Vec2();b2PositionSolverManifold.Initialize_s_planePoint=new b2Vec2();b2PositionSolverManifold.Initialize_s_clipPoint=new b2Vec2();var b2ContactSolver=/*#__PURE__*/function(){function b2ContactSolver(){_rollupPluginBabelHelpers._classCallCheck(this,b2ContactSolver);this.m_step=new b2TimeStep();this.m_positionConstraints=b2ContactPositionConstraint.MakeArray(1024);// TODO: b2Settings
this.m_velocityConstraints=b2ContactVelocityConstraint.MakeArray(1024);// TODO: b2Settings
this.m_count=0;}_rollupPluginBabelHelpers._createClass(b2ContactSolver,[{key:"Initialize",value:function Initialize(def){this.m_step.Copy(def.step);this.m_count=def.count;// TODO:
...
return minSeparation>=-1.5*b2_linearSlop;}}]);return b2ContactSolver;}();b2ContactSolver.InitializeVelocityConstraints_s_xfA=new b2Transform();b2ContactSolver.InitializeVelocityConstraints_s_xfB=new b2Transform();b2ContactSolver.InitializeVelocityConstraints_s_worldManifold=new b2WorldManifold();b2ContactSolver.WarmStart_s_P=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_dv=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_dv1=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_dv2=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_P=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_a=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_b=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_x=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_d=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_P1=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_P2=new b2Vec2();b2ContactSolver.SolveVelocityConstraints_s_P1P2=new b2Vec2();b2ContactSolver.SolvePositionConstraints_s_xfA=new b2Transform();b2ContactSolver.SolvePositionConstraints_s_xfB=new b2Transform();b2ContactSolver.SolvePositionConstraints_s_psm=new b2PositionSolverManifold();b2ContactSolver.SolvePositionConstraints_s_rA=new b2Vec2();b2ContactSolver.SolvePositionConstraints_s_rB=new b2Vec2();b2ContactSolver.SolvePositionConstraints_s_P=new b2Vec2();b2ContactSolver.SolveTOIPositionConstraints_s_xfA=new b2Transform();b2ContactSolver.SolveTOIPositionConstraints_s_xfB=new b2Transform();b2ContactSolver.SolveTOIPositionConstraints_s_psm=new b2PositionSolverManifold();b2ContactSolver.SolveTOIPositionConstraints_s_rA=new b2Vec2();b2ContactSolver.SolveTOIPositionConstraints_s_rB=new b2Vec2();b2ContactSolver.SolveTOIPositionConstraints_s_P=new b2Vec2();/*
  ...
  */var b2Island=/*#__PURE__*/function(){function b2Island(){_rollupPluginBabelHelpers._classCallCheck(this,b2Island);this.m_bodies=[/*1024*/];// TODO: b2Settings
...
/// particles.
b2ParticleFlag[b2ParticleFlag["b2_particleContactFilterParticle"]=131072]="b2_particleContactFilterParticle";})(exports.b2ParticleFlag||(exports.b2ParticleFlag={}));var b2ParticleDef=function b2ParticleDef(){_rollupPluginBabelHelpers._classCallCheck(this,b2ParticleDef);this.flags=0;this.position=new b2Vec2();this.velocity=new b2Vec2();this.color=new b2Color(0,0,0,0);this.lifetime=0.0;this.userData=null;this.group=null;};function b2CalculateParticleIterations(gravity,radius,timeStep){// In some situations you may want more particle iterations than this,
// but to avoid excessive cycle cost, don't recommend more than this.
var B2_MAX_RECOMMENDED_PARTICLE_ITERATIONS=8;var B2_RADIUS_THRESHOLD=0.01;var iterations=Math.ceil(Math.sqrt(gravity/(B2_RADIUS_THRESHOLD*radius))*timeStep);return b2Clamp(iterations,1,B2_MAX_RECOMMENDED_PARTICLE_ITERATIONS);}var b2ParticleHandle=/*#__PURE__*/function(){function b2ParticleHandle(){_rollupPluginBabelHelpers._classCallCheck(this,b2ParticleHandle);this.m_index=b2_invalidParticleIndex;}_rollupPluginBabelHelpers._createClass(b2ParticleHandle,[{key:"GetIndex",value:function GetIndex(){return this.m_index;}},{key:"SetIndex",value:function SetIndex(index){this.m_index=index;}}]);return b2ParticleHandle;}();// #endif
/*
   * Copyright (c) 2013 Google, Inc.
   *
   * This software is provided 'as-is', without any express or implied
...
var b2StackQueue=/*#__PURE__*/function(){function b2StackQueue(capacity){_rollupPluginBabelHelpers._classCallCheck(this,b2StackQueue);this.m_buffer=[];this.m_front=0;this.m_back=0;this.m_buffer.fill(null,0,capacity);}_rollupPluginBabelHelpers._createClass(b2StackQueue,[{key:"Push",value:function Push(item){if(this.m_back>=this.m_capacity){for(var i=this.m_front;i<this.m_back;i++){this.m_buffer[i-this.m_front]=this.m_buffer[i];}this.m_back-=this.m_front;this.m_front=0;}this.m_buffer[this.m_back]=item;this.m_back++;}},{key:"Pop",value:function Pop(){// DEBUG: b2Assert(this.m_front < this.m_back);
this.m_buffer[this.m_front]=null;this.m_front++;}},{key:"Empty",value:function Empty(){// DEBUG: b2Assert(this.m_front <= this.m_back);
return this.m_front===this.m_back;}},{key:"Front",value:function Front(){var item=this.m_buffer[this.m_front];if(!item){throw new Error();}return item;}},{key:"m_capacity",get:function get(){return this.m_buffer.length;}}]);return b2StackQueue;}();// #endif
/*
   * Copyright (c) 2013 Google, Inc.
   *
   * This software is provided 'as-is', without any express or implied
...
std_iter_swap$1(array,++result,first);}}return ++result;}var b2GrowableBuffer=/*#__PURE__*/function(){function b2GrowableBuffer(allocator){_rollupPluginBabelHelpers._classCallCheck(this,b2GrowableBuffer);this.data=[];this.count=0;this.capacity=0;this.allocator=allocator;}_rollupPluginBabelHelpers._createClass(b2GrowableBuffer,[{key:"Append",value:function Append(){if(this.count>=this.capacity){this.Grow();}return this.count++;}},{key:"Reserve",value:function Reserve(newCapacity){if(this.capacity>=newCapacity){return;}// DEBUG: b2Assert(this.capacity === this.data.length);
...
}},{key:"Unique",value:function Unique(pred){this.count=std_unique(this.data,0,this.count,pred);}}]);return b2GrowableBuffer;}();var b2FixtureParticleQueryCallback=/*#__PURE__*/function(_b2QueryCallback){_rollupPluginBabelHelpers._inherits(b2FixtureParticleQueryCallback,_b2QueryCallback);function b2FixtureParticleQueryCallback(system){var _this31;_rollupPluginBabelHelpers._classCallCheck(this,b2FixtureParticleQueryCallback);_this31=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2FixtureParticleQueryCallback).call(this));_this31.m_system=system;return _this31;}_rollupPluginBabelHelpers._createClass(b2FixtureParticleQueryCallback,[{key:"ShouldQueryParticleSystem",value:function ShouldQueryParticleSystem(system){// Skip reporting particles.
...
}}]);return b2FixtureParticleQueryCallback;}(b2QueryCallback);var b2ParticleContact=/*#__PURE__*/function(){function b2ParticleContact(){_rollupPluginBabelHelpers._classCallCheck(this,b2ParticleContact);this.indexA=0;this.indexB=0;this.weight=0;this.normal=new b2Vec2();this.flags=0;}_rollupPluginBabelHelpers._createClass(b2ParticleContact,[{key:"SetIndices",value:function SetIndices(a,b){// DEBUG: b2Assert(a <= b2_maxParticleIndex && b <= b2_maxParticleIndex);
...
};var b2ParticlePair=function b2ParticlePair(){_rollupPluginBabelHelpers._classCallCheck(this,b2ParticlePair);this.indexA=0;// Indices of the respective particles making pair.
...
};var b2ParticleTriad=function b2ParticleTriad(){_rollupPluginBabelHelpers._classCallCheck(this,b2ParticleTriad);this.indexA=0;// Indices of the respective particles making triad.
...
this.pb=new b2Vec2(0.0,0.0);this.pc=new b2Vec2(0.0,0.0);this.ka=0.0;this.kb=0.0;this.kc=0.0;this.s=0.0;};var b2ParticleSystemDef=/*#__PURE__*/function(){function b2ParticleSystemDef(){_rollupPluginBabelHelpers._classCallCheck(this,b2ParticleSystemDef);// Initialize physical coefficients to the maximum values that
...
this.m_def=def.Clone();this.m_world=world;this.SetDestructionByAge(this.m_def.destroyByAge);}_rollupPluginBabelHelpers._createClass(b2ParticleSystem,[{key:"Drop",value:function Drop(){while(this.m_groupList){this.DestroyParticleGroup(this.m_groupList);}this.FreeUserOverridableBuffer(this.m_handleIndexBuffer);this.FreeUserOverridableBuffer(this.m_flagsBuffer);this.FreeUserOverridableBuffer(this.m_lastBodyContactStepBuffer);this.FreeUserOverridableBuffer(this.m_bodyContactCountBuffer);this.FreeUserOverridableBuffer(this.m_consecutiveContactStepsBuffer);this.FreeUserOverridableBuffer(this.m_positionBuffer);this.FreeUserOverridableBuffer(this.m_velocityBuffer);this.FreeUserOverridableBuffer(this.m_colorBuffer);this.FreeUserOverridableBuffer(this.m_userDataBuffer);this.FreeUserOverridableBuffer(this.m_expirationTimeBuffer);this.FreeUserOverridableBuffer(this.m_indexByExpirationTimeBuffer);this.FreeBuffer(this.m_forceBuffer,this.m_internalAllocatedCapacity);this.FreeBuffer(this.m_weightBuffer,this.m_internalAllocatedCapacity);this.FreeBuffer(this.m_staticPressureBuffer,this.m_internalAllocatedCapacity);this.FreeBuffer(this.m_accumulationBuffer,this.m_internalAllocatedCapacity);this.FreeBuffer(this.m_accumulation2Buffer,this.m_internalAllocatedCapacity);this.FreeBuffer(this.m_depthBuffer,this.m_internalAllocatedCapacity);this.FreeBuffer(this.m_groupBuffer,this.m_internalAllocatedCapacity);}/**
...
vel_data[i].SelfAdd(velocityDelta);}}},{key:"ParticleApplyForce",/**
       * Apply a force to the center of a particle.
       *
       * @param index the particle that will be modified.
       * @param force the world force vector, usually in Newtons (N).
       */value:function ParticleApplyForce(index,force){if(b2ParticleSystem.IsSignificantForce(force)&&this.ForceCanBeApplied(this.m_flagsBuffer.data[index])){this.PrepareForceBuffer();///m_forceBuffer[index] += force;
...
if(xTag>=this.m_xLower&&xTag<=this.m_xUpper){return this.m_system.m_proxyBuffer.data[this.m_first++].index;}this.m_first++;}return b2_invalidParticleIndex;}}]);return b2ParticleSystem_InsideBoundsEnumerator;}();var b2ParticleSystem_ParticleListNode=function b2ParticleSystem_ParticleListNode(){_rollupPluginBabelHelpers._classCallCheck(this,b2ParticleSystem_ParticleListNode);/**
           ...
           */this.index=0;};/**
   * @constructor
   */var b2ParticleSystem_FixedSetAllocator=/*#__PURE__*/function(){function b2ParticleSystem_FixedSetAllocator(){_rollupPluginBabelHelpers._classCallCheck(this,b2ParticleSystem_FixedSetAllocator);}_rollupPluginBabelHelpers._createClass(b2ParticleSystem_FixedSetAllocator,[{key:"Allocate",value:function Allocate(itemSize,count){// TODO
...
}}]);return b2ParticleSystem_FixedSetAllocator;}();var b2ParticleSystem_FixtureParticle=function b2ParticleSystem_FixtureParticle(fixture,particle){_rollupPluginBabelHelpers._classCallCheck(this,b2ParticleSystem_FixtureParticle);this.second=b2_invalidParticleIndex;this.first=fixture;this.second=particle;};var b2ParticleSystem_FixtureParticleSet=/*#__PURE__*/function(_b2ParticleSystem_Fix){_rollupPluginBabelHelpers._inherits(b2ParticleSystem_FixtureParticleSet,_b2ParticleSystem_Fix);function b2ParticleSystem_FixtureParticleSet(){_rollupPluginBabelHelpers._classCallCheck(this,b2ParticleSystem_FixtureParticleSet);return _rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2ParticleSystem_FixtureParticleSet).apply(this,arguments));}_rollupPluginBabelHelpers._createClass(b2ParticleSystem_FixtureParticleSet,[{key:"Initialize",value:function Initialize(bodyContactBuffer,flagsBuffer){// TODO
}},{key:"Find",value:function Find(pair){// TODO
return b2_invalidParticleIndex;}}]);return b2ParticleSystem_FixtureParticleSet;}(b2ParticleSystem_FixedSetAllocator);var b2ParticleSystem_ParticlePair=function b2ParticleSystem_ParticlePair(particleA,particleB){_rollupPluginBabelHelpers._classCallCheck(this,b2ParticleSystem_ParticlePair);this.first=b2_invalidParticleIndex;this.second=b2_invalidParticleIndex;this.first=particleA;this.second=particleB;};var b2ParticlePairSet=/*#__PURE__*/function(_b2ParticleSystem_Fix2){_rollupPluginBabelHelpers._inherits(b2ParticlePairSet,_b2ParticleSystem_Fix2);function b2ParticlePairSet(){_rollupPluginBabelHelpers._classCallCheck(this,b2ParticlePairSet);return _rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2ParticlePairSet).apply(this,arguments));}_rollupPluginBabelHelpers._createClass(b2ParticlePairSet,[{key:"Initialize",value:function Initialize(contactBuffer,flagsBuffer){// TODO
}},{key:"Find",value:function Find(pair){// TODO
return b2_invalidParticleIndex;}}]);return b2ParticlePairSet;}(b2ParticleSystem_FixedSetAllocator);var b2ParticleSystem_ConnectionFilter=/*#__PURE__*/function(){function b2ParticleSystem_ConnectionFilter(){_rollupPluginBabelHelpers._classCallCheck(this,b2ParticleSystem_ConnectionFilter);}_rollupPluginBabelHelpers._createClass(b2ParticleSystem_ConnectionFilter,[{key:"IsNecessary",/**
       * Is the particle necessary for connection?
       * A pair or a triad should contain at least one 'necessary'
       * particle.
       */value:function IsNecessary(index){return true;}/**
       * An additional condition for creating a pair.
       */},{key:"ShouldCreatePair",value:function ShouldCreatePair(a,b){return true;}/**
       * An additional condition for creating a triad.
       */},{key:"ShouldCreateTriad",value:function ShouldCreateTriad(a,b,c){return true;}}]);return b2ParticleSystem_ConnectionFilter;}();var b2ParticleSystem_DestroyParticlesInShapeCallback=/*#__PURE__*/function(_b2QueryCallback2){_rollupPluginBabelHelpers._inherits(b2ParticleSystem_DestroyParticlesInShapeCallback,_b2QueryCallback2);function b2ParticleSystem_DestroyParticlesInShapeCallback(system,shape,xf,callDestructionListener){var _this32;_rollupPluginBabelHelpers._classCallCheck(this,b2ParticleSystem_DestroyParticlesInShapeCallback);_this32=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2ParticleSystem_DestroyParticlesInShapeCallback).call(this));_this32.m_callDestructionListener=false;_this32.m_destroyed=0;_this32.m_system=system;_this32.m_shape=shape;_this32.m_xf=xf;_this32.m_callDestructionListener=callDestructionListener;_this32.m_destroyed=0;return _this32;}_rollupPluginBabelHelpers._createClass(b2ParticleSystem_DestroyParticlesInShapeCallback,[{key:"ReportFixture",value:function ReportFixture(fixture){return false;}},{key:"ReportParticle",value:function ReportParticle(particleSystem,index){if(particleSystem!==this.m_system){return false;}// DEBUG: b2Assert(index >= 0 && index < this.m_system.m_count);
if(this.m_shape.TestPoint(this.m_xf,this.m_system.m_positionBuffer.data[index])){this.m_system.DestroyParticle(index,this.m_callDestructionListener);this.m_destroyed++;}return true;}},{key:"Destroyed",value:function Destroyed(){return this.m_destroyed;}}]);return b2ParticleSystem_DestroyParticlesInShapeCallback;}(b2QueryCallback);var b2ParticleSystem_JoinParticleGroupsFilter=/*#__PURE__*/function(_b2ParticleSystem_Con){_rollupPluginBabelHelpers._inherits(b2ParticleSystem_JoinParticleGroupsFilter,_b2ParticleSystem_Con);function b2ParticleSystem_JoinParticleGroupsFilter(threshold){var _this33;_rollupPluginBabelHelpers._classCallCheck(this,b2ParticleSystem_JoinParticleGroupsFilter);_this33=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2ParticleSystem_JoinParticleGroupsFilter).call(this));_this33.m_threshold=0;_this33.m_threshold=threshold;return _this33;}/**
       * An additional condition for creating a pair.
       */_rollupPluginBabelHelpers._createClass(b2ParticleSystem_JoinParticleGroupsFilter,[{key:"ShouldCreatePair",value:function ShouldCreatePair(a,b){return a<this.m_threshold&&this.m_threshold<=b||b<this.m_threshold&&this.m_threshold<=a;}/**
       * An additional condition for creating a triad.
       */},{key:"ShouldCreateTriad",value:function ShouldCreateTriad(a,b,c){return (a<this.m_threshold||b<this.m_threshold||c<this.m_threshold)&&(this.m_threshold<=a||this.m_threshold<=b||this.m_threshold<=c);}}]);return b2ParticleSystem_JoinParticleGroupsFilter;}(b2ParticleSystem_ConnectionFilter);var b2ParticleSystem_CompositeShape=/*#__PURE__*/function(_b2Shape5){_rollupPluginBabelHelpers._inherits(b2ParticleSystem_CompositeShape,_b2Shape5);function b2ParticleSystem_CompositeShape(shapes){var _this34;var shapeCount=arguments.length>1&&arguments[1]!==undefined?arguments[1]:shapes.length;_rollupPluginBabelHelpers._classCallCheck(this,b2ParticleSystem_CompositeShape);_this34=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2ParticleSystem_CompositeShape).call(this,exports.b2ShapeType.e_unknown,0));_this34.m_shapeCount=0;_this34.m_shapes=shapes;_this34.m_shapeCount=shapeCount;return _this34;}_rollupPluginBabelHelpers._createClass(b2ParticleSystem_CompositeShape,[{key:"Clone",value:function Clone(){// DEBUG: b2Assert(false);
...
}}]);return b2ParticleSystem_CompositeShape;}(b2Shape);var b2ParticleSystem_ReactiveFilter=/*#__PURE__*/function(_b2ParticleSystem_Con2){_rollupPluginBabelHelpers._inherits(b2ParticleSystem_ReactiveFilter,_b2ParticleSystem_Con2);function b2ParticleSystem_ReactiveFilter(flagsBuffer){var _this35;_rollupPluginBabelHelpers._classCallCheck(this,b2ParticleSystem_ReactiveFilter);_this35=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2ParticleSystem_ReactiveFilter).call(this));_this35.m_flagsBuffer=flagsBuffer;return _this35;}_rollupPluginBabelHelpers._createClass(b2ParticleSystem_ReactiveFilter,[{key:"IsNecessary",value:function IsNecessary(index){return (this.m_flagsBuffer.data[index]&exports.b2ParticleFlag.b2_reactiveParticle)!==0;}}]);return b2ParticleSystem_ReactiveFilter;}(b2ParticleSystem_ConnectionFilter);var b2ParticleSystem_UpdateBodyContactsCallback=/*#__PURE__*/function(_b2FixtureParticleQue){_rollupPluginBabelHelpers._inherits(b2ParticleSystem_UpdateBodyContactsCallback,_b2FixtureParticleQue);function b2ParticleSystem_UpdateBodyContactsCallback(system){var _this36;var contactFilter=arguments.length>1&&arguments[1]!==undefined?arguments[1]:null;_rollupPluginBabelHelpers._classCallCheck(this,b2ParticleSystem_UpdateBodyContactsCallback);_this36=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2ParticleSystem_UpdateBodyContactsCallback).call(this,system));// base class constructor
_this36.m_contactFilter=null;_this36.m_contactFilter=contactFilter;return _this36;}_rollupPluginBabelHelpers._createClass(b2ParticleSystem_UpdateBodyContactsCallback,[{key:"ShouldCollideFixtureParticle",value:function ShouldCollideFixtureParticle(fixture,particleSystem,particleIndex){// Call the contact filter if it's set, to determine whether to
...
function b2World(gravity){_rollupPluginBabelHelpers._classCallCheck(this,b2World);this.m_newFixture=false;this.m_locked=false;this.m_clearForces=true;this.m_contactManager=new b2ContactManager();this.m_bodyList=null;this.m_jointList=null;// #if B2_ENABLE_PARTICLE
...
/// remain in scope.
_rollupPluginBabelHelpers._createClass(b2World,[{key:"SetDestructionListener",value:function SetDestructionListener(listener){this.m_destructionListener=listener;}/// Register a contact filter to provide specific control over collision.
...
b2World.DrawDebugData_s_color=new b2Color(0,0,0);b2World.DrawDebugData_s_vs=b2Vec2.MakeArray(4);b2World.DrawDebugData_s_xf=new b2Transform();b2World.QueryFixtureShape_s_aabb=new b2AABB();b2World.RayCast_s_input=new b2RayCastInput();b2World.RayCast_s_output=new b2RayCastOutput();b2World.RayCast_s_point=new b2Vec2();b2World.DrawJoint_s_p1=new b2Vec2();b2World.DrawJoint_s_p2=new b2Vec2();b2World.DrawJoint_s_color=new b2Color(0.5,0.8,0.8);b2World.DrawJoint_s_c=new b2Color();b2World.DrawShape_s_ghostColor=new b2Color();b2World.SolveTOI_s_subStep=new b2TimeStep();b2World.SolveTOI_s_backup=new b2Sweep();b2World.SolveTOI_s_backup1=new b2Sweep();b2World.SolveTOI_s_backup2=new b2Sweep();b2World.SolveTOI_s_toi_input=new b2TOIInput();b2World.SolveTOI_s_toi_output=new b2TOIOutput();/*
   ...
   */var b2ControllerEdge=function b2ControllerEdge(controller,body){_rollupPluginBabelHelpers._classCallCheck(this,b2ControllerEdge);this.prevBody=null;///< the previous controller edge in the controllers's joint list
...
this.controller=controller;this.body=body;};/**
   ...
   */var b2Controller=/*#__PURE__*/function(){function b2Controller(){_rollupPluginBabelHelpers._classCallCheck(this,b2Controller);// m_world: b2World;
this.m_bodyList=null;this.m_bodyCount=0;this.m_prev=null;this.m_next=null;}/**
       * Get the next controller in the world's body list.
       */_rollupPluginBabelHelpers._createClass(b2Controller,[{key:"GetNext",value:function GetNext(){return this.m_next;}/**
...
/*
   ...
   * plane.
   */var b2BuoyancyController=/*#__PURE__*/function(_b2Controller){_rollupPluginBabelHelpers._inherits(b2BuoyancyController,_b2Controller);function b2BuoyancyController(){var _this38;_rollupPluginBabelHelpers._classCallCheck(this,b2BuoyancyController);_this38=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2BuoyancyController).apply(this,arguments));/**
...
/*
   ...
   */var b2ConstantAccelController=/*#__PURE__*/function(_b2Controller2){_rollupPluginBabelHelpers._inherits(b2ConstantAccelController,_b2Controller2);function b2ConstantAccelController(){var _this39;_rollupPluginBabelHelpers._classCallCheck(this,b2ConstantAccelController);_this39=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2ConstantAccelController).apply(this,arguments));/**
           * The acceleration to apply
           */_this39.A=new b2Vec2(0,0);return _this39;}_rollupPluginBabelHelpers._createClass(b2ConstantAccelController,[{key:"Step",value:function Step(step){var dtA=b2Vec2.MulSV(step.dt,this.A,b2ConstantAccelController.Step_s_dtA);for(var i=this.m_bodyList;i;i=i.nextBody){var body=i.body;if(!body.IsAwake()){continue;}body.SetLinearVelocity(b2Vec2.AddVV(body.GetLinearVelocity(),dtA,b2Vec2.s_t0));}}},{key:"Draw",value:function Draw(draw){}}]);return b2ConstantAccelController;}(b2Controller);b2ConstantAccelController.Step_s_dtA=new b2Vec2();// #endif
/*
   * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
   *
   * This software is provided 'as-is', without any express or implied
   ...
   */ /**
   * Applies a force every frame
   */var b2ConstantForceController=/*#__PURE__*/function(_b2Controller3){_rollupPluginBabelHelpers._inherits(b2ConstantForceController,_b2Controller3);function b2ConstantForceController(){var _this40;_rollupPluginBabelHelpers._classCallCheck(this,b2ConstantForceController);_this40=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2ConstantForceController).apply(this,arguments));/**
           * The force to apply
           */_this40.F=new b2Vec2(0,0);return _this40;}_rollupPluginBabelHelpers._createClass(b2ConstantForceController,[{key:"Step",value:function Step(step){for(var i=this.m_bodyList;i;i=i.nextBody){var body=i.body;if(!body.IsAwake()){continue;}body.ApplyForce(this.F,body.GetWorldCenter());}}},{key:"Draw",value:function Draw(draw){}}]);return b2ConstantForceController;}(b2Controller);// #endif
/*
   * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
   *
   * This software is provided 'as-is', without any express or implied
...
/*
   ...
   */var b2TensorDampingController=/*#__PURE__*/function(_b2Controller5){_rollupPluginBabelHelpers._inherits(b2TensorDampingController,_b2Controller5);function b2TensorDampingController(){var _this42;_rollupPluginBabelHelpers._classCallCheck(this,b2TensorDampingController);_this42=_rollupPluginBabelHelpers._possibleConstructorReturn(this,_rollupPluginBabelHelpers._getPrototypeOf(b2TensorDampingController).apply(this,arguments));/// Tensor to use in damping model
...
/*
  ...
  * 3. This notice may not be removed or altered from any source distribution.
  */ ///
var b2RopeDef=function b2RopeDef(){_rollupPluginBabelHelpers._classCallCheck(this,b2RopeDef);///
this.vertices=[];///
this.count=0;///
this.masses=[];///
...
this.k3=0.1;};///
var b2Rope=/*#__PURE__*/function(){function b2Rope(){_rollupPluginBabelHelpers._classCallCheck(this,b2Rope);this.m_count=0;this.m_ps=[];this.m_p0s=[];this.m_vs=[];this.m_ims=[];this.m_Ls=[];this.m_as=[];this.m_gravity=new b2Vec2();this.m_damping=0;this.m_k2=1;this.m_k3=0.1;}_rollupPluginBabelHelpers._createClass(b2Rope,[{key:"GetVertexCount",value:function GetVertexCount(){return this.m_count;}},{key:"GetVertices",value:function GetVertices(){return this.m_ps;}///
