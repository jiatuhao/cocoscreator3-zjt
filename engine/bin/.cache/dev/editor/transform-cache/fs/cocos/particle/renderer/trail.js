...
let TrailModule = (_dec = (0, _index.ccclass)('cc.TrailModule'), _dec2 = (0, _index.displayOrder)(0), _dec3 = (0, _index.type)(_enum.TrailMode), _dec4 = (0, _index.displayOrder)(1), _dec5 = (0, _index.tooltip)('Particle在每个粒子的运动轨迹上形成拖尾效果'), _dec6 = (0, _index.type)(_curveRange.default), _dec7 = (0, _index.displayOrder)(3), _dec8 = (0, _index.tooltip)('拖尾的生命周期'), _dec9 = (0, _index.displayOrder)(5), _dec10 = (0, _index.tooltip)('粒子每生成一个拖尾节点所运行的最短距离'), _dec11 = (0, _index.type)(_enum.Space), _dec12 = (0, _index.displayOrder)(6), _dec13 = (0, _index.tooltip)('拖尾所在的坐标系，World在世界坐标系中运行，Local在本地坐标系中运行'), _dec14 = (0, _index.type)(_enum.TextureMode), _dec15 = (0, _index.displayOrder)(8), _dec16 = (0, _index.tooltip)('贴图在拖尾上的展开形式，Stretch贴图覆盖在整条拖尾上，Repeat贴图覆盖在一段拖尾上'), _dec17 = (0, _index.displayOrder)(9), _dec18 = (0, _index.tooltip)('拖尾宽度继承自粒子大小'), _dec19 = (0, _index.type)(_curveRange.default), _dec20 = (0, _index.displayOrder)(10), _dec21 = (0, _index.tooltip)('拖尾宽度，如果继承自粒子则是粒子大小的比例'), _dec22 = (0, _index.displayOrder)(11), _dec23 = (0, _index.tooltip)('拖尾颜色是否继承自粒子'), _dec24 = (0, _index.type)(_gradientRange.default), _dec25 = (0, _index.displayOrder)(12), _dec26 = (0, _index.tooltip)('拖尾颜色随拖尾自身长度的颜色渐变'), _dec27 = (0, _index.type)(_gradientRange.default), _dec28 = (0, _index.displayOrder)(13), _dec29 = (0, _index.tooltip)('拖尾颜色随时间的颜色渐变'), _dec30 = (0, _index.type)(_enum.Space), _dec(_class = (_class2 = (_temp = class TrailModule {
  ...
  constructor() {
    ...
    this._vertAttrs = [new _index2.Attribute(_define.AttributeName.ATTR_POSITION, _define.Format.RGB32F), // xyz:position
    new _index2.Attribute(_define.AttributeName.ATTR_TEX_COORD, _define.Format.RGBA32F), // x:index y:size zw:texcoord
    // new Attribute(AttributeName.ATTR_TEX_COORD2, Format.RGB32F), // <wireframe debug>
    new _index2.Attribute(_define.AttributeName.ATTR_TEX_COORD1, _define.Format.RGB32F), // xyz:velocity
    new _index2.Attribute(_define.AttributeName.ATTR_COLOR, _define.Format.RGBA8, true)];
    this._vertSize = 0;
  ...
  rebuild() {
    ...
    const vertexBuffer = device.createBuffer(new _index2.BufferInfo(_define.BufferUsageBit.VERTEX | _define.BufferUsageBit.TRANSFER_DST, _define.MemoryUsageBit.HOST | _define.MemoryUsageBit.DEVICE, this._vertSize * (this._trailNum + 1) * 2, this._vertSize));
    ...
    const indexBuffer = device.createBuffer(new _index2.BufferInfo(_define.BufferUsageBit.INDEX | _define.BufferUsageBit.TRANSFER_DST, _define.MemoryUsageBit.HOST | _define.MemoryUsageBit.DEVICE, this._trailNum * 6 * Uint16Array.BYTES_PER_ELEMENT, Uint16Array.BYTES_PER_ELEMENT));
    this._iBuffer = new Uint16Array(this._trailNum * 6);
    indexBuffer.update(this._iBuffer);
    this._iaInfoBuffer = device.createBuffer(new _index2.BufferInfo(_define.BufferUsageBit.INDIRECT, _define.MemoryUsageBit.HOST | _define.MemoryUsageBit.DEVICE, _index2.DRAW_INFO_SIZE, _index2.DRAW_INFO_SIZE));
    this._iaInfo.drawInfos[0].vertexCount = (this._trailNum + 1) * 2;
    this._iaInfo.drawInfos[0].indexCount = this._trailNum * 6;

    this._iaInfoBuffer.update(this._iaInfo);

    this._subMeshData = new _renderingSubMesh.RenderingSubMesh([vertexBuffer], this._vertAttrs, _define.PrimitiveMode.TRIANGLE_LIST, indexBuffer, this._iaInfoBuffer);
