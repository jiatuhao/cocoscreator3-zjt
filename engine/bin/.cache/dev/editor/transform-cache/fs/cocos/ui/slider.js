...
let Slider = (_dec = (0, _index.ccclass)('cc.Slider'), _dec2 = (0, _index.help)('i18n:cc.Slider'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('UI/Slider'), _dec5 = (0, _index.requireComponent)(_index3.UITransform), _dec6 = (0, _index.type)(_sprite.Sprite), _dec7 = (0, _index.tooltip)('滑块按钮部件'), _dec8 = (0, _index.type)(Direction), _dec9 = (0, _index.tooltip)('滑动方向'), _dec10 = (0, _index.range)([0, 1, 0.01]), _dec11 = (0, _index.tooltip)('当前进度值，该数值的区间是 0 - 1 之间。'), _dec12 = (0, _index.type)([_index2.EventHandler]), _dec13 = (0, _index.tooltip)('滑动器组件事件回调函数'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (_class2 = (_temp = _class3 = class Slider extends _index2.Component {
  constructor(...args) {
    super(...args);
