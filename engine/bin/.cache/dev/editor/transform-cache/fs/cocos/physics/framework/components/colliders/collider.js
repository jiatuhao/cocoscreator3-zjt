 ...
 * 碰撞器的基类。
 */
let Collider = (_dec = (0, _index.ccclass)('cc.Collider'), _dec2 = (0, _index.type)(_rigidBody.RigidBody), _dec3 = (0, _index.displayName)('Attached'), _dec4 = (0, _index.displayOrder)(-2), _dec5 = (0, _index.type)(_physicsMaterial.PhysicsMaterial), _dec6 = (0, _index.displayName)('Material'), _dec7 = (0, _index.displayOrder)(-1), _dec8 = (0, _index.tooltip)('源材质'), _dec9 = (0, _index.displayOrder)(0), _dec10 = (0, _index.tooltip)('是否为触发器，触发器不会产生物理反馈'), _dec11 = (0, _index.type)(_index3.Vec3), _dec12 = (0, _index.displayOrder)(1), _dec13 = (0, _index.tooltip)('形状的中心点（与所在 Node 中心点的相对位置）'), _dec14 = (0, _index.type)(_physicsMaterial.PhysicsMaterial), _dec(_class = (_class2 = (_temp = _class3 = class Collider extends (0, _index2.Eventify)(_index4.Component) {
  /**
   * @en
