...
function isSupportGPUParticle() {
  ...
  if (device.maxVertexTextureUnits >= 8 && device.hasFeature(_index4.Feature.TEXTURE_FLOAT)) {
    return true;
  }
...
let ParticleSystemRenderer = (_dec = (0, _index.ccclass)('cc.ParticleSystemRenderer'), _dec2 = (0, _index.type)(_enum.RenderMode), _dec3 = (0, _index.displayOrder)(0), _dec4 = (0, _index.tooltip)('设定粒子生成模式'), _dec5 = (0, _index.displayOrder)(1), _dec6 = (0, _index.tooltip)('在粒子生成方式为 StrecthedBillboard 时,对粒子在运动方向上按速度大小进行拉伸'), _dec7 = (0, _index.displayOrder)(2), _dec8 = (0, _index.tooltip)('在粒子生成方式为 StrecthedBillboard 时,对粒子在运动方向上按粒子大小进行拉伸'), _dec9 = (0, _index.type)(_enum.RenderMode), _dec10 = (0, _index.type)(_index2.Mesh), _dec11 = (0, _index.displayOrder)(7), _dec12 = (0, _index.tooltip)('粒子发射的模型'), _dec13 = (0, _index.type)(_index3.Material), _dec14 = (0, _index.displayOrder)(8), _dec15 = (0, _index.tooltip)('粒子使用的材质'), _dec16 = (0, _index.type)(_index3.Material), _dec17 = (0, _index.displayOrder)(9), _dec18 = (0, _index.tooltip)('拖尾使用的材质'), _dec19 = (0, _index.displayOrder)(10), _dec20 = (0, _index.tooltip)('是否启用GPU粒子'), _dec(_class = (_class2 = (_temp = class ParticleSystemRenderer {
  constructor() {
