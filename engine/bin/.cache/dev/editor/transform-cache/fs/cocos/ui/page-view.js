...
const _temp_vec2 = new _index4.Vec2();
/**
...
let PageView = (_dec = (0, _index.ccclass)('cc.PageView'), _dec2 = (0, _index.help)('i18n:cc.PageView'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('UI/PageView'), _dec5 = (0, _index.type)(SizeMode), _dec6 = (0, _index.tooltip)('页面视图中每个页面大小类型'), _dec7 = (0, _index.type)(Direction), _dec8 = (0, _index.tooltip)('页面视图滚动类型'), _dec9 = (0, _index.range)([0, 1, 0.01]), _dec10 = (0, _index.tooltip)('滚动临界值，默认单位百分比，当拖拽超出该数值时，松开会自动滚动下一页，小于时则还原'), _dec11 = (0, _index.range)([0, 1, 0.01]), _dec12 = (0, _index.tooltip)('设置 PageView PageTurning 事件的发送时机'), _dec13 = (0, _index.type)(_pageViewIndicator.PageViewIndicator), _dec14 = (0, _index.tooltip)('页面视图指示器组件'), _dec15 = (0, _index.tooltip)('快速滑动翻页临界值\n当用户快速滑动时，会根据滑动开始和结束的距离与时间计算出一个速度值\n该值与此临界值相比较，如果大于临界值，则进行自动翻页'), _dec16 = (0, _index.type)(_scrollBar.ScrollBar), _dec17 = (0, _index.visible)(false), _dec18 = (0, _index.type)(_scrollBar.ScrollBar), _dec19 = (0, _index.visible)(false), _dec20 = (0, _index.visible)(false), _dec21 = (0, _index.visible)(false), _dec22 = (0, _index.visible)(false), _dec23 = (0, _index.type)([_index2.EventHandler]), _dec24 = (0, _index.visible)(false), _dec25 = (0, _index.type)([_index2.EventHandler]), _dec26 = (0, _index.tooltip)('滚动视图的事件回调函数'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (_class2 = (_temp = _class3 = class PageView extends _scrollView.ScrollView {
  constructor(...args) {
    super(...args);
    ...
    this._touchBeganPosition = new _index4.Vec3();
    this._touchEndPosition = new _index4.Vec3();
  }
  ...
  _autoScrollToPage() {
    ...
    if (bounceBackStarted) {
      ...
      const moveOffset = new _index4.Vec3();
