...
let Billboard = (_dec = (0, _index.ccclass)('cc.Billboard'), _dec2 = (0, _index.help)('i18n:cc.Billboard'), _dec3 = (0, _index.menu)('Effects/Billboard'), _dec4 = (0, _index.type)(_index4.Texture2D), _dec5 = (0, _index.type)(_index4.Texture2D), _dec6 = (0, _index.tooltip)('billboard显示的贴图'), _dec7 = (0, _index.tooltip)('billboard的高度'), _dec8 = (0, _index.tooltip)('billboard的宽度'), _dec9 = (0, _index.tooltip)('billboard绕中心点旋转的角度'), _dec(_class = _dec2(_class = _dec3(_class = (0, _index.executeInEditMode)(_class = (_class2 = (_temp = class Billboard extends _component.Component {
  /**
   * @zh Billboard纹理。
   */
  get texture() {
