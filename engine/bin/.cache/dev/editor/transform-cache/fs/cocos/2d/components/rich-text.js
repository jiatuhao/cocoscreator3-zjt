...
function createSegment(type) {
  return {
    node: new _index5.PrivateNode(type),
    comp: null,
    lineCount: 0,
    styleIndex: 0,
    imageOffset: '',
 ...
 * 富文本组件。
 */
let RichText = (_dec = (0, _index.ccclass)('cc.RichText'), _dec2 = (0, _index.help)('i18n:cc.RichText'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('2D/RichText'), _dec5 = (0, _index.tooltip)('富文本显示的文本内容'), _dec6 = (0, _index.type)(_label.HorizontalTextAlignment), _dec7 = (0, _index.tooltip)('文本内容的水平对齐方式'), _dec8 = (0, _index.tooltip)('富文本字体大小'), _dec9 = (0, _index.tooltip)('富文本定制系统字体'), _dec10 = (0, _index.type)(_index2.Font), _dec11 = (0, _index.tooltip)('富文本定制字体'), _dec12 = (0, _index.tooltip)('是否使用系统字体'), _dec13 = (0, _index.type)(_label.CacheMode), _dec14 = (0, _index.tooltip)('文本缓存模式, 该模式只支持系统字体。'), _dec15 = (0, _index.tooltip)('富文本的最大宽度'), _dec16 = (0, _index.tooltip)('富文本行高'), _dec17 = (0, _index.type)(_index2.SpriteAtlas), _dec18 = (0, _index.tooltip)('对于 img 标签里面的 src 属性名称，都需要在 imageAtlas 里面找到一个有效的 spriteFrame，否则 img tag 会判定为无效'), _dec19 = (0, _index.tooltip)('选中此选项后，RichText 将阻止节点边界框中的所有输入事件（鼠标和触摸），从而防止输入事件穿透到底层节点'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (0, _index.executeInEditMode)(_class = (_class2 = (_temp = _class3 = class RichText extends _index6.UIComponent {
  /**
   * @en
