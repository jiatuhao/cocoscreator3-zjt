...
var _prefabUtils = require("../utils/prefab-utils.js");
...
let Node = (_dec = (0, _index.ccclass)('cc.Node'), _dec2 = (0, _index.type)(_index2.Vec3), _dec(_class = (_class2 = (_temp = _class3 = class Node extends _baseNode.BaseNode {
  ...
  set hasChangedFlags(val) {
    ...
    _memoryPools.NodePool.set(this._poolHandle, _memoryPools.NodeView.FLAGS_CHANGED, val);
  } // ===============================
  // hierarchy
  // ===============================
  ...
  _onBatchCreated(dontSyncChildPrefab) {
    ...
    if (!dontSyncChildPrefab && prefabInstance) {
      (0, _prefabUtils.createNodeWithPrefab)(this);
    }
    ...
    if (!dontSyncChildPrefab && prefabInstance) {
      ...
      (0, _prefabUtils.generateTargetMap)(this, targetMap, true);
      (0, _prefabUtils.applyMountedChildren)(this, prefabInstance.mountedChildren, targetMap);
      (0, _prefabUtils.applyPropertyOverrides)(this, prefabInstance.propertyOverrides, targetMap);
    }

    (0, _prefabUtils.applyTargetOverrides)(this);
  }
  ...
  invalidateChildren(dirtyBit) {
    ...
    const newDirtyBit = dirtyBit | _nodeEnum.TransformBit.POSITION;
    const len = this._children.length;
...
}, _class3.bookOfChange = bookOfChange, _class3.EventType = _eventEnum.SystemEventType, _class3.NodeSpace = _nodeEnum.NodeSpace, _class3.TransformDirtyBit = _nodeEnum.TransformBit, _class3.TransformBit = _nodeEnum.TransformBit, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "_lpos", [_index.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
