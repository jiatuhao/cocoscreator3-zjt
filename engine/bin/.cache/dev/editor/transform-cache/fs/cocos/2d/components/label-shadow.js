 ...
 */
let LabelShadow = (_dec = (0, _index.ccclass)('cc.LabelShadow'), _dec2 = (0, _index.help)('i18n:cc.LabelShadow'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('UI/LabelShadow'), _dec5 = (0, _index.requireComponent)(_label.Label), _dec6 = (0, _index.tooltip)('描边的颜色'), _dec7 = (0, _index.tooltip)('字体与阴影的偏移'), _dec8 = (0, _index.tooltip)('阴影的模糊程度'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (0, _index.executeInEditMode)(_class = (_class2 = (_temp = class LabelShadow extends _component.Component {
  constructor(...args) {
    super(...args);
