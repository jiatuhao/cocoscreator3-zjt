...
let Toggle = (_dec = (0, _index.ccclass)('cc.Toggle'), _dec2 = (0, _index.help)('i18n:cc.Toggle'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('UI/Toggle'), _dec5 = (0, _index.requireComponent)(_index2.UITransform), _dec6 = (0, _index.displayOrder)(2), _dec7 = (0, _index.tooltip)('如果这个设置为 true，则 check mark 组件会处于 enabled 状态，否则处于 disabled 状态。'), _dec8 = (0, _index.type)(_sprite.Sprite), _dec9 = (0, _index.displayOrder)(3), _dec10 = (0, _index.tooltip)('Toggle 处于选中状态时显示的精灵图片'), _dec11 = (0, _index.type)([_componentEventHandler.EventHandler]), _dec12 = (0, _index.tooltip)('列表类型，默认为空，用户添加的每一个事件由节点引用，组件名称和一个响应函数组成'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (_class2 = (_temp = _class3 = class Toggle extends _button.Button {
  constructor(...args) {
    super(...args);
