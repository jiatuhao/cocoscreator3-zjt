...
(0, _enum.ccenum)(_define.TextureType);
(0, _enum.ccenum)(_define.TextureUsageBit);
(0, _enum.ccenum)(_define.StoreOp);
(0, _enum.ccenum)(_define.LoadOp);
(0, _enum.ccenum)(_define.TextureLayout);
/**
...
let RenderTextureDesc = (_dec = (0, _index.ccclass)('RenderTextureDesc'), _dec2 = (0, _index.type)(_define.TextureType), _dec3 = (0, _index.type)(_define.TextureUsageBit), _dec4 = (0, _index.type)(_define.Format), _dec(_class = (_class2 = (_temp = class RenderTextureDesc {
  constructor() {
  ...
  writable: true,
  initializer: function () {
    return _define.TextureType.TEX2D;
  }
  ...
  writable: true,
  initializer: function () {
    return _define.TextureUsageBit.COLOR_ATTACHMENT;
  }
...
let ColorDesc = (_dec12 = (0, _index.ccclass)('ColorDesc'), _dec13 = (0, _index.type)(_define.Format), _dec14 = (0, _index.type)(_define.LoadOp), _dec15 = (0, _index.type)(_define.StoreOp), _dec16 = (0, _index.type)(_define.TextureLayout), _dec17 = (0, _index.type)(_define.TextureLayout), _dec12(_class13 = (_class14 = (_temp5 = class ColorDesc {
  constructor() {
  ...
  writable: true,
  initializer: function () {
    return _define.TextureLayout.UNDEFINED;
  }
  ...
  writable: true,
  initializer: function () {
    return _define.TextureLayout.PRESENT_SRC;
  }
})), _class14)) || _class13);
exports.ColorDesc = ColorDesc;
let DepthStencilDesc = (_dec18 = (0, _index.ccclass)('DepthStencilDesc'), _dec19 = (0, _index.type)(_define.Format), _dec20 = (0, _index.type)(_define.LoadOp), _dec21 = (0, _index.type)(_define.StoreOp), _dec22 = (0, _index.type)(_define.LoadOp), _dec23 = (0, _index.type)(_define.StoreOp), _dec24 = (0, _index.type)(_define.TextureLayout), _dec25 = (0, _index.type)(_define.TextureLayout), _dec18(_class16 = (_class17 = (_temp6 = class DepthStencilDesc {
  constructor() {
  ...
  writable: true,
  initializer: function () {
    return _define.TextureLayout.DEPTH_STENCIL_ATTACHMENT_OPTIMAL;
  }
})), _class17)) || _class16);
