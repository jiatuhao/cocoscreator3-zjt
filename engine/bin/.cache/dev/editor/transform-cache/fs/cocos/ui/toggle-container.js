 ...
 */
let ToggleContainer = (_dec = (0, _index.ccclass)('cc.ToggleContainer'), _dec2 = (0, _index.help)('i18n:cc.ToggleContainer'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('UI/ToggleContainer'), _dec5 = (0, _index.tooltip)('如果这个设置为 true， 那么 toggle 按钮在被点击的时候可以反复地被选中和未选中。'), _dec6 = (0, _index.type)([_index2.EventHandler]), _dec7 = (0, _index.tooltip)('选中事件。列表类型，默认为空，用户添加的每一个事件由节点引用，组件名称和一个响应函数组成。'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (0, _index.executeInEditMode)(_class = (_class2 = (_temp = class ToggleContainer extends _index2.Component {
  constructor(...args) {
    super(...args);
