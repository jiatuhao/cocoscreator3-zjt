...
let EditBox = (_dec = (0, _index.ccclass)('cc.EditBox'), _dec2 = (0, _index.help)('i18n:cc.EditBox'), _dec3 = (0, _index.executionOrder)(100), _dec4 = (0, _index.menu)('UI/EditBox'), _dec5 = (0, _index.requireComponent)(_index2.UITransform), _dec6 = (0, _index.displayOrder)(1), _dec7 = (0, _index.tooltip)('输入框的初始输入内容，如果为空则会显示占位符的文本'), _dec8 = (0, _index.displayOrder)(2), _dec9 = (0, _index.tooltip)('输入框占位符的文本内容'), _dec10 = (0, _index.type)(_label.Label), _dec11 = (0, _index.displayOrder)(3), _dec12 = (0, _index.tooltip)('输入框输入文本节点上挂载的 Label 组件对象'), _dec13 = (0, _index.type)(_label.Label), _dec14 = (0, _index.displayOrder)(4), _dec15 = (0, _index.tooltip)('输入框占位符节点上挂载的 Label 组件对象'), _dec16 = (0, _index.type)(_spriteFrame.SpriteFrame), _dec17 = (0, _index.displayOrder)(5), _dec18 = (0, _index.tooltip)('输入框的背景图片'), _dec19 = (0, _index.type)(_types.InputFlag), _dec20 = (0, _index.displayOrder)(6), _dec21 = (0, _index.tooltip)('指定输入标志位，可以指定输入方式为密码或者单词首字母大写'), _dec22 = (0, _index.type)(_types.InputMode), _dec23 = (0, _index.displayOrder)(7), _dec24 = (0, _index.tooltip)('指定输入模式: ANY 表示多行输入，其它都是单行输入，移动平台上还可以指定键盘样式'), _dec25 = (0, _index.type)(_types.KeyboardReturnType), _dec26 = (0, _index.displayOrder)(8), _dec27 = (0, _index.tooltip)('指定移动设备上面回车按钮的样式'), _dec28 = (0, _index.displayOrder)(9), _dec29 = (0, _index.tooltip)('输入框最大允许输入的字符个数'), _dec30 = (0, _index.displayOrder)(10), _dec31 = (0, _index.tooltip)('修改 DOM 输入元素的 tabIndex（这个属性只有在 Web 上面修改有意义）'), _dec32 = (0, _index.type)([_componentEventHandler.EventHandler]), _dec33 = (0, _index.displayOrder)(11), _dec34 = (0, _index.tooltip)('该事件在用户点击输入框获取焦点的时候被触发'), _dec35 = (0, _index.type)([_componentEventHandler.EventHandler]), _dec36 = (0, _index.displayOrder)(12), _dec37 = (0, _index.tooltip)('编辑文本输入框时触发的事件回调'), _dec38 = (0, _index.type)([_componentEventHandler.EventHandler]), _dec39 = (0, _index.displayOrder)(13), _dec40 = (0, _index.tooltip)('在单行模式下面，一般是在用户按下回车或者点击屏幕输入框以外的地方调用该函数。 如果是多行输入，一般是在用户点击屏幕输入框以外的地方调用该函数'), _dec41 = (0, _index.type)([_componentEventHandler.EventHandler]), _dec42 = (0, _index.displayOrder)(14), _dec43 = (0, _index.tooltip)('该事件在用户按下回车键的时候被触发, 如果是单行输入框，按回车键还会使输入框失去焦点'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (0, _index.executeInEditMode)(_class = (_class2 = (_temp = _class3 = class EditBox extends _component.Component {
  constructor(...args) {
    super(...args);
