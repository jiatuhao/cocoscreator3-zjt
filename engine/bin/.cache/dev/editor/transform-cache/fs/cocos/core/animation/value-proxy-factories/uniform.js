...
let UniformProxyFactory = (_dec = (0, _index.ccclass)('cc.animation.UniformProxyFactory'), _dec(_class = (_class2 = (_temp = class UniformProxyFactory {
  ...
  forTarget(target) {
    ...
    if (propertyType === _passUtils.PropertyType.UBO) {
      const realHandle = this.channelIndex === undefined ? handle : pass.getHandle(this.uniformName, this.channelIndex, _define.Type.FLOAT);
    ...
    if (propertyType === _passUtils.PropertyType.SAMPLER) {
