...
exports.ArmatureCache = exports.AnimationCache = void 0;
      ...
      for (let i = 0, l = bones.length; i < l; i++, _boneInfoOffset++) {
        ...
        if (!boneInfo) {
          boneInfo = boneInfos[_boneInfoOffset] = {
            globalTransformMatrix: new _dragonbonesJs.Matrix()
          };
        }
...
class ArmatureCache {
  ...
  getArmatureCache(armatureName, armatureKey, atlasUUID) {
    ...
    if (!armatureInfo) {
      const factory = _CCFactory.CCFactory.getInstance();
...
exports.ArmatureCache = ArmatureCache;
