...
let Mask = (_dec = (0, _index.ccclass)('cc.Mask'), _dec2 = (0, _index.help)('i18n:cc.Mask'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('2D/Mask'), _dec5 = (0, _index.type)(MaskType), _dec6 = (0, _index.displayOrder)(10), _dec7 = (0, _index.tooltip)('遮罩类型'), _dec8 = (0, _index.displayOrder)(14), _dec9 = (0, _index.tooltip)('反向遮罩'), _dec10 = (0, _index.visible)(function () {
  ...
  return this.type === MaskType.IMAGE_STENCIL;
}), _dec14 = (0, _index.range)([0, 1, 0.1]), _dec15 = (0, _index.visible)(false), _dec16 = (0, _index.visible)(false), _dec17 = (0, _index.visible)(false), _dec18 = (0, _index.visible)(false), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (_class2 = (_temp = _class3 = class Mask extends _renderable2d.Renderable2D {
  /**
   * @en
   * The mask type.
   *
  ...
  _createClearModel() {
    if (!this._clearModel) {
      ...
      const renderMesh = new _index4.RenderingSubMesh([vertexBuffer], _vertexFormat.vfmt, _index5.PrimitiveMode.TRIANGLE_LIST, indexBuffer);
