...
class Downloader {
  constructor() {
    ...
    this.maxRetryCount = _internal253Aconstants.EDITOR ? 0 : 3;
  ...
  importBundleEntry(bundleName) {
    return Promise.resolve(`virtual:///prerequisite-imports/${bundleName}`).then(s => _interopRequireWildcard(require(s)));
  }
  /**
   * @en
