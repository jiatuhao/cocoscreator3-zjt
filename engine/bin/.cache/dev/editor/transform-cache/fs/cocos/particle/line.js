...
let Line = (_dec = (0, _index.ccclass)('cc.Line'), _dec2 = (0, _index.help)('i18n:cc.Line'), _dec3 = (0, _index.menu)('Effects/Line'), _dec4 = (0, _index.type)(_index2.Texture2D), _dec5 = (0, _index.type)(_index2.Texture2D), _dec6 = (0, _index.displayOrder)(0), _dec7 = (0, _index.tooltip)('线段中显示的贴图'), _dec8 = (0, _index.displayOrder)(1), _dec9 = (0, _index.tooltip)('线段中各个点的坐标采用哪个坐标系，勾选使用世界坐标系，不选使用本地坐标系'), _dec10 = (0, _index.type)([_index4.Vec3]), _dec11 = (0, _index.type)([_index4.Vec3]), _dec12 = (0, _index.displayOrder)(2), _dec13 = (0, _index.tooltip)('每个线段端点的坐标'), _dec14 = (0, _index.type)(_curveRange.default), _dec15 = (0, _index.type)(_curveRange.default), _dec16 = (0, _index.displayOrder)(3), _dec17 = (0, _index.tooltip)('线段宽度，如果采用曲线，则表示沿着线段方向上的曲线变化'), _dec18 = (0, _index.type)(_index4.Vec2), _dec19 = (0, _index.displayOrder)(4), _dec20 = (0, _index.tooltip)('贴图平铺次数'), _dec21 = (0, _index.type)(_index4.Vec2), _dec22 = (0, _index.displayOrder)(5), _dec23 = (0, _index.tooltip)('贴图坐标的偏移'), _dec24 = (0, _index.type)(_gradientRange.default), _dec25 = (0, _index.type)(_gradientRange.default), _dec26 = (0, _index.displayOrder)(6), _dec27 = (0, _index.tooltip)('线段颜色，如果采用渐变色，则表示沿着线段方向上的颜色渐变'), _dec(_class = _dec2(_class = _dec3(_class = (0, _index.executeInEditMode)(_class = (_class2 = (_temp = class Line extends _index3.Component {
  /**
   * @zh 显示的纹理。
   */
  get texture() {
