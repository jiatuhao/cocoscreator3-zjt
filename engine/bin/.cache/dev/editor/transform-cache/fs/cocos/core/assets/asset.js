 ...
 * @extends CCObject
 */
let Asset = (_dec = (0, _index.ccclass)('cc.Asset'), _dec(_class = (_class2 = (_temp = _class3 = class Asset extends (0, _index2.Eventify)(_object.CCObject) {
  /**
  ...
  constructor(...args) {
    ...
    this.__asyncLoadAssets__ = false;
...
}, _class3.preventDeferredLoadDependents = false, _class3.preventPreloadNativeObject = false, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "_native", [_index.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
