...
let Label = (_dec = (0, _index.ccclass)('cc.Label'), _dec2 = (0, _index.help)('i18n:cc.Label'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('2D/Label'), _dec5 = (0, _index.displayOrder)(4), _dec6 = (0, _index.tooltip)('Label 显示的文本内容字符串'), _dec7 = (0, _index.type)(HorizontalTextAlignment), _dec8 = (0, _index.displayOrder)(5), _dec9 = (0, _index.tooltip)('文字水平对齐模式'), _dec10 = (0, _index.type)(VerticalTextAlignment), _dec11 = (0, _index.displayOrder)(6), _dec12 = (0, _index.tooltip)('文字垂直对齐模式'), _dec13 = (0, _index.displayOrder)(7), _dec14 = (0, _index.tooltip)('文字尺寸，以 point 为单位'), _dec15 = (0, _index.displayOrder)(8), _dec16 = (0, _index.visible)(function () {
  return !this._isSystemFontUsed;
}), _dec17 = (0, _index.tooltip)('文字字体名字'), _dec18 = (0, _index.displayOrder)(8), _dec19 = (0, _index.tooltip)('文字行高，以 point 为单位'), _dec20 = (0, _index.type)(Overflow), _dec21 = (0, _index.displayOrder)(9), _dec22 = (0, _index.tooltip)('文字排版模式，包括以下三种：\n 1. CLAMP: 节点约束框之外的文字会被截断 \n 2. SHRINK: 自动根据节点约束框缩小文字\n 3. RESIZE_HEIGHT: 根据文本内容自动更新节点的 height 属性.'), _dec23 = (0, _index.displayOrder)(10), _dec24 = (0, _index.tooltip)('自动换行'), _dec25 = (0, _index.type)(_index2.Font), _dec26 = (0, _index.displayOrder)(11), _dec27 = (0, _index.visible)(function () {
  return !this._isSystemFontUsed;
}), _dec28 = (0, _index.tooltip)('Label 使用的字体资源'), _dec29 = (0, _index.displayOrder)(12), _dec30 = (0, _index.tooltip)('是否使用系统默认字体'), _dec31 = (0, _index.type)(CacheMode), _dec32 = (0, _index.displayOrder)(13), _dec33 = (0, _index.tooltip)('文本缓存模式，包括以下三种：\n 1. NONE: 不做任何缓存，文本内容进行一次绘制 \n 2. BITMAP: 将文本作为静态图像加入动态图集进行批次合并，但是不能频繁动态修改文本内容 \n 3. CHAR: 将文本拆分为字符并且把字符纹理缓存到一张字符图集中进行复用，适用于字符内容重复并且频繁更新的文本内容'), _dec34 = (0, _index.displayOrder)(15), _dec35 = (0, _index.tooltip)('字体加粗'), _dec36 = (0, _index.displayOrder)(16), _dec37 = (0, _index.tooltip)('字体倾斜'), _dec38 = (0, _index.displayOrder)(17), _dec39 = (0, _index.tooltip)('字体加下划线'), _dec40 = (0, _index.visible)(function () {
