...
const proto = Component.prototype; // @ts-expect-error

proto.update = null; // @ts-expect-error

proto.lateUpdate = null; // @ts-expect-error

proto.__preload = null; // @ts-expect-error

proto.onLoad = null; // @ts-expect-error

proto.start = null; // @ts-expect-error

proto.onEnable = null; // @ts-expect-error

proto.onDisable = null; // @ts-expect-error

proto.onDestroy = null; // @ts-expect-error

proto.onFocusInEditor = null; // @ts-expect-error

proto.onLostFocusInEditor = null; // @ts-expect-error

proto.resetInEditor = null; // @ts-expect-error

proto._getLocalBounds = null; // @ts-expect-error

proto.onRestore = null; // @ts-expect-error

Component._requireComponent = null; // @ts-expect-error
...
if (_internal253Aconstants.EDITOR || _internal253Aconstants.TEST) {
  ...
  // @ts-expect-error
  Component._executeInEditMode = false; // @ts-expect-error

  Component._playOnFocus = false; // @ts-expect-error

  Component._disallowMultiple = null; // @ts-expect-error
