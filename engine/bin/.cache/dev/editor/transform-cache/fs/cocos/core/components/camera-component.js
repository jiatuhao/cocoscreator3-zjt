...
const ClearFlag = (0, _index4.Enum)({
  SKYBOX: _camera.SKYBOX_FLAG | _define.ClearFlag.DEPTH_STENCIL,
  SOLID_COLOR: _define.ClearFlag.ALL,
  DEPTH_ONLY: _define.ClearFlag.DEPTH_STENCIL,
  DONT_CLEAR: _define.ClearFlag.NONE
});
