...
var _pipelineState = require("../../core/gfx/pipeline-state.js");

var _globalExports = require("../../core/global-exports.js");

var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _class3, _temp;
...
// hack
(0, _enum.ccenum)(_define.BlendFactor);
/**
 * @en
...
let Renderable2D = (_dec = (0, _index.ccclass)('cc.Renderable2D'), _dec2 = (0, _index.requireComponent)(_uiTransform.UITransform), _dec3 = (0, _index.visible)(false), _dec4 = (0, _index.type)(_index4.Material), _dec5 = (0, _index.type)(_index4.Material), _dec6 = (0, _index.displayOrder)(0), _dec7 = (0, _index.displayName)('CustomMaterial'), _dec8 = (0, _index.visible)(function () {
  if (this._customMaterial) {
    return false;
  }

  return true;
}), _dec9 = (0, _index.type)(_define.BlendFactor), _dec10 = (0, _index.displayOrder)(0), _dec11 = (0, _index.tooltip)('Source blend factor'), _dec12 = (0, _index.visible)(function () {
  if (this._customMaterial) {
    return false;
  }

  return true;
}), _dec13 = (0, _index.type)(_define.BlendFactor), _dec14 = (0, _index.displayOrder)(1), _dec15 = (0, _index.tooltip)('destination blend factor'), _dec16 = (0, _index.displayOrder)(2), _dec17 = (0, _index.tooltip)('渲染颜色'), _dec(_class = _dec2(_class = (0, _index.disallowMultiple)(_class = (0, _index.executeInEditMode)(_class = (_class2 = (_temp = _class3 = class Renderable2D extends _renderableComponent.RenderableComponent {
  constructor(...args) {
    super(...args);
    ...
    this._blendState = new _pipelineState.BlendState();
    this._blendHash = 0;
  ...
  _updateBlendFunc() {
    ...
    if (!target) {
      target = new _pipelineState.BlendTarget();
    ...
    if (target.blendDst !== this._dstBlendFactor || target.blendSrc !== this._srcBlendFactor) {
      target.blend = true;
      target.blendDstAlpha = _define.BlendFactor.ONE_MINUS_SRC_ALPHA;
...
}, _class3.BlendState = _define.BlendFactor, _class3.Assembler = null, _class3.PostAssembler = null, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "_materials", [_index.override], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _applyDecoratedDescriptor(_class2.prototype, "customMaterial", [_dec5, _dec6, _dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "customMaterial"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "srcBlendFactor", [_dec8, _dec9, _dec10, _dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "srcBlendFactor"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "dstBlendFactor", [_dec12, _dec13, _dec14, _dec15], Object.getOwnPropertyDescriptor(_class2.prototype, "dstBlendFactor"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "color", [_dec16, _dec17], Object.getOwnPropertyDescriptor(_class2.prototype, "color"), _class2.prototype), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "_srcBlendFactor", [_index.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
    return _define.BlendFactor.SRC_ALPHA;
  }
  ...
  writable: true,
  initializer: function () {
    return _define.BlendFactor.ONE_MINUS_SRC_ALPHA;
  }
