...
let Canvas = (_dec = (0, _index.ccclass)('cc.Canvas'), _dec2 = (0, _index.help)('i18n:cc.Canvas'), _dec3 = (0, _index.executionOrder)(100), _dec4 = (0, _index.menu)('UI/Canvas'), _dec5 = (0, _index.type)(_cameraComponent.Camera), _dec6 = (0, _index.tooltip)('2D渲染相机'), _dec7 = (0, _index.tooltip)('是否自动为 camera 计算参数'), _dec8 = (0, _index.type)(_cameraComponent.Camera), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (0, _index.executeInEditMode)(_class = (0, _index.disallowMultiple)(_class = (_class2 = (_temp = class Canvas extends _renderRoot2d.RenderRoot2D {
  /**
   * @en
