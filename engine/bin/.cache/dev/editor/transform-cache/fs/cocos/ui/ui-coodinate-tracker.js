 ...
 */
let UICoordinateTracker = (_dec = (0, _index.ccclass)('cc.UICoordinateTracker'), _dec2 = (0, _index.help)('i18n:cc.UICoordinateTracker'), _dec3 = (0, _index.menu)('UI/UICoordinateTracker'), _dec4 = (0, _index.executionOrder)(110), _dec5 = (0, _index.type)(_node.Node), _dec6 = (0, _index.tooltip)('目标对象'), _dec7 = (0, _index.type)(_index2.Camera), _dec8 = (0, _index.tooltip)('照射相机'), _dec9 = (0, _index.tooltip)('是否是缩放映射'), _dec10 = (0, _index.tooltip)('距相机多少距离为正常显示计算大小'), _dec11 = (0, _index.type)([_componentEventHandler.EventHandler]), _dec12 = (0, _index.tooltip)('映射数据事件。回调的第一个参数是映射后的本地坐标，第二个是距相机距离比'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (_class2 = (_temp = class UICoordinateTracker extends _component.Component {
  constructor(...args) {
    super(...args);
