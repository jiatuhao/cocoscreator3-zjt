...
let SubContextView = (_dec = (0, _index.ccclass)('cc.SubContextView'), _dec2 = (0, _index.help)('i18n:cc.SubContextView'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.requireComponent)(_uiTransform.UITransform), _dec5 = (0, _index.menu)('Miscellaneous/SubContextView'), _dec6 = (0, _index.tooltip)('子域的设计分辨率，禁止在运行时动态更新'), _dec7 = (0, _index.tooltip)('主域更新子域贴图的频率'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (_class2 = (_temp = class SubContextView extends _component.Component {
  ...
  constructor() {
    ...
    this._content = new _index2.PrivateNode('content');
    this._sprite = null;
