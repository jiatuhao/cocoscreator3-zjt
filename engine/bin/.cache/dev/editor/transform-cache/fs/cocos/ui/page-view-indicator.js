...
let PageViewIndicator = (_dec = (0, _index.ccclass)('cc.PageViewIndicator'), _dec2 = (0, _index.help)('i18n:cc.PageViewIndicator'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('UI/PageViewIndicator'), _dec5 = (0, _index.type)(_index2.SpriteFrame), _dec6 = (0, _index.tooltip)('每个页面标记显示的图片'), _dec7 = (0, _index.type)(Direction), _dec8 = (0, _index.tooltip)('页面标记摆放方向'), _dec9 = (0, _index.type)(_index4.Size), _dec10 = (0, _index.tooltip)('每个页面标记的大小'), _dec11 = (0, _index.tooltip)('每个页面标记之间的边距'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (_class2 = (_temp = _class3 = class PageViewIndicator extends _index3.Component {
  constructor(...args) {
    super(...args);
