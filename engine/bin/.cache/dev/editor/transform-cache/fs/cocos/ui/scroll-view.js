...
let ScrollView = (_dec = (0, _index.ccclass)('cc.ScrollView'), _dec2 = (0, _index.help)('i18n:cc.ScrollView'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('UI/ScrollView'), _dec5 = (0, _index.requireComponent)(_index2.UITransform), _dec6 = (0, _index.range)([0, 10]), _dec7 = (0, _index.displayOrder)(0), _dec8 = (0, _index.tooltip)('回弹持续的时间，0 表示将立即反弹'), _dec9 = (0, _index.range)([0, 1, 0.1]), _dec10 = (0, _index.displayOrder)(1), _dec11 = (0, _index.tooltip)('开启惯性后，在用户停止触摸后滚动多快停止，0 表示永不停止，1 表示立刻停止'), _dec12 = (0, _index.displayOrder)(2), _dec13 = (0, _index.tooltip)('是否允许滚动内容超过边界，并在停止触摸后回弹'), _dec14 = (0, _index.displayOrder)(3), _dec15 = (0, _index.tooltip)('是否开启滚动惯性'), _dec16 = (0, _index.type)(_node.Node), _dec17 = (0, _index.displayOrder)(4), _dec18 = (0, _index.tooltip)('可滚动展示内容的节点'), _dec19 = (0, _index.displayOrder)(5), _dec20 = (0, _index.tooltip)('是否开启水平滚动'), _dec21 = (0, _index.type)(_scrollBar.ScrollBar), _dec22 = (0, _index.displayOrder)(6), _dec23 = (0, _index.tooltip)('水平滚动的 ScrollBar'), _dec24 = (0, _index.displayOrder)(7), _dec25 = (0, _index.tooltip)('是否开启垂直滚动'), _dec26 = (0, _index.type)(_scrollBar.ScrollBar), _dec27 = (0, _index.displayOrder)(8), _dec28 = (0, _index.tooltip)('垂直滚动的 ScrollBar'), _dec29 = (0, _index.displayOrder)(9), _dec30 = (0, _index.tooltip)('滚动行为是否会取消子节点上注册的触摸事件'), _dec31 = (0, _index.type)([_componentEventHandler.EventHandler]), _dec32 = (0, _index.displayOrder)(10), _dec33 = (0, _index.tooltip)('滚动视图的事件回调函数'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (_class2 = (_temp = _class3 = class ScrollView extends _viewGroup.ViewGroup {
  constructor(...args) {
    super(...args);
  ...
  _startAttenuatingAutoScroll(deltaMove, initialVelocity) {
    const targetDelta = new _index5.Vec3(deltaMove);
    ...
    if (this.brake > 0 && factor > 7) {
      ...
      const a = new _index5.Vec3(deltaMove);
  ...
  _getHowMuchOutOfBoundary(addition) {
    ...
    let outOfBoundaryAmount = new _index5.Vec3();
  ...
  _processAutoScrolling(dt) {
    ...
    const a = new _index5.Vec3(this._autoScrollTargetDelta);
    a.multiplyScalar(percentage);
    const newPosition = new _index5.Vec3(this._autoScrollStartPosition);
    newPosition.add(a);
    ...
    if (this.elastic) {
      const brakeOffsetPosition = new _index5.Vec3(newPosition);
      ...
      const moveDelta = new _index5.Vec3(newPosition);
    ...
    const deltaMove = new _index5.Vec3(newPosition);
