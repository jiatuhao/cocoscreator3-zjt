...
}), _dec41 = (0, _index.type)(_attribute.CCBoolean), _dec42 = (0, _index.visible)(function () {
  return this._type === _shadows.ShadowType.ShadowMap;
...
}), _dec45 = (0, _index.type)(_attribute.CCFloat), _dec46 = (0, _index.visible)(function () {
  return this._type === _shadows.ShadowType.ShadowMap && this._autoAdapt === false;
}), _dec47 = (0, _index.type)(_attribute.CCFloat), _dec48 = (0, _index.visible)(function () {
  return this._type === _shadows.ShadowType.ShadowMap && this._autoAdapt === false;
}), _dec49 = (0, _index.type)(_attribute.CCInteger), _dec50 = (0, _index.visible)(function () {
  return this._type === _shadows.ShadowType.ShadowMap && this._autoAdapt === false;
}), _dec51 = (0, _index.visible)(function () {
  return this._type === _shadows.ShadowType.ShadowMap && this._autoAdapt === false;
}), _dec52 = (0, _index.type)(_attribute.CCFloat), _dec53 = (0, _index.visible)(function () {
  return this._type === _shadows.ShadowType.ShadowMap && this._autoAdapt === false;
}), _dec54 = (0, _index.type)(_attribute.CCFloat), _dec55 = (0, _index.visible)(function () {
  return this._type === _shadows.ShadowType.ShadowMap && this._autoAdapt === false;
...
}), _descriptor25 = _applyDecoratedDescriptor(_class11.prototype, "_near", [_index.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor26 = _applyDecoratedDescriptor(_class11.prototype, "_far", [_index.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor27 = _applyDecoratedDescriptor(_class11.prototype, "_aspect", [_index.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor28 = _applyDecoratedDescriptor(_class11.prototype, "_orthoSize", [_index.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor29 = _applyDecoratedDescriptor(_class11.prototype, "_maxReceived", [_index.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor30 = _applyDecoratedDescriptor(_class11.prototype, "_size", [_index.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
let SceneGlobals = (_dec56 = (0, _index.ccclass)('cc.SceneGlobals'), _dec57 = (0, _index.type)(SkyboxInfo), _dec56(_class13 = (_class14 = (_temp5 = class SceneGlobals {
  constructor() {
...
}, _temp5), (_descriptor31 = _applyDecoratedDescriptor(_class14.prototype, "ambient", [_index.serializable, _index.editable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor32 = _applyDecoratedDescriptor(_class14.prototype, "shadows", [_index.serializable, _index.editable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor33 = _applyDecoratedDescriptor(_class14.prototype, "_skybox", [_index.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor34 = _applyDecoratedDescriptor(_class14.prototype, "fog", [_index.editable, _index.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _applyDecoratedDescriptor(_class14.prototype, "skybox", [_index.editable, _dec57], Object.getOwnPropertyDescriptor(_class14.prototype, "skybox"), _class14.prototype)), _class14)) || _class13);
