...
let Graphics = (_dec = (0, _index.ccclass)('cc.Graphics'), _dec2 = (0, _index.help)('i18n:cc.Graphics'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('2D/Graphics'), _dec5 = (0, _index.type)(_types.LineJoin), _dec6 = (0, _index.tooltip)('两条线相交时，所创建的拐角类型'), _dec7 = (0, _index.type)(_types.LineCap), _dec8 = (0, _index.tooltip)('线条的结束端点样式'), _dec9 = (0, _index.tooltip)('笔触的颜色'), _dec10 = (0, _index.tooltip)('填充绘画的颜色'), _dec11 = (0, _index.tooltip)('最大斜接长度'), _dec12 = (0, _index.visible)(false), _dec13 = (0, _index.visible)(false), _dec14 = (0, _index.visible)(false), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (_class2 = (_temp = _class3 = class Graphics extends _renderable2d.Renderable2D {
  /**
   * @en
   * Current line width.
   *
