 ...
 * 参考 [[EventType]]
 */
let Animation = (_dec = (0, _index.ccclass)('cc.Animation'), _dec2 = (0, _index.help)('i18n:cc.Animation'), _dec3 = (0, _index.executionOrder)(99), _dec4 = (0, _index.menu)('Animation/Animation'), _dec5 = (0, _index.type)([_animationClip.AnimationClip]), _dec6 = (0, _index.tooltip)('此动画组件管理的动画剪辑'), _dec7 = (0, _index.type)(_animationClip.AnimationClip), _dec8 = (0, _index.tooltip)('默认动画剪辑'), _dec9 = (0, _index.tooltip)('是否在动画组件开始运行时自动播放默认动画剪辑'), _dec10 = (0, _index.type)([_animationClip.AnimationClip]), _dec(_class = _dec2(_class = _dec3(_class = (0, _index.executeInEditMode)(_class = _dec4(_class = (_class2 = (_temp = _class3 = class Animation extends (0, _eventify.Eventify)(_component.Component) {
  constructor(...args) {
    super(...args);
