  ...
  _init(groupInfo, mapInfo, texGrids) {
    ...
    for (let i = 0, l = objects.length; i < l; i++) {
      ...
      if (objType === _tiledTypes.TMXObjectType.TEXT) {
        ...
        if (imgNode instanceof _index4.PrivateNode) {
        ...
        sprite.srcBlendFactor = this._premultiplyAlpha ? _index3.BlendFactor.ONE : _index3.BlendFactor.SRC_ALPHA;
        sprite.dstBlendFactor = _index3.BlendFactor.ONE_MINUS_SRC_ALPHA;
