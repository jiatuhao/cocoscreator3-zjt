...
let ScrollBar = (_dec = (0, _index.ccclass)('cc.ScrollBar'), _dec2 = (0, _index.help)('i18n:cc.ScrollBar'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('UI/ScrollBar'), _dec5 = (0, _index.requireComponent)(_index2.UITransform), _dec6 = (0, _index.type)(_sprite.Sprite), _dec7 = (0, _index.displayOrder)(0), _dec8 = (0, _index.tooltip)('作为当前滚动区域位置显示的滑块 Sprite'), _dec9 = (0, _index.type)(Direction), _dec10 = (0, _index.displayOrder)(1), _dec11 = (0, _index.tooltip)('ScrollBar 的滚动方向'), _dec12 = (0, _index.displayOrder)(2), _dec13 = (0, _index.tooltip)('是否在没有滚动动作时自动隐藏 ScrollBar'), _dec14 = (0, _index.displayOrder)(3), _dec15 = (0, _index.tooltip)('没有滚动动作后经过多久会自动隐藏。\n注意：只要当 “enableAutoHide” 为 true 时，才有效。'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (_class2 = (_temp = _class3 = class ScrollBar extends _component.Component {
  constructor(...args) {
    super(...args);
  ...
  _fixupHandlerPosition() {
    ...
    let fixupPosition = new _index3.Vec3();
