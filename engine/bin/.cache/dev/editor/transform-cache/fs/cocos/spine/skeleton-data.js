 ...
 * @extends Asset
 */
let SkeletonData = (_dec = (0, _index2.ccclass)('sp.SkeletonData'), _dec2 = (0, _index2.type)([_index.Texture2D]), _dec3 = (0, _index2.type)([_index.CCString]), _dec(_class = (_class2 = (_temp = _class3 = class SkeletonData extends _index.Asset {
  // use by jsb
  get skeletonJsonStr() {
...
}, _class3.preventDeferredLoadDependents = true, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "_skeletonJson", [_index2.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
