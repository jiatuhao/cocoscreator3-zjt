...
let UITransform = (_dec = (0, _index.ccclass)('cc.UITransform'), _dec2 = (0, _index.help)('i18n:cc.UITransform'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('UI/UITransform'), _dec5 = (0, _index.displayOrder)(0), _dec6 = (0, _index.tooltip)('内容尺寸'), _dec7 = (0, _index.displayOrder)(1), _dec8 = (0, _index.tooltip)('锚点位置'), _dec9 = (0, _index.tooltip)('渲染排序优先级'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (0, _index.disallowMultiple)(_class = (0, _index.executeInEditMode)(_class = (_class2 = (_temp = _class3 = class UITransform extends _index2.Component {
  constructor(...args) {
    super(...args);

    _initializerDefineProperty(this, "_priority", _descriptor, this);

    _initializerDefineProperty(this, "_contentSize", _descriptor2, this);

    _initializerDefineProperty(this, "_anchorPoint", _descriptor3, this);
  }
