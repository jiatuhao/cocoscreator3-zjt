...
let AnimationClip = (_dec = (0, _index.ccclass)('cc.AnimationClip'), _dec(_class = (_class2 = (_temp = _class3 = class AnimationClip extends _asset.Asset {
  constructor(...args) {
    ...
    _initializerDefineProperty(this, "_keys", _descriptor6, this);

    _initializerDefineProperty(this, "_stepness", _descriptor7, this);

    _initializerDefineProperty(this, "_curves", _descriptor8, this);

    _initializerDefineProperty(this, "_commonTargets", _descriptor9, this);

    _initializerDefineProperty(this, "_hash", _descriptor10, this);
...
}, _class3.preventDeferredLoadDependents = true, _class3.WrapMode = _types.WrapMode, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "sample", [_index.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
