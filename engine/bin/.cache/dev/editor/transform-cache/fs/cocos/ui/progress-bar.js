...
ProgressBar = (_dec = (0, _index.ccclass)('cc.ProgressBar'), _dec2 = (0, _index.help)('i18n:cc.ProgressBar'), _dec3 = (0, _index.executionOrder)(110), _dec4 = (0, _index.menu)('UI/ProgressBar'), _dec5 = (0, _index.requireComponent)(_index2.UITransform), _dec6 = (0, _index.type)(_sprite.Sprite), _dec7 = (0, _index.tooltip)('进度条显示用的 Sprite 节点，可以动态改变尺寸'), _dec8 = (0, _index.type)(Mode), _dec9 = (0, _index.tooltip)('进度条显示模式，目前支持水平和垂直两种'), _dec10 = (0, _index.tooltip)('进度条在 progress 为 1 时的最大长度'), _dec11 = (0, _index.range)([0, 1, 0.1]), _dec12 = (0, _index.tooltip)('当前进度指示，范围从 0 到 1'), _dec13 = (0, _index.tooltip)('是否反向驱动进度条'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (_class2 = (_temp = _class3 = class ProgressBar extends _component.Component {
  constructor(...args) {
    super(...args);
