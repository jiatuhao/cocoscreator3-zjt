 ...
 * 地形碰撞器。
 */
let TerrainCollider = (_dec = (0, _index.ccclass)('cc.TerrainCollider'), _dec2 = (0, _index.help)('i18n:cc.TerrainCollider'), _dec3 = (0, _index.menu)('Physics/TerrainCollider(beta)'), _dec4 = (0, _index.type)(_terrainAsset.TerrainAsset), _dec(_class = _dec2(_class = _dec3(_class = (0, _index.executeInEditMode)(_class = (_class2 = (_temp = class TerrainCollider extends _collider.Collider {
...
}, _temp), (_applyDecoratedDescriptor(_class2.prototype, "terrain", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "terrain"), _class2.prototype), _descriptor = _applyDecoratedDescriptor(_class2.prototype, "_terrain", [_index.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
