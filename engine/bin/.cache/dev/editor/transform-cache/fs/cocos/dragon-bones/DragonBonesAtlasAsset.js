...
var _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _class3, _temp;
 ...
 * @extends Asset
 */
let DragonBonesAtlasAsset = (_dec = (0, _index2.ccclass)('dragonBones.DragonBonesAtlasAsset'), _dec2 = (0, _index2.type)(_index.Texture2D), _dec(_class = (_class2 = (_temp = _class3 = class DragonBonesAtlasAsset extends _index.Asset {
  constructor() {
    super();
...
}, _class3.preventDeferredLoadDependents = void 0, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "_atlasJson", [_index2.serializable], {
  configurable: true,
  enumerable: true,
  writable: true,
