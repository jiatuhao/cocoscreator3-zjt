System.register("q-bundled:///fs/cocos/2d/components/sprite.js", ["../../core/data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../assets/sprite-atlas.js", "../assets/sprite-frame.js", "../../core/platform/event-manager/event-enum.js", "../../core/math/index.js", "../../core/value-types/enum.js", "../../core/math/utils.js", "../framework/renderable-2d.js", "../../core/global-exports.js", "../../core/assets/asset-enum.js", "../../core/assets/texture-base.js"], function (_export, _context) {
  "use strict";

  var ccclass, help, executionOrder, menu, tooltip, displayOrder, type, range, editable, serializable, EDITOR, SpriteAtlas, SpriteFrame, SystemEventType, Vec2, ccenum, clamp, Renderable2D, InstanceMaterialType, legacyCC, PixelFormat, TextureBase, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _dec25, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _class3, _temp, SpriteType, FillType, SizeMode, EventType, Sprite;
  ...
  return {
    ...
    execute: function () {
       ...
       * 渲染精灵组件。
       */
      _export("Sprite", Sprite = (_dec = ccclass('cc.Sprite'), _dec2 = help('i18n:cc.Sprite'), _dec3 = executionOrder(110), _dec4 = menu('2D/Sprite'), _dec5 = type(SpriteAtlas), _dec6 = displayOrder(4), _dec7 = tooltip('图片资源所属的 Atlas 图集资源'), _dec8 = type(SpriteFrame), _dec9 = displayOrder(5), _dec10 = tooltip('渲染 Sprite 使用的 SpriteFrame 图片资源'), _dec11 = type(SpriteType), _dec12 = displayOrder(6), _dec13 = tooltip('渲染模式：\n- 普通（Simple）：修改尺寸会整体拉伸图像，适用于序列帧动画和普通图像 \n' + '- 九宫格（Sliced）：修改尺寸时四个角的区域不会拉伸，适用于 UI 按钮和面板背景 \n' + '- 填充（Filled）：设置一定的填充起始位置和方向，能够以一定比率剪裁显示图片'), _dec14 = type(FillType), _dec15 = tooltip('填充方向，可以选择横向（Horizontal），纵向（Vertical）和扇形（Radial）三种方向'), _dec16 = tooltip('扇形填充时，指定扇形的中心点，取值范围 0 ~ 1'), _dec17 = range([0, 1, 0.1]), _dec18 = tooltip('填充起始位置，输入一个 0 ~ 1 之间的小数表示起始位置的百分比'), _dec19 = range([-1, 1, 0.1]), _dec20 = tooltip('填充总量，取值范围 0 ~ 1 指定显示图像范围的百分比'), _dec21 = displayOrder(8), _dec22 = tooltip('节点约束框内是否包括透明像素区域，勾选此项会去除节点约束框内的透明区域'), _dec23 = type(SizeMode), _dec24 = displayOrder(7), _dec25 = tooltip('指定 Sprite 所在节点的尺寸，CUSTOM 表示自定义尺寸，TRIMMED 表示取原始图片剪裁透明像素后的尺寸，RAW 表示取原始图片未剪裁的尺寸'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Renderable2D) {
