System.register("q-bundled:///fs/cocos/particle/renderer/particle-system-renderer-data.js", ["../../core/data/decorators/index.js", "../../3d/index.js", "../../core/assets/index.js", "../enum.js", "./particle-system-renderer-cpu.js", "./particle-system-renderer-gpu.js", "../../core/director.js", "../../core/gfx/index.js", "../../core/global-exports.js"], function (_export, _context) {
  "use strict";

  var ccclass, tooltip, displayOrder, type, serializable, Mesh, Material, RenderMode, ParticleSystemRendererCPU, ParticleSystemRendererGPU, director, Feature, legacyCC, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _temp, ParticleSystemRenderer;
  ...
  return {
    ...
    execute: function () {
      _export("default", ParticleSystemRenderer = (_dec = ccclass('cc.ParticleSystemRenderer'), _dec2 = type(RenderMode), _dec3 = displayOrder(0), _dec4 = tooltip('设定粒子生成模式'), _dec5 = displayOrder(1), _dec6 = tooltip('在粒子生成方式为 StrecthedBillboard 时,对粒子在运动方向上按速度大小进行拉伸'), _dec7 = displayOrder(2), _dec8 = tooltip('在粒子生成方式为 StrecthedBillboard 时,对粒子在运动方向上按粒子大小进行拉伸'), _dec9 = type(RenderMode), _dec10 = type(Mesh), _dec11 = displayOrder(7), _dec12 = tooltip('粒子发射的模型'), _dec13 = type(Material), _dec14 = displayOrder(8), _dec15 = tooltip('粒子使用的材质'), _dec16 = type(Material), _dec17 = displayOrder(9), _dec18 = tooltip('拖尾使用的材质'), _dec19 = displayOrder(10), _dec20 = tooltip('是否启用GPU粒子'), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function () {
