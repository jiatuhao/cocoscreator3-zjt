System.register("q-bundled:///fs/cocos/physics/framework/components/colliders/terrain-collider.js", ["../../../../core/data/decorators/index.js", "../../../../../../virtual/internal%253Aconstants.js", "./collider.js", "../../../../terrain/terrain-asset.js", "../../physics-enum.js"], function (_export, _context) {
  ...
  var ccclass, help, executeInEditMode, menu, type, serializable, EDITOR, TEST, Collider, TerrainAsset, EColliderType, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _temp, TerrainCollider;
  ...
  return {
    ...
    execute: function () {
       ...
       * 地形碰撞器。
       */
      _export("TerrainCollider", TerrainCollider = (_dec = ccclass('cc.TerrainCollider'), _dec2 = help('i18n:cc.TerrainCollider'), _dec3 = menu('Physics/TerrainCollider(beta)'), _dec4 = type(TerrainAsset), _dec(_class = _dec2(_class = _dec3(_class = executeInEditMode(_class = (_class2 = (_temp = /*#__PURE__*/function (_Collider) {
      ...
      }(Collider), _temp), (_applyDecoratedDescriptor(_class2.prototype, "terrain", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "terrain"), _class2.prototype), _descriptor = _applyDecoratedDescriptor(_class2.prototype, "_terrain", [serializable], {
        configurable: true,
        enumerable: true,
        writable: true,
