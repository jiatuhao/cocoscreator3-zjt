System.register("q-bundled:///fs/cocos/2d/framework/renderable-2d.js", ["../../../../virtual/internal%253Aconstants.js", "../../core/data/decorators/index.js", "../../core/math/index.js", "../../core/platform/event-manager/event-enum.js", "../../core/value-types/enum.js", "../../core/builtin/index.js", "../../core/assets/index.js", "../../core/gfx/define.js", "../renderer/render-data.js", "./ui-transform.js", "../../core/components/renderable-component.js", "../renderer/stencil-manager.js", "../../core/platform/debug.js", "../../core/gfx/pipeline-state.js", "../../core/global-exports.js"], function (_export, _context) {
  "use strict";

  var EDITOR, ccclass, executeInEditMode, requireComponent, disallowMultiple, tooltip, type, displayOrder, serializable, override, visible, displayName, Color, SystemEventType, ccenum, builtinResMgr, Material, BlendFactor, RenderData, UITransform, RenderableComponent, Stage, warnID, BlendState, BlendTarget, legacyCC, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _class3, _temp, InstanceMaterialType, _matInsInfo, Renderable2D;
  ...
  return {
    ...
    }, function (_coreGfxDefineJs) {
      BlendFactor = _coreGfxDefineJs.BlendFactor;
    ...
    }, function (_coreGfxPipelineStateJs) {
      BlendState = _coreGfxPipelineStateJs.BlendState;
      BlendTarget = _coreGfxPipelineStateJs.BlendTarget;
    ...
    execute: function () {
      ...
      _export("Renderable2D", Renderable2D = (_dec = ccclass('cc.Renderable2D'), _dec2 = requireComponent(UITransform), _dec3 = visible(false), _dec4 = type(Material), _dec5 = type(Material), _dec6 = displayOrder(0), _dec7 = displayName('CustomMaterial'), _dec8 = visible(function () {
        if (this._customMaterial) {
          return false;
        }

        return true;
      }), _dec9 = type(BlendFactor), _dec10 = displayOrder(0), _dec11 = tooltip('Source blend factor'), _dec12 = visible(function () {
        if (this._customMaterial) {
          return false;
        }

        return true;
      }), _dec13 = type(BlendFactor), _dec14 = displayOrder(1), _dec15 = tooltip('destination blend factor'), _dec16 = displayOrder(2), _dec17 = tooltip('渲染颜色'), _dec(_class = _dec2(_class = disallowMultiple(_class = executeInEditMode(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_RenderableComponent) {
      ...
      }), _applyDecoratedDescriptor(_class2.prototype, "customMaterial", [_dec5, _dec6, _dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "customMaterial"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "srcBlendFactor", [_dec8, _dec9, _dec10, _dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "srcBlendFactor"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "dstBlendFactor", [_dec12, _dec13, _dec14, _dec15], Object.getOwnPropertyDescriptor(_class2.prototype, "dstBlendFactor"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "color", [_dec16, _dec17], Object.getOwnPropertyDescriptor(_class2.prototype, "color"), _class2.prototype), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "_srcBlendFactor", [serializable], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
