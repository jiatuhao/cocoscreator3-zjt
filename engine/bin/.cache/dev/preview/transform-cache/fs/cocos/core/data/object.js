System.register("q-bundled:///fs/cocos/core/data/object.js", ["../../../../virtual/internal%253Aconstants.js", "../utils/js.js", "./class.js", "../platform/debug.js", "../global-exports.js"], function (_export, _context) {
  "use strict";

  var SUPPORT_JIT, EDITOR, TEST, js, CCClass, errorID, warnID, legacyCC, Destroyed, RealDestroyed, ToDestroy, DontSave, EditorOnly, Dirty, DontDestroy, Destroying, Deactivating, LockedInEditor, HideInHierarchy, IsOnEnableCalled, IsEditorOnEnableCalled, IsPreloadStarted, IsOnLoadCalled, IsOnLoadStarted, IsStartCalled, IsRotationLocked, IsScaleLocked, IsAnchorLocked, IsSizeLocked, IsPositionLocked, PersistentMask, objectsToDestroy, deferredDestroyTimer, CCObject, prototype;
