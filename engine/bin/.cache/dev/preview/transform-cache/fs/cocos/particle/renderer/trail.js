System.register("q-bundled:///fs/cocos/particle/renderer/trail.js", ["../../core/data/decorators/index.js", "../../core/assets/rendering-sub-mesh.js", "../../core/director.js", "../../core/gfx/define.js", "../../core/gfx/index.js", "../../core/math/index.js", "../../core/memop/index.js", "../../core/renderer/index.js", "../animator/curve-range.js", "../animator/gradient-range.js", "../enum.js", "../../core/global-exports.js"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_coreDataDecoratorsIndexJs) {
      ...
      FormatInfos = _coreGfxDefineJs.FormatInfos;
    ...
    execute: function () {
      ...
      _export("default", TrailModule = (_dec = ccclass('cc.TrailModule'), _dec2 = displayOrder(0), _dec3 = type(TrailMode), _dec4 = displayOrder(1), _dec5 = tooltip('Particle在每个粒子的运动轨迹上形成拖尾效果'), _dec6 = type(CurveRange), _dec7 = displayOrder(3), _dec8 = tooltip('拖尾的生命周期'), _dec9 = displayOrder(5), _dec10 = tooltip('粒子每生成一个拖尾节点所运行的最短距离'), _dec11 = type(Space), _dec12 = displayOrder(6), _dec13 = tooltip('拖尾所在的坐标系，World在世界坐标系中运行，Local在本地坐标系中运行'), _dec14 = type(TextureMode), _dec15 = displayOrder(8), _dec16 = tooltip('贴图在拖尾上的展开形式，Stretch贴图覆盖在整条拖尾上，Repeat贴图覆盖在一段拖尾上'), _dec17 = displayOrder(9), _dec18 = tooltip('拖尾宽度继承自粒子大小'), _dec19 = type(CurveRange), _dec20 = displayOrder(10), _dec21 = tooltip('拖尾宽度，如果继承自粒子则是粒子大小的比例'), _dec22 = displayOrder(11), _dec23 = tooltip('拖尾颜色是否继承自粒子'), _dec24 = type(GradientRange), _dec25 = displayOrder(12), _dec26 = tooltip('拖尾颜色随拖尾自身长度的颜色渐变'), _dec27 = type(GradientRange), _dec28 = displayOrder(13), _dec29 = tooltip('拖尾颜色随时间的颜色渐变'), _dec30 = type(Space), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function () {
