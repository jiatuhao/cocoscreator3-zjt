System.register("q-bundled:///fs/cocos/physics/framework/components/colliders/box-collider.js", ["../../../../core/data/decorators/index.js", "../../../../core/math/index.js", "./collider.js", "../../physics-enum.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
       ...
       * 盒子碰撞器。
       */
      _export("BoxCollider", BoxCollider = (_dec = ccclass('cc.BoxCollider'), _dec2 = help('i18n:cc.BoxCollider'), _dec3 = menu('Physics/BoxCollider'), _dec4 = type(Vec3), _dec5 = tooltip('盒的大小，即长、宽、高'), _dec(_class = _dec2(_class = _dec3(_class = executeInEditMode(_class = (_class2 = (_temp = /*#__PURE__*/function (_Collider) {
