System.register("q-bundled:///fs/cocos/dragon-bones/DragonBonesAsset.js", ["../../../virtual/internal%253Aconstants.js", "../core/assets/index.js", "../core/data/decorators/index.js", "./ArmatureCache.js", "../core/index.js", "./CCFactory.js", "../core/global-exports.js"], function (_export, _context) {
  ...
  var EDITOR, Asset, ccclass, serializable, ArmatureCache, Enum, Node, CCFactory, legacyCC, _dec, _class, _class2, _descriptor, _class3, _temp, DragonBonesAsset;
  ...
  return {
    ...
    execute: function () {
       ...
       * @extends Asset
       */
      _export("DragonBonesAsset", DragonBonesAsset = (_dec = ccclass('dragonBones.DragonBonesAsset'), _dec(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Asset) {
      ...
      }(Asset), _class3.preventDeferredLoadDependents = true, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "_dragonBonesJson", [serializable], {
        configurable: true,
        enumerable: true,
        writable: true,
