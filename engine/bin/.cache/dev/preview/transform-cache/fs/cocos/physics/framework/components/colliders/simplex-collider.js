System.register("q-bundled:///fs/cocos/physics/framework/components/colliders/simplex-collider.js", ["../../../../core/data/decorators/index.js", "../../../../../../virtual/internal%253Aconstants.js", "../../../../core/math/index.js", "./collider.js", "../../physics-enum.js"], function (_export, _context) {
  ...
  var ccclass, help, executeInEditMode, menu, visible, type, editable, serializable, EDITOR, TEST, Vec3, Collider, ESimplexType, EColliderType, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _class3, _temp, SimplexCollider;
  ...
  return {
    ...
    execute: function () {
       ...
       */
      _export("SimplexCollider", SimplexCollider = (_dec = ccclass('cc.SimplexCollider'), _dec2 = help('i18n:cc.SimplexCollider'), _dec3 = menu('Physics/SimplexCollider'), _dec4 = type(ESimplexType), _dec5 = visible(function () {
        return this._shapeType > 1;
      }), _dec6 = visible(function () {
        return this._shapeType > 2;
      }), _dec7 = visible(function () {
        return this._shapeType > 3;
      }), _dec(_class = _dec2(_class = _dec3(_class = executeInEditMode(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Collider) {
      ...
      }(Collider), _class3.ESimplexType = ESimplexType, _temp), (_applyDecoratedDescriptor(_class2.prototype, "shapeType", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "shapeType"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "vertex0", [editable], Object.getOwnPropertyDescriptor(_class2.prototype, "vertex0"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "vertex1", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "vertex1"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "vertex2", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "vertex2"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "vertex3", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "vertex3"), _class2.prototype), _descriptor = _applyDecoratedDescriptor(_class2.prototype, "_shapeType", [serializable], {
        configurable: true,
        enumerable: true,
        writable: true,
