System.register("q-bundled:///fs/cocos/tiledmap/tiled-map.js", ["../core/data/decorators/index.js", "../../../virtual/internal%253Aconstants.js", "../core/components/index.js", "../2d/framework/index.js", "./tiled-types.js", "./tmx-xml-parser.js", "./tiled-layer.js", "./tiled-object-group.js", "./tiled-map-asset.js", "../2d/components/sprite.js", "./tiled-utils.js", "../core/index.js"], function (_export, _context) {
  "use strict";

  var ccclass, displayOrder, executeInEditMode, help, menu, requireComponent, type, serializable, editable, EDITOR, JSB, Component, UITransform, Orientation, Property, RenderOrder, StaggerAxis, StaggerIndex, TileFlag, TMXImageLayerInfo, TMXLayerInfo, TMXObjectGroupInfo, TMXObjectType, TMXMapInfo, TiledLayer, TiledObjectGroup, TiledMapAsset, Sprite, fillTextureGrids, loadAllTextures, Size, SystemEventType, Vec2, Node, logID, sys, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _class3, _temp, TiledMap;
  ...
  return {
    setters: [function (_coreDataDecoratorsIndexJs) {
      ...
      loadAllTextures = _tiledUtilsJs.loadAllTextures;
    ...
    execute: function () {
      ...
      _export("TiledMap", TiledMap = (_dec = ccclass('cc.TiledMap'), _dec2 = help('i18n:cc.TiledMap'), _dec3 = menu('TiledMap/TiledMap'), _dec4 = requireComponent(UITransform), _dec5 = type(TiledMapAsset), _dec6 = displayOrder(7), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = executeInEditMode(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Component) {
        ...
        function TiledMap() {
          ...
          _initializerDefineProperty(_this, "_tmxFile", _descriptor, _assertThisInitialized(_this));

          _initializerDefineProperty(_this, "_enableCulling", _descriptor2, _assertThisInitialized(_this));

          _initializerDefineProperty(_this, "cleanupImageCache", _descriptor3, _assertThisInitialized(_this));
        ...
        _proto._applyFile = function _applyFile() {
          ...
          if (file) {
            ...
            for (var i = 0; i < spfNames.length; ++i) {
              var texName = spfNames[i]; // textures[texName] = texValues[i];
        ...
        _proto._syncAnchorPoint = function _syncAnchorPoint() {
          ...
          for (i = 0, l = this._groups.length; i < l; i++) {
            ...
            var groupNode = groupInfo.node._uiProps.uiTransformComp; // Group layer not sync anchor to map because it's old behavior,
      ...
      }), _applyDecoratedDescriptor(_class2.prototype, "tmxAsset", [_dec5, _dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "tmxAsset"), _class2.prototype), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "_enableCulling", [serializable], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _applyDecoratedDescriptor(_class2.prototype, "enableCulling", [editable], Object.getOwnPropertyDescriptor(_class2.prototype, "enableCulling"), _class2.prototype), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "cleanupImageCache", [serializable], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
