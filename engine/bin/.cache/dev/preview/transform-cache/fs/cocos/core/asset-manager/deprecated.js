System.register("q-bundled:///fs/cocos/core/asset-manager/deprecated.js", ["../../../../virtual/internal%253Aconstants.js", "../assets/index.js", "../director.js", "../game.js", "../global-exports.js", "../platform/debug.js", "../platform/macro.js", "../utils/index.js", "./asset-manager.js", "./bundle.js", "./depend-util.js", "./downloader.js", "./helper.js", "./parser.js", "./release-manager.js", "./shared.js", "./utilities.js", "./factory.js"], function (_export, _context) {
  "use strict";

  var BUILD, Asset, director, game, legacyCC, getError, macro, path, removeProperty, replaceProperty, assetManager, AssetManager, resources, dependUtil, downloader, getUuidFromURL, transform, parser, releaseManager, assets, BuiltinBundleName, bundles, parseLoadResArgs, setDefaultProgressCallback, factory, ImageFmts, AudioFmts, md5Pipe, CCLoader, loader, AssetLibrary, url, _autoRelease;
  ...
  return {
    setters: [function (_virtualInternal253AconstantsJs) {
      ...
      getUuidFromURL = _helperJs.getUuidFromURL;
      ...
      setDefaultProgressCallback = _utilitiesJs.setDefaultProgressCallback;
    }, function (_factoryJs) {
      factory = _factoryJs.default;
    }],
    execute: function () {
      ImageFmts = ['.png', '.jpg', '.bmp', '.jpeg', '.gif', '.ico', '.tiff', '.webp', '.image', '.pvr', '.pkm', '.astc'];
      AudioFmts = ['.mp3', '.ogg', '.wav', '.m4a'];
      md5Pipe = {
       ...
       */
      _export("CCLoader", CCLoader = /*#__PURE__*/function () {
        function CCLoader() {
      ...
      _export("loader", loader = new CCLoader());
      /**
       * /**
       * 管理项目中加载/卸载资源的资源库。
       * @class AssetLibrary
      ...
      _export("AssetLibrary", AssetLibrary = {
        /**
         * @en
      ...
      _autoRelease = releaseManager._autoRelease;
