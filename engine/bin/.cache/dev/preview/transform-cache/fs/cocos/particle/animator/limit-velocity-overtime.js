System.register("q-bundled:///fs/cocos/particle/animator/limit-velocity-overtime.js", ["../../core/data/decorators/index.js", "../../core/math/index.js", "../enum.js", "../particle.js", "./curve-range.js", "../particle-general-function.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", LimitVelocityOvertimeModule = (_dec = ccclass('cc.LimitVelocityOvertimeModule'), _dec2 = displayOrder(0), _dec3 = type(CurveRange), _dec4 = range([-1, 1]), _dec5 = displayOrder(4), _dec6 = tooltip('X 轴方向上的速度下限'), _dec7 = type(CurveRange), _dec8 = range([-1, 1]), _dec9 = displayOrder(5), _dec10 = tooltip('Y 轴方向上的速度下限'), _dec11 = type(CurveRange), _dec12 = range([-1, 1]), _dec13 = displayOrder(6), _dec14 = tooltip('Z 轴方向上的速度下限'), _dec15 = type(CurveRange), _dec16 = range([-1, 1]), _dec17 = displayOrder(3), _dec18 = tooltip('速度下限'), _dec19 = displayOrder(7), _dec20 = tooltip('当前速度与速度下限的插值'), _dec21 = displayOrder(2), _dec22 = tooltip('是否三个轴分开限制'), _dec23 = type(Space), _dec24 = displayOrder(1), _dec25 = tooltip('计算速度下限时采用的坐标系'), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_ParticleModuleBase) {
