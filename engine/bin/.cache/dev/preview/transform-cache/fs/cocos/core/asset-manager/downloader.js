System.register("q-bundled:///fs/cocos/core/asset-manager/downloader.js", ["../../../../virtual/internal%253Aconstants.js", "../platform/sys.js", "../utils/index.js", "../utils/misc.js", "../utils/path.js", "./cache.js", "./download-dom-image.js", "./download-file.js", "./download-script.js", "./shared.js", "./utilities.js", "../global-exports.js"], function (_export, _context) {
  ...
  var EDITOR, sys, js, callInNextTick, basename, Cache, downloadDomImage, downloadFile, downloadScript, files, retry, urlAppendTimestamp, legacyCC, REGEX, downloadImage, downloadBlob, downloadJson, downloadArrayBuffer, downloadText, downloadBundle, Downloader, downloader;
    ...
    execute: function () {
      ...
      _export("Downloader", Downloader = /*#__PURE__*/function () {
        ...
        _proto.importBundleEntry = function importBundleEntry(bundleName) {
          return _context["import"]("virtual:///prerequisite-imports/" + bundleName);
        }
        /**
         * @en
