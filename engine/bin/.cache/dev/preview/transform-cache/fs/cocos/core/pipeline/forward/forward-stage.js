System.register("q-bundled:///fs/cocos/core/pipeline/forward/forward-stage.js", ["../../data/decorators/index.js", "../define.js", "../pass-phase.js", "../render-queue.js", "../../gfx/define.js", "../../gfx/index.js", "../pipeline-funcs.js", "../render-batched-queue.js", "../render-instanced-queue.js", "../render-stage.js", "./enum.js", "../render-additive-light-queue.js", "../instanced-buffer.js", "../batched-buffer.js", "../../renderer/core/pass.js", "../pipeline-serialization.js", "./planar-shadow-queue.js", "./ui-phase.js"], function (_export, _context) {
  "use strict";

  var ccclass, displayOrder, type, serializable, SetIndex, getPhaseID, opaqueCompareFn, RenderQueue, transparentCompareFn, ClearFlag, Color, Rect, SRGBToLinear, RenderBatchedQueue, RenderInstancedQueue, RenderStage, ForwardStagePriority, RenderAdditiveLightQueue, InstancedBuffer, BatchedBuffer, BatchingSchemes, RenderQueueDesc, RenderQueueSortMode, PlanarShadowQueue, UIPhase, _dec, _dec2, _dec3, _class, _class2, _descriptor, _class3, _temp, colors, ForwardStage;
  ...
  return {
    setters: [function (_dataDecoratorsIndexJs) {
      ...
      opaqueCompareFn = _renderQueueJs.opaqueCompareFn;
      RenderQueue = _renderQueueJs.RenderQueue;
      transparentCompareFn = _renderQueueJs.transparentCompareFn;
    ...
    execute: function () {
      ...
      _export("ForwardStage", ForwardStage = (_dec = ccclass('ForwardStage'), _dec2 = type([RenderQueueDesc]), _dec3 = displayOrder(2), _dec(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_RenderStage) {
        ...
        _proto.render = function render(camera) {
          ...
          var vp = camera.viewport; // render area is not oriented

          var w = camera.window.hasOnScreenAttachments && device.surfaceTransform % 2 ? camera.height : camera.width;
          var h = camera.window.hasOnScreenAttachments && device.surfaceTransform % 2 ? camera.width : camera.height;
        ...
        _proto.renderQueueClearFunc = function renderQueueClearFunc(rq) {
          rq.clear();
        }
        /**
        ...
        _proto.renderQueueSortFunc = function renderQueueSortFunc(rq) {
          rq.sort();
        };
