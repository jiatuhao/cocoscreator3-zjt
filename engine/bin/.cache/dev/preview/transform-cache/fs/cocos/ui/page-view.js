System.register("q-bundled:///fs/cocos/ui/page-view.js", ["../core/data/decorators/index.js", "../../../virtual/internal%253Aconstants.js", "../core/components/index.js", "../core/platform/index.js", "../core/math/index.js", "../core/value-types/enum.js", "./layout.js", "./page-view-indicator.js", "./scroll-view.js", "./scroll-bar.js", "../core/platform/debug.js", "../core/data/utils/extends-enum.js", "../core/global-exports.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
       ...
       * 页面视图组件
       */
      _export("PageView", PageView = (_dec = ccclass('cc.PageView'), _dec2 = help('i18n:cc.PageView'), _dec3 = executionOrder(110), _dec4 = menu('UI/PageView'), _dec5 = type(SizeMode), _dec6 = tooltip('页面视图中每个页面大小类型'), _dec7 = type(Direction), _dec8 = tooltip('页面视图滚动类型'), _dec9 = range([0, 1, 0.01]), _dec10 = tooltip('滚动临界值，默认单位百分比，当拖拽超出该数值时，松开会自动滚动下一页，小于时则还原'), _dec11 = range([0, 1, 0.01]), _dec12 = tooltip('设置 PageView PageTurning 事件的发送时机'), _dec13 = type(PageViewIndicator), _dec14 = tooltip('页面视图指示器组件'), _dec15 = tooltip('快速滑动翻页临界值\n当用户快速滑动时，会根据滑动开始和结束的距离与时间计算出一个速度值\n该值与此临界值相比较，如果大于临界值，则进行自动翻页'), _dec16 = type(ScrollBar), _dec17 = visible(false), _dec18 = type(ScrollBar), _dec19 = visible(false), _dec20 = visible(false), _dec21 = visible(false), _dec22 = visible(false), _dec23 = type([ComponentEventHandler]), _dec24 = visible(false), _dec25 = type([ComponentEventHandler]), _dec26 = tooltip('滚动视图的事件回调函数'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_ScrollView) {
