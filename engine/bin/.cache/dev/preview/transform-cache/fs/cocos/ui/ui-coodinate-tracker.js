System.register("q-bundled:///fs/cocos/ui/ui-coodinate-tracker.js", ["../core/data/decorators/index.js", "../core/components/component.js", "../core/components/component-event-handler.js", "../core/scene-graph/node.js", "../core/components/index.js", "../core/math/index.js"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
       ...
       */
      _export("UICoordinateTracker", UICoordinateTracker = (_dec = ccclass('cc.UICoordinateTracker'), _dec2 = help('i18n:cc.UICoordinateTracker'), _dec3 = menu('UI/UICoordinateTracker'), _dec4 = executionOrder(110), _dec5 = type(Node), _dec6 = tooltip('目标对象'), _dec7 = type(Camera), _dec8 = tooltip('照射相机'), _dec9 = tooltip('是否是缩放映射'), _dec10 = tooltip('距相机多少距离为正常显示计算大小'), _dec11 = type([EventHandler]), _dec12 = tooltip('映射数据事件。回调的第一个参数是映射后的本地坐标，第二个是距相机距离比'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
