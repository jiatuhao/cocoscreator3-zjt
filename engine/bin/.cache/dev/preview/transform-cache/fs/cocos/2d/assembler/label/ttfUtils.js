System.register("q-bundled:///fs/cocos/2d/assembler/label/ttfUtils.js", ["../../assets/index.js", "../../utils/text-utils.js", "../../../core/math/index.js", "../../components/index.js", "../../../core/platform/debug.js", "../../../core/global-exports.js", "../../../core/asset-manager/index.js", "../../utils/dynamic-atlas/atlas-manager.js"], function (_export, _context2) {
  "use strict";

  var SpriteFrame, fragmentText, safeMeasureText, getBaselineOffset, BASELINE_RATIO, Color, Size, Vec2, Rect, HorizontalTextAlignment, Label, LabelOutline, VerticalTextAlignment, LabelShadow, logID, legacyCC, assetManager, dynamicAtlasManager, Overflow, MAX_SIZE, _BASELINE_OFFSET, _context, _canvas, _texture, _fontDesc, _string, _fontSize, _drawFontsize, _splitStrings, _canvasSize, _lineHeight, _hAlign, _vAlign, _color, _fontFamily, _overflow, _isWrapText, _outlineComp, _outlineColor, _shadowComp, _shadowColor, _canvasPadding, _contentSizeExtend, _nodeContentSize, _startPosition, _drawUnderlinePos, _drawUnderlineWidth, _underlineThickness, _isBold, _isItalic, _isUnderline, Alignment, ttfUtils;
