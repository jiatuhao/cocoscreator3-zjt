System.register("q-bundled:///fs/cocos/particle/billboard.js", ["../core/data/decorators/index.js", "../core/builtin/index.js", "../3d/misc/index.js", "../core/assets/index.js", "../core/components/component.js", "../core/gfx/index.js", "../core/math/index.js", "../core/renderer/index.js", "../core/global-exports.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      _export("Billboard", Billboard = (_dec = ccclass('cc.Billboard'), _dec2 = help('i18n:cc.Billboard'), _dec3 = menu('Effects/Billboard'), _dec4 = type(Texture2D), _dec5 = type(Texture2D), _dec6 = tooltip('billboard显示的贴图'), _dec7 = tooltip('billboard的高度'), _dec8 = tooltip('billboard的宽度'), _dec9 = tooltip('billboard绕中心点旋转的角度'), _dec(_class = _dec2(_class = _dec3(_class = executeInEditMode(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
