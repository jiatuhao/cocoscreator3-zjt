System.register("q-bundled:///fs/cocos/ui/editbox/edit-box.js", ["../../core/data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../../2d/framework/index.js", "../../2d/assets/sprite-frame.js", "../../core/components/component.js", "../../core/components/component-event-handler.js", "../../core/math/index.js", "../../core/platform/event-manager/event-enum.js", "../../core/scene-graph/node.js", "../../2d/components/label.js", "../../2d/components/sprite.js", "./edit-box-impl.js", "./edit-box-impl-base.js", "./types.js", "../../core/global-exports.js"], function (_export, _context) {
  "use strict";

  var ccclass, help, executeInEditMode, executionOrder, menu, requireComponent, tooltip, displayOrder, type, serializable, EDITOR, JSB, MINIGAME, RUNTIME_BASED, UITransform, SpriteFrame, Component, ComponentEventHandler, Vec3, SystemEventType, Node, Label, VerticalTextAlignment, Sprite, EditBoxImpl, EditBoxImplBase, InputFlag, InputMode, KeyboardReturnType, legacyCC, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _dec25, _dec26, _dec27, _dec28, _dec29, _dec30, _dec31, _dec32, _dec33, _dec34, _dec35, _dec36, _dec37, _dec38, _dec39, _dec40, _dec41, _dec42, _dec43, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _class3, _temp, LEFT_PADDING, EventType, EditBox;
  ...
  return {
    ...
    execute: function () {
       ...
       */
      _export("EditBox", EditBox = (_dec = ccclass('cc.EditBox'), _dec2 = help('i18n:cc.EditBox'), _dec3 = executionOrder(100), _dec4 = menu('UI/EditBox'), _dec5 = requireComponent(UITransform), _dec6 = displayOrder(1), _dec7 = tooltip('输入框的初始输入内容，如果为空则会显示占位符的文本'), _dec8 = displayOrder(2), _dec9 = tooltip('输入框占位符的文本内容'), _dec10 = type(Label), _dec11 = displayOrder(3), _dec12 = tooltip('输入框输入文本节点上挂载的 Label 组件对象'), _dec13 = type(Label), _dec14 = displayOrder(4), _dec15 = tooltip('输入框占位符节点上挂载的 Label 组件对象'), _dec16 = type(SpriteFrame), _dec17 = displayOrder(5), _dec18 = tooltip('输入框的背景图片'), _dec19 = type(InputFlag), _dec20 = displayOrder(6), _dec21 = tooltip('指定输入标志位，可以指定输入方式为密码或者单词首字母大写'), _dec22 = type(InputMode), _dec23 = displayOrder(7), _dec24 = tooltip('指定输入模式: ANY 表示多行输入，其它都是单行输入，移动平台上还可以指定键盘样式'), _dec25 = type(KeyboardReturnType), _dec26 = displayOrder(8), _dec27 = tooltip('指定移动设备上面回车按钮的样式'), _dec28 = displayOrder(9), _dec29 = tooltip('输入框最大允许输入的字符个数'), _dec30 = displayOrder(10), _dec31 = tooltip('修改 DOM 输入元素的 tabIndex（这个属性只有在 Web 上面修改有意义）'), _dec32 = type([ComponentEventHandler]), _dec33 = displayOrder(11), _dec34 = tooltip('该事件在用户点击输入框获取焦点的时候被触发'), _dec35 = type([ComponentEventHandler]), _dec36 = displayOrder(12), _dec37 = tooltip('编辑文本输入框时触发的事件回调'), _dec38 = type([ComponentEventHandler]), _dec39 = displayOrder(13), _dec40 = tooltip('在单行模式下面，一般是在用户按下回车或者点击屏幕输入框以外的地方调用该函数。 如果是多行输入，一般是在用户点击屏幕输入框以外的地方调用该函数'), _dec41 = type([ComponentEventHandler]), _dec42 = displayOrder(14), _dec43 = tooltip('该事件在用户按下回车键的时候被触发, 如果是单行输入框，按回车键还会使输入框失去焦点'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = executeInEditMode(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Component) {
