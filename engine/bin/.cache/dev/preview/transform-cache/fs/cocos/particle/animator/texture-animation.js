System.register("q-bundled:///fs/cocos/particle/animator/texture-animation.js", ["../../core/data/decorators/index.js", "../../core/math/index.js", "../../core/value-types/index.js", "../particle.js", "./curve-range.js", "../enum.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", TextureAnimationModule = (_dec = ccclass('cc.TextureAnimationModule'), _dec2 = formerlySerializedAs('numTilesX'), _dec3 = formerlySerializedAs('numTilesY'), _dec4 = displayOrder(0), _dec5 = type(Mode), _dec6 = type(Mode), _dec7 = displayOrder(1), _dec8 = tooltip('设定粒子贴图动画的类型（暂只支持 Grid 模式）'), _dec9 = displayOrder(2), _dec10 = tooltip('X 方向动画帧数'), _dec11 = displayOrder(3), _dec12 = tooltip('Y 方向动画帧数'), _dec13 = type(Animation), _dec14 = displayOrder(4), _dec15 = tooltip('动画播放方式'), _dec16 = type(CurveRange), _dec17 = displayOrder(7), _dec18 = tooltip('一个周期内动画播放的帧与时间变化曲线'), _dec19 = type(CurveRange), _dec20 = displayOrder(8), _dec21 = tooltip('从第几帧开始播放，时间为整个粒子系统的生命周期'), _dec22 = displayOrder(9), _dec23 = tooltip('一个生命周期内播放循环的次数'), _dec24 = displayOrder(5), _dec25 = tooltip('随机从动画贴图中选择一行以生成动画。\n此选项仅在动画播放方式为 SingleRow 时生效'), _dec26 = displayOrder(6), _dec27 = tooltip('从动画贴图中选择特定行以生成动画。\n此选项仅在动画播放方式为 SingleRow 时且禁用 randomRow 时可用'), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_ParticleModuleBase) {
