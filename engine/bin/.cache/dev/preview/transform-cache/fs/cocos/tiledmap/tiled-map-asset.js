System.register("q-bundled:///fs/cocos/tiledmap/tiled-map-asset.js", ["../core/data/decorators/index.js", "../core/assets/asset.js", "../core/index.js", "../2d/assets/index.js"], function (_export, _context) {
  ...
  var ccclass, type, serializable, Asset, CCString, Size, TextAsset, SpriteFrame, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _class3, _temp, TiledMapAsset;
  ...
  return {
    ...
    execute: function () {
       ...
       *
       */
      _export("TiledMapAsset", TiledMapAsset = (_dec = ccclass('cc.TiledMapAsset'), _dec2 = type([TextAsset]), _dec3 = type([CCString]), _dec4 = type([SpriteFrame]), _dec5 = type([SpriteFrame]), _dec6 = type([CCString]), _dec7 = type([CCString]), _dec8 = type([Size]), _dec(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Asset) {
      ...
      }(Asset), _class3.preventDeferredLoadDependents = true, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "tmxXmlStr", [serializable], {
        configurable: true,
        enumerable: true,
        writable: true,
