System.register("q-bundled:///fs/cocos/particle/emitter/shape-module.js", ["../../core/data/decorators/index.js", "../../core/math/index.js", "../animator/curve-range.js", "../enum.js", "../particle-general-function.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", ShapeModule = (_dec = ccclass('cc.ShapeModule'), _dec2 = displayOrder(13), _dec3 = tooltip('粒子发射器位置'), _dec4 = displayOrder(14), _dec5 = tooltip('粒子发射器旋转角度'), _dec6 = displayOrder(15), _dec7 = tooltip('粒子发射器缩放比例'), _dec8 = displayOrder(6), _dec9 = tooltip('粒子发射器在一个扇形范围内发射'), _dec10 = displayOrder(5), _dec11 = tooltip('圆锥的轴与母线的夹角\n决定圆锥发射器的开合程度'), _dec12 = displayOrder(0), _dec13 = type(ShapeType), _dec14 = formerlySerializedAs('shapeType'), _dec15 = displayOrder(1), _dec16 = type(ShapeType), _dec17 = tooltip('粒子发射器类型'), _dec18 = type(EmitLocation), _dec19 = displayOrder(2), _dec20 = tooltip('粒子从发射器哪个部位发射'), _dec21 = displayOrder(16), _dec22 = tooltip('根据粒子的初始方向决定粒子的移动方向'), _dec23 = displayOrder(17), _dec24 = tooltip('粒子生成方向随机设定'), _dec25 = displayOrder(18), _dec26 = tooltip('表示当前发射方向与当前位置到结点中心连线方向的插值'), _dec27 = displayOrder(19), _dec28 = tooltip('粒子生成位置随机设定（设定此值为非 0 会使粒子生成位置超出生成器大小范围）'), _dec29 = displayOrder(3), _dec30 = tooltip('粒子发射器半径'), _dec31 = displayOrder(4), _dec32 = tooltip('粒子发射器发射位置（对 Box 类型的发射器无效）:\n - 0 表示从表面发射；\n - 1 表示从中心发射；\n - 0 ~ 1 之间表示在中心到表面之间发射。'), _dec33 = type(ArcMode), _dec34 = displayOrder(7), _dec35 = tooltip('粒子在扇形范围内的发射方式'), _dec36 = displayOrder(9), _dec37 = tooltip('控制可能产生粒子的弧周围的离散间隔'), _dec38 = type(CurveRange), _dec39 = displayOrder(10), _dec40 = tooltip('粒子沿圆周发射的速度'), _dec41 = displayOrder(11), _dec42 = tooltip('圆锥顶部截面距离底部的轴长\n决定圆锥发射器的高度'), _dec43 = displayOrder(12), _dec44 = tooltip('粒子发射器发射位置（针对 Box 类型的粒子发射器）'), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function () {
