System.register("q-bundled:///fs/cocos/2d/components/mask.js", ["../../core/data/decorators/index.js", "../framework/renderable-2d.js", "../../core/math/index.js", "../../core/platform/index.js", "../../core/value-types/enum.js", "./graphics.js", "../assets/sprite-frame.js", "../../core/index.js", "../../core/gfx/index.js", "../../core/global-exports.js", "../../core/renderer/index.js", "../renderer/vertex-format.js", "../renderer/stencil-manager.js"], function (_export, _context) {
  "use strict";

  var ccclass, help, executionOrder, menu, tooltip, displayOrder, type, visible, override, serializable, range, slide, InstanceMaterialType, Renderable2D, clamp, Color, Mat4, Vec2, Vec3, warnID, ccenum, Graphics, SpriteFrame, Game, builtinResMgr, director, RenderingSubMesh, BufferInfo, BufferUsageBit, MemoryUsageBit, PrimitiveMode, legacyCC, MaterialInstance, scene, vfmt, getAttributeStride, Stage, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _class3, _temp, _worldMatrix, _vec2_temp, _mat4_temp, _circlePoints, MaskType, SEGMENTS_MIN, SEGMENTS_MAX, Mask;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Mask", Mask = (_dec = ccclass('cc.Mask'), _dec2 = help('i18n:cc.Mask'), _dec3 = executionOrder(110), _dec4 = menu('2D/Mask'), _dec5 = type(MaskType), _dec6 = displayOrder(10), _dec7 = tooltip('遮罩类型'), _dec8 = displayOrder(14), _dec9 = tooltip('反向遮罩'), _dec10 = visible(function () {
        ...
        return this.type === MaskType.IMAGE_STENCIL;
      }), _dec14 = range([0, 1, 0.1]), _dec15 = visible(false), _dec16 = visible(false), _dec17 = visible(false), _dec18 = visible(false), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Renderable2D) {
