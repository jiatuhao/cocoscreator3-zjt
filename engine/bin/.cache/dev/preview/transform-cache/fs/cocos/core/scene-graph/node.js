System.register("q-bundled:///fs/cocos/core/scene-graph/node.js", ["../data/decorators/index.js", "./layers.js", "./node-ui-properties.js", "../platform/event-manager/event-enum.js", "../platform/event-manager/event-manager.js", "../global-exports.js", "./base-node.js", "../math/index.js", "../renderer/core/memory-pools.js", "./node-enum.js", "../utils/prefab-utils.js"], function (_export, _context) {
  ...
  var ccclass, editable, serializable, type, Layers, NodeUIProperties, SystemEventType, eventManager, legacyCC, BaseNode, TRANSFORM_ON, Mat3, Mat4, Quat, Vec3, NULL_HANDLE, NodePool, NodeView, NodeSpace, TransformBit, applyMountedChildren, applyPropertyOverrides, applyTargetOverrides, createNodeWithPrefab, generateTargetMap, _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _class3, _temp, v3_a, q_a, q_b, array_a, qt_1, m3_1, m3_scaling, m4_1, bookOfChange, Node;
  ...
  return {
    ...
    execute: function () {
      ...
      q_a = new Quat();
      q_b = new Quat();
      array_a = new Array(10);
      qt_1 = new Quat();
      m3_1 = new Mat3();
      m3_scaling = new Mat3();
      m4_1 = new Mat4();
      bookOfChange = new Map();
      /**
       * @zh
       * 场景树中的基本节点，基本特性有：
       * * 具有层级关系
      ...
      _export("Node", Node = (_dec = ccclass('cc.Node'), _dec2 = type(Vec3), _dec(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_BaseNode) {
        ...
        return Node;
      }(BaseNode), _class3.bookOfChange = bookOfChange, _class3.EventType = SystemEventType, _class3.NodeSpace = NodeSpace, _class3.TransformDirtyBit = TransformBit, _class3.TransformBit = TransformBit, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "_lpos", [serializable], {
        configurable: true,
        enumerable: true,
        writable: true,
