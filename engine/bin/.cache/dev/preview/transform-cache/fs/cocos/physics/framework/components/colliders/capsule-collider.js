System.register("q-bundled:///fs/cocos/physics/framework/components/colliders/capsule-collider.js", ["../../../../core/data/decorators/index.js", "../../../../../../virtual/internal%253Aconstants.js", "./collider.js", "../../physics-enum.js", "../../../../core/index.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
       ...
       * 胶囊体碰撞器。
       */
      _export("CapsuleCollider", CapsuleCollider = (_dec = ccclass('cc.CapsuleCollider'), _dec2 = help('i18n:cc.CapsuleCollider'), _dec3 = menu('Physics/CapsuleCollider'), _dec4 = tooltip('本地坐标系下胶囊体上的球的半径'), _dec5 = tooltip('本地坐标系下胶囊体上的圆柱体的高度'), _dec6 = type(EAxisDirection), _dec7 = tooltip('本地坐标系下胶囊体的朝向'), _dec(_class = _dec2(_class = _dec3(_class = executeInEditMode(_class = (_class2 = (_temp = /*#__PURE__*/function (_Collider) {
