System.register("q-bundled:///fs/cocos/physics/framework/components/colliders/mesh-collider.js", ["../../../../core/data/decorators/index.js", "../../../../../../virtual/internal%253Aconstants.js", "./collider.js", "../../../../3d/assets/index.js", "../../physics-enum.js"], function (_export, _context) {
  ...
  var ccclass, help, executeInEditMode, menu, type, editable, serializable, EDITOR, TEST, Collider, Mesh, EColliderType, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _temp, MeshCollider;
  ...
  return {
    ...
    execute: function () {
       ...
       * 三角网格碰撞器。
       */
      _export("MeshCollider", MeshCollider = (_dec = ccclass('cc.MeshCollider'), _dec2 = help('i18n:cc.MeshCollider'), _dec3 = menu('Physics/MeshCollider'), _dec4 = type(Mesh), _dec(_class = _dec2(_class = _dec3(_class = executeInEditMode(_class = (_class2 = (_temp = /*#__PURE__*/function (_Collider) {
        ...
        return MeshCollider;
      }(Collider), _temp), (_applyDecoratedDescriptor(_class2.prototype, "mesh", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "mesh"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "convex", [editable], Object.getOwnPropertyDescriptor(_class2.prototype, "convex"), _class2.prototype), _descriptor = _applyDecoratedDescriptor(_class2.prototype, "_mesh", [serializable], {
        configurable: true,
        enumerable: true,
        writable: true,
