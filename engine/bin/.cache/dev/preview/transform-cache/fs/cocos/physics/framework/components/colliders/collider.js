System.register("q-bundled:///fs/cocos/physics/framework/components/colliders/collider.js", ["../../../../core/data/decorators/index.js", "../../../../../../virtual/internal%253Aconstants.js", "../../../../core/event/index.js", "../../../../core/math/index.js", "../rigid-body.js", "../../assets/physics-material.js", "../../physics-system.js", "../../../../core/index.js", "../../../../core/geometry/index.js", "../../physics-enum.js", "../../instance.js"], function (_export, _context) {
  ...
  var ccclass, tooltip, displayOrder, displayName, readOnly, type, serializable, EDITOR, Eventify, Vec3, RigidBody, PhysicsMaterial, PhysicsSystem, Component, error, AABB, Sphere, EColliderType, EAxisDirection, createShape, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _class, _class2, _descriptor, _descriptor2, _descriptor3, _class3, _temp, Collider;
  ...
  return {
    ...
    execute: function () {
       ...
       * 碰撞器的基类。
       */
      _export("Collider", Collider = (_dec = ccclass('cc.Collider'), _dec2 = type(RigidBody), _dec3 = displayName('Attached'), _dec4 = displayOrder(-2), _dec5 = type(PhysicsMaterial), _dec6 = displayName('Material'), _dec7 = displayOrder(-1), _dec8 = tooltip('源材质'), _dec9 = displayOrder(0), _dec10 = tooltip('是否为触发器，触发器不会产生物理反馈'), _dec11 = type(Vec3), _dec12 = displayOrder(1), _dec13 = tooltip('形状的中心点（与所在 Node 中心点的相对位置）'), _dec14 = type(PhysicsMaterial), _dec(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Eventify) {
