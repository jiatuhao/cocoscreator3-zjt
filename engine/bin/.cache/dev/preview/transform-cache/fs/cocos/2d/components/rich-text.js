System.register("q-bundled:///fs/cocos/2d/components/rich-text.js", ["../../core/data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../assets/index.js", "../../core/platform/index.js", "../utils/text-utils.js", "../utils/html-text-parser.js", "../../core/utils/pool.js", "../../core/math/index.js", "../../core/scene-graph/index.js", "./label.js", "./label-outline.js", "./sprite.js", "../framework/index.js", "../../core/global-exports.js", "../../core/components/index.js", "../../core/asset-manager/asset-manager.js"], function (_export, _context) {
  ...
  return {
    setters: [function (_coreDataDecoratorsIndexJs) {
      ...
      PrivateNode = _coreSceneGraphIndexJs.PrivateNode;
    }, function (_labelJs) {
    ...
    execute: function () {
       ...
       * 富文本组件。
       */
      _export("RichText", RichText = (_dec = ccclass('cc.RichText'), _dec2 = help('i18n:cc.RichText'), _dec3 = executionOrder(110), _dec4 = menu('2D/RichText'), _dec5 = tooltip('富文本显示的文本内容'), _dec6 = type(HorizontalTextAlignment), _dec7 = tooltip('文本内容的水平对齐方式'), _dec8 = tooltip('富文本字体大小'), _dec9 = tooltip('富文本定制系统字体'), _dec10 = type(Font), _dec11 = tooltip('富文本定制字体'), _dec12 = tooltip('是否使用系统字体'), _dec13 = type(CacheMode), _dec14 = tooltip('文本缓存模式, 该模式只支持系统字体。'), _dec15 = tooltip('富文本的最大宽度'), _dec16 = tooltip('富文本行高'), _dec17 = type(SpriteAtlas), _dec18 = tooltip('对于 img 标签里面的 src 属性名称，都需要在 imageAtlas 里面找到一个有效的 spriteFrame，否则 img tag 会判定为无效'), _dec19 = tooltip('选中此选项后，RichText 将阻止节点边界框中的所有输入事件（鼠标和触摸），从而防止输入事件穿透到底层节点'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = executeInEditMode(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_UIComponent) {
