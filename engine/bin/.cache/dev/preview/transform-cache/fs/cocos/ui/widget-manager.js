System.register("q-bundled:///fs/cocos/ui/widget-manager.js", ["../../../virtual/internal%253Aconstants.js", "../core/director.js", "../core/math/index.js", "../core/platform/view.js", "../core/platform/visible-rect.js", "../core/scene-graph/index.js", "../core/scene-graph/node.js", "../core/utils/js.js", "./widget.js", "../2d/framework/index.js", "../core/global-exports.js"], function (_export, _context) {
  "use strict";

  var EDITOR, DEV, Director, director, Vec2, Vec3, View, visibleRect, Scene, Node, array, AlignFlags, AlignMode, computeInverseTransForTarget, getReadonlyNodeSize, Widget, UITransform, legacyCC, _tempPos, _defaultAnchor, tInverseTranslate, tInverseScale, activeWidgets, widgetManager;
  ...
  return {
    ...
    execute: function () {
      ...
      tInverseTranslate = new Vec3();
      tInverseScale = new Vec3(1, 1, 1);
      activeWidgets = [];
