System.register("q-bundled:///fs/cocos/spine/skeleton-data.js", ["../../../virtual/internal%253Aconstants.js", "../core/index.js", "./skeleton-cache.js", "./skeleton-texture.js", "./lib/spine-core.js", "../core/data/decorators/index.js", "../core/global-exports.js"], function (_export, _context) {
  ...
  var EDITOR, Asset, CCString, Enum, Node, Texture2D, SkeletonCache, SkeletonTexture, spine, ccclass, serializable, type, legacyCC, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _class3, _temp, SkeletonData;
  ...
  return {
    ...
    execute: function () {
       ...
       * @extends Asset
       */
      _export("SkeletonData", SkeletonData = (_dec = ccclass('sp.SkeletonData'), _dec2 = type([Texture2D]), _dec3 = type([CCString]), _dec(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Asset) {
