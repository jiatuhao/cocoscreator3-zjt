System.register("q-bundled:///fs/cocos/ui/scroll-bar.js", ["../core/data/decorators/index.js", "../core/components/component.js", "../2d/framework/index.js", "../core/math/index.js", "../core/value-types/enum.js", "../core/math/utils.js", "../2d/components/sprite.js"], function (_export, _context) {
  "use strict";

  var ccclass, help, executionOrder, menu, requireComponent, tooltip, displayOrder, type, serializable, Component, UITransform, Color, Vec2, Vec3, ccenum, clamp01, Sprite, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _class3, _temp, GETTING_SHORTER_FACTOR, ZERO, _tempPos_1, _tempPos_2, defaultAnchor, _tempColor, Direction, ScrollBar;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ScrollBar", ScrollBar = (_dec = ccclass('cc.ScrollBar'), _dec2 = help('i18n:cc.ScrollBar'), _dec3 = executionOrder(110), _dec4 = menu('UI/ScrollBar'), _dec5 = requireComponent(UITransform), _dec6 = type(Sprite), _dec7 = displayOrder(0), _dec8 = tooltip('作为当前滚动区域位置显示的滑块 Sprite'), _dec9 = type(Direction), _dec10 = displayOrder(1), _dec11 = tooltip('ScrollBar 的滚动方向'), _dec12 = displayOrder(2), _dec13 = tooltip('是否在没有滚动动作时自动隐藏 ScrollBar'), _dec14 = displayOrder(3), _dec15 = tooltip('没有滚动动作后经过多久会自动隐藏。\n注意：只要当 “enableAutoHide” 为 true 时，才有效。'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Component) {
