System.register("q-bundled:///fs/cocos/ui/scroll-view.js", ["../core/data/decorators/index.js", "../../../virtual/internal%253Aconstants.js", "../core/components/component-event-handler.js", "../2d/framework/index.js", "../core/event/index.js", "../core/platform/index.js", "../core/math/index.js", "./layout.js", "./scroll-bar.js", "./view-group.js", "../core/scene-graph/node.js", "../core/director.js", "../core/scene-graph/node-enum.js", "../core/global-exports.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
       ...
       * 滚动视图组件。
       */
      _export("ScrollView", ScrollView = (_dec = ccclass('cc.ScrollView'), _dec2 = help('i18n:cc.ScrollView'), _dec3 = executionOrder(110), _dec4 = menu('UI/ScrollView'), _dec5 = requireComponent(UITransform), _dec6 = range([0, 10]), _dec7 = displayOrder(0), _dec8 = tooltip('回弹持续的时间，0 表示将立即反弹'), _dec9 = range([0, 1, 0.1]), _dec10 = displayOrder(1), _dec11 = tooltip('开启惯性后，在用户停止触摸后滚动多快停止，0 表示永不停止，1 表示立刻停止'), _dec12 = displayOrder(2), _dec13 = tooltip('是否允许滚动内容超过边界，并在停止触摸后回弹'), _dec14 = displayOrder(3), _dec15 = tooltip('是否开启滚动惯性'), _dec16 = type(Node), _dec17 = displayOrder(4), _dec18 = tooltip('可滚动展示内容的节点'), _dec19 = displayOrder(5), _dec20 = tooltip('是否开启水平滚动'), _dec21 = type(ScrollBar), _dec22 = displayOrder(6), _dec23 = tooltip('水平滚动的 ScrollBar'), _dec24 = displayOrder(7), _dec25 = tooltip('是否开启垂直滚动'), _dec26 = type(ScrollBar), _dec27 = displayOrder(8), _dec28 = tooltip('垂直滚动的 ScrollBar'), _dec29 = displayOrder(9), _dec30 = tooltip('滚动行为是否会取消子节点上注册的触摸事件'), _dec31 = type([ComponentEventHandler]), _dec32 = displayOrder(10), _dec33 = tooltip('滚动视图的事件回调函数'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_ViewGroup) {
