System.register("q-bundled:///fs/cocos/core/gfx/pipeline-state.js", ["./define-class.js", "./define.js", "../renderer/core/memory-pools.js"], function (_export, _context) {
  "use strict";

  var Color, BlendFactor, BlendOp, ColorMask, ComparisonFunc, CullMode, DynamicStateFlagBit, Obj, ObjectType, PolygonMode, PrimitiveMode, ShadeModel, StencilOp, NULL_HANDLE, RasterizerState, DepthStencilState, BlendTarget, BlendState, InputState, PipelineStateInfo, PipelineState;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("InputState", InputState = // to make sure all usages must be an instance of this exact class, not assembled from plain object
      ...
      function PipelineStateInfo(shader, pipelineLayout, renderPass, inputState, rasterizerState, depthStencilState, blendState, primitive, dynamicStates) {
        if (primitive === void 0) {
