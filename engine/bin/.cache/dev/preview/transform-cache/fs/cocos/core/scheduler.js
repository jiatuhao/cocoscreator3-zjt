System.register("q-bundled:///fs/cocos/core/scheduler.js", ["./utils/id-generator.js", "./utils/js.js", "./components/system.js", "./global-exports.js", "./platform/debug.js"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
       ...
       */
      ListEntry = function ListEntry(target, priority, paused, markedForDeletion) {
        this.target = void 0;
      ...
      HashUpdateEntry = function HashUpdateEntry(list, entry, target, callback) {
        this.list = void 0;
        this.entry = void 0;
        this.target = void 0;
      ...
      HashTimerEntry = function HashTimerEntry(timers, target, timerIndex, currentTimer, currentTimerSalvaged, paused) {
        this.timers = void 0;
        this.target = void 0;
      ...
      _export("Scheduler", Scheduler = /*#__PURE__*/function (_System) {
        ...
        _proto2.schedule = function schedule(callback, target, interval, repeat, delay, paused) {
          if (typeof callback !== 'function') {
            var tmp = callback; // @ts-expect-error
