System.register("q-bundled:///fs/cocos/core/assets/asset.js", ["../data/decorators/index.js", "../data/decorators/property.js", "../asset-manager/helper.js", "../event/index.js", "../data/object.js", "../global-exports.js", "../utils/path.js"], function (_export, _context) {
  "use strict";

  var ccclass, serializable, property, getUrlWithUuid, Eventify, CCObject, legacyCC, extname, _dec, _class, _class2, _descriptor, _class3, _temp, Asset;
  ...
  return {
    ...
    execute: function () {
       ...
       * @extends CCObject
       */
      _export("Asset", Asset = (_dec = ccclass('cc.Asset'), _dec(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Eventify) {
