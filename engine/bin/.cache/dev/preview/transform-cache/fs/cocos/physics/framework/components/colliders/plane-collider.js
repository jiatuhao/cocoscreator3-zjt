System.register("q-bundled:///fs/cocos/physics/framework/components/colliders/plane-collider.js", ["../../../../core/data/decorators/index.js", "../../../../../../virtual/internal%253Aconstants.js", "../../../../core/math/index.js", "./collider.js", "../../physics-enum.js"], function (_export, _context) {
  ...
  var ccclass, help, executeInEditMode, menu, tooltip, type, editable, serializable, EDITOR, TEST, Vec3, Collider, EColliderType, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _temp, PlaneCollider;
  ...
  return {
    ...
    execute: function () {
       ...
       * 静态平面碰撞器。
       */
      _export("PlaneCollider", PlaneCollider = (_dec = ccclass('cc.PlaneCollider'), _dec2 = help('i18n:cc.PlaneCollider'), _dec3 = menu('Physics/PlaneCollider(beta)'), _dec4 = type(Vec3), _dec5 = tooltip('平面的法线'), _dec(_class = _dec2(_class = _dec3(_class = executeInEditMode(_class = (_class2 = (_temp = /*#__PURE__*/function (_Collider) {
      ...
      }(Collider), _temp), (_applyDecoratedDescriptor(_class2.prototype, "normal", [_dec4, _dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "normal"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "constant", [editable], Object.getOwnPropertyDescriptor(_class2.prototype, "constant"), _class2.prototype), _descriptor = _applyDecoratedDescriptor(_class2.prototype, "_normal", [serializable], {
        configurable: true,
        enumerable: true,
        writable: true,
