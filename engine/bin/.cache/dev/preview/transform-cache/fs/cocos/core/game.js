System.register("q-bundled:///fs/cocos/core/game.js", ["../../../virtual/internal%253Aconstants.js", "./event/event-target.js", "./platform/debug.js", "./platform/event-manager/input-manager.js", "./gfx/index.js", "./platform/sys.js", "./platform/macro.js", "./global-exports.js", "./pipeline/define.js", "./pipeline/index.js"], function (_export, _context) {
  "use strict";

  var EDITOR, JSB, PREVIEW, RUNTIME_BASED, EventTarget, debug, inputManager, DeviceInfo, sys, macro, legacyCC, VERSION, bindingMappingInfo, RenderPipeline, Game, game;
    ...
    execute: function () {
      ...
      _export("Game", Game = /*#__PURE__*/function (_EventTarget) {
        ...
        _proto._initEvents = function _initEvents() {
          ...
          var hidden = false; // eslint-disable-next-line @typescript-eslint/no-this-alias
          ...
          if (hiddenPropName) {
            ...
            for (var i = 0; i < changeList.length; i++) {
              document.addEventListener(changeList[i], function (event) {
                var visible = document[hiddenPropName]; // @ts-expect-error QQ App
