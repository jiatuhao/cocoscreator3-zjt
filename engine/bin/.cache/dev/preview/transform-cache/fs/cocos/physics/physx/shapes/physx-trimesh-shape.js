System.register("q-bundled:///fs/cocos/physics/physx/shapes/physx-trimesh-shape.js", ["../../../core/index.js", "../export-physx.js", "./physx-shape.js"], function (_export, _context) {
  "use strict";

  var GFXAttributeName, Quat, Vec3, createConvexMesh, createMeshGeometryFlags, createTriangleMesh, PX, EPhysXShapeType, PhysXShape, PhysXTrimeshShape;
  ...
  return {
    setters: [function (_coreIndexJs) {
      GFXAttributeName = _coreIndexJs.GFXAttributeName;
          ...
          if (v && v.renderingSubMeshes.length > 0 && this._impl == null) {
            ...
            if (collider.convex) {
              if (PX.MESH_CONVEX[v._uuid] == null) {
                ...
                var posBuf = v.readAttribute(0, GFXAttributeName.ATTR_POSITION);
              ...
              if (PX.MESH_STATIC[v._uuid] == null) {
                ...
                var _posBuf = v.readAttribute(0, GFXAttributeName.ATTR_POSITION);
