System.register("q-bundled:///fs/cocos/particle/animator/size-overtime.js", ["../../core/data/decorators/index.js", "../../core/math/index.js", "../particle.js", "./curve-range.js", "../enum.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", SizeOvertimeModule = (_dec = ccclass('cc.SizeOvertimeModule'), _dec2 = displayOrder(0), _dec3 = displayOrder(1), _dec4 = tooltip('决定是否在每个轴上独立控制粒子大小'), _dec5 = type(CurveRange), _dec6 = displayOrder(2), _dec7 = tooltip('定义一条曲线来决定粒子在其生命周期中的大小变化'), _dec8 = type(CurveRange), _dec9 = displayOrder(3), _dec10 = tooltip('定义一条曲线来决定粒子在其生命周期中 X 轴方向上的大小变化'), _dec11 = type(CurveRange), _dec12 = displayOrder(4), _dec13 = tooltip('定义一条曲线来决定粒子在其生命周期中 Y 轴方向上的大小变化'), _dec14 = type(CurveRange), _dec15 = displayOrder(5), _dec16 = tooltip('定义一条曲线来决定粒子在其生命周期中 Z 轴方向上的大小变化'), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_ParticleModuleBase) {
