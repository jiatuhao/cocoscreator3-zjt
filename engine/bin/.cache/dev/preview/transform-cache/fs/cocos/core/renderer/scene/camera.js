System.register("q-bundled:///fs/cocos/core/renderer/scene/camera.js", ["../../../../../virtual/internal%253Aconstants.js", "../../geometry/index.js", "../../gfx/define.js", "../../math/index.js", "../../pipeline/define.js", "../../gfx/index.js", "../../global-exports.js", "../core/memory-pools.js", "../../geometry/frustum.js", "../../math/mat4.js"], function (_export, _context) {
  "use strict";

  var JSB, Frustum, Ray, ClearFlag, SurfaceTransform, lerp, Mat4, Rect, toRadian, Vec3, CAMERA_DEFAULT_MASK, Color, legacyCC, CameraPool, CameraView, FrustumPool, NULL_HANDLE, recordFrustumToSharedMemory, preTransforms, CameraFOVAxis, CameraProjection, CameraAperture, CameraISO, CameraShutter, FSTOPS, SHUTTERS, ISOS, v_a, v_b, _tempMat1, SKYBOX_FLAG, correctionMatrices, Camera;
  ...
  return {
    setters: [function (_virtualInternal253AconstantsJs) {
      ...
      SurfaceTransform = _gfxDefineJs.SurfaceTransform;
    ...
    execute: function () {
      ...
      _export("SKYBOX_FLAG", SKYBOX_FLAG = ClearFlag.STENCIL << 1);
