System.register("q-bundled:///fs/cocos/tiledmap/tiled-tile.js", ["../core/data/decorators/index.js", "../core/components/index.js", "../core/index.js"], function (_export, _context) {
  "use strict";

  var ccclass, help, menu, type, Component, CCInteger, warn, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _temp, TiledTile;
  ...
  return {
    ...
    execute: function () {
      _export("TiledTile", TiledTile = (_dec = ccclass('cc.TiledTile'), _dec2 = help('i18n:cc.TiledTile'), _dec3 = menu('TiledMap/TiledTile'), _dec4 = type(CCInteger), _dec5 = type(CCInteger), _dec6 = type(CCInteger), _dec7 = type(CCInteger), _dec8 = type(CCInteger), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
