System.register("q-bundled:///fs/cocos/particle/animator/rotation-overtime.js", ["../../core/data/decorators/index.js", "../../core/math/index.js", "../particle.js", "./curve-range.js", "../enum.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", RotationOvertimeModule = (_dec = ccclass('cc.RotationOvertimeModule'), _dec2 = displayOrder(0), _dec3 = displayOrder(1), _dec4 = tooltip('是否三个轴分开设定旋转（暂不支持）'), _dec5 = type(CurveRange), _dec6 = range([-1, 1]), _dec7 = displayOrder(2), _dec8 = tooltip('绕 X 轴设定旋转'), _dec9 = type(CurveRange), _dec10 = range([-1, 1]), _dec11 = displayOrder(3), _dec12 = tooltip('绕 Y 轴设定旋转'), _dec13 = type(CurveRange), _dec14 = range([-1, 1]), _dec15 = displayOrder(4), _dec16 = tooltip('绕 Z 轴设定旋转'), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_ParticleModuleBase) {
