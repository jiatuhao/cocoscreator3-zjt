System.register("q-bundled:///fs/cocos/core/renderer/core/pass.js", ["../../../../../virtual/internal%253Aconstants.js", "../../builtin/builtin-res-mgr.js", "../../pipeline/pass-phase.js", "../../utils/murmurhash2_gc.js", "./sampler-lib.js", "../../gfx/index.js", "../../gfx/define.js", "./memory-pools.js", "./program-lib.js", "./pass-utils.js", "../../pipeline/define.js"], function (_export, _context) {
  "use strict";

  var EDITOR, builtinResMgr, getPhaseID, murmurhash2_32_gc, samplerLib, BlendState, BufferInfo, BufferViewInfo, DepthStencilState, DescriptorSetInfo, RasterizerState, BufferUsageBit, Feature, GetTypeSize, MemoryUsageBit, PrimitiveMode, Type, DSPool, NULL_HANDLE, PassPool, PassView, programLib, PropertyType, customizeType, getBindingFromHandle, getDefaultFromType, getOffsetFromHandle, getPropertyTypeFromHandle, getTypeFromHandle, type2reader, type2writer, RenderPassStage, RenderPriority, _bufferInfo, _bufferViewInfo, _dsInfo, BatchingSchemes, Pass;
  ...
  return {
    setters: [function (_virtualInternal253AconstantsJs) {
      ...
      Feature = _gfxDefineJs.Feature;
      GetTypeSize = _gfxDefineJs.GetTypeSize;
      MemoryUsageBit = _gfxDefineJs.MemoryUsageBit;
      PrimitiveMode = _gfxDefineJs.PrimitiveMode;
      Type = _gfxDefineJs.Type;
