System.register("q-bundled:///fs/cocos/tiledmap/tiled-object-group.js", ["../core/data/decorators/index.js", "../core/components/index.js", "../2d/components/sprite.js", "../2d/components/label.js", "../core/gfx/index.js", "./tiled-types.js", "../2d/framework/ui-transform.js", "../core/index.js", "../2d/assets/index.js"], function (_export, _context) {
  "use strict";

  var ccclass, help, type, requireComponent, Component, Sprite, Label, BlendFactor, TileFlag, Orientation, StaggerAxis, TMXObjectType, UITransform, CCBoolean, Node, Vec2, Color, PrivateNode, SpriteFrame, _dec, _dec2, _dec3, _dec4, _class, _class2, _temp, TiledObjectGroup;
  ...
  return {
    ...
    execute: function () {
       ...
       * @extends Component
       */
      _export("TiledObjectGroup", TiledObjectGroup = (_dec = ccclass('cc.TiledObjectGroup'), _dec2 = help('i18n:cc.TiledObjectGroup'), _dec3 = requireComponent(UITransform), _dec4 = type(CCBoolean), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
      ...
      }(Component), _temp), (_applyDecoratedDescriptor(_class2.prototype, "premultiplyAlpha", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "premultiplyAlpha"), _class2.prototype)), _class2)) || _class) || _class) || _class));
    }
  };
});