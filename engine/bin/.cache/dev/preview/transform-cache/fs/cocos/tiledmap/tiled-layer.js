System.register("q-bundled:///fs/cocos/tiledmap/tiled-layer.js", ["../core/data/decorators/index.js", "../../../virtual/internal%253Aconstants.js", "../2d/framework/renderable-2d.js", "../core/components/index.js", "../core/index.js", "./tiled-tile.js", "../2d/renderer/render-data.js", "./tiled-types.js", "./tiled-utils.js"], function (_export, _context) {
  "use strict";

  var ccclass, EDITOR, Renderable2D, Component, Mat4, SystemEventType, Vec2, Vec3, Node, warn, logID, director, TiledTile, MeshRenderData, Orientation, StaggerAxis, StaggerIndex, TileFlag, fillTextureGrids, loadAllTextures, _dec, _class, _temp, _dec2, _class3, _temp2, _mat4_temp, _vec2_temp, _vec3_temp, _vec3_temp2, _tempRowCol, TiledUserNodeData, TiledLayer;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("TiledUserNodeData", TiledUserNodeData = (_dec = ccclass('cc.TiledUserNodeData'), _dec(_class = (_temp = /*#__PURE__*/function (_Component) {
       ...
       * @extends Component
       */
      _export("TiledLayer", TiledLayer = (_dec2 = ccclass('cc.TiledLayer'), _dec2(_class3 = (_temp2 = /*#__PURE__*/function (_Renderable2D) {
        ...
        _proto.getTileFlagsAt = function getTileFlagsAt(x, y) {
          ...
          var idx = Math.floor(x) + Math.floor(y) * this._layerSize.width; // Bits on the far end of the 32-bit global tile ID are used for tile flags
        ...
        _proto.init = function init(layerInfo, mapInfo, tilesets, textures, texGrids) {
          ...
          var size = layerInfo.layerSize; // layerInfo
