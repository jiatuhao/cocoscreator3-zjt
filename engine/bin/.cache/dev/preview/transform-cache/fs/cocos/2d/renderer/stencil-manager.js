System.register("q-bundled:///fs/cocos/2d/renderer/stencil-manager.js", ["../../core/gfx/define.js", "../../core/gfx/pipeline-state.js"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_coreGfxDefineJs) {
      ComparisonFunc = _coreGfxDefineJs.ComparisonFunc;
      StencilOp = _coreGfxDefineJs.StencilOp;
    }, function (_coreGfxPipelineStateJs) {
      DepthStencilState = _coreGfxPipelineStateJs.DepthStencilState;
    }],
    execute: function () {
      (function (Stage) {
