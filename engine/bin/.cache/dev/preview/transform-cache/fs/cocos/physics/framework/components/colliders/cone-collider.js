System.register("q-bundled:///fs/cocos/physics/framework/components/colliders/cone-collider.js", ["../../../../core/data/decorators/index.js", "../../../../../../virtual/internal%253Aconstants.js", "./collider.js", "../../physics-enum.js"], function (_export, _context) {
  ...
  var ccclass, help, executeInEditMode, menu, tooltip, type, serializable, EDITOR, TEST, Collider, EAxisDirection, EColliderType, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _temp, ConeCollider;
  ...
  return {
    ...
    execute: function () {
       ...
       * 圆锥体碰撞器。
       */
      _export("ConeCollider", ConeCollider = (_dec = ccclass('cc.ConeCollider'), _dec2 = help('i18n:cc.ConeCollider'), _dec3 = menu('Physics/ConeCollider(beta)'), _dec4 = tooltip('圆锥体上圆面的半径'), _dec5 = tooltip('圆锥体在相应轴向的高度'), _dec6 = type(EAxisDirection), _dec(_class = _dec2(_class = _dec3(_class = executeInEditMode(_class = (_class2 = (_temp = /*#__PURE__*/function (_Collider) {
