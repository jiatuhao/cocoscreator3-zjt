System.register("q-bundled:///fs/cocos/dragon-bones/DragonBonesAtlasAsset.js", ["../../../virtual/internal%253Aconstants.js", "../core/index.js", "../core/data/decorators/index.js", "./ArmatureCache.js", "../core/global-exports.js"], function (_export, _context) {
  ...
  var JSB, Asset, Texture2D, Node, ccclass, serializable, type, ArmatureCache, legacyCC, _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _class3, _temp, DragonBonesAtlasAsset;
  ...
  return {
    ...
    execute: function () {
       ...
       * @extends Asset
       */
      _export("DragonBonesAtlasAsset", DragonBonesAtlasAsset = (_dec = ccclass('dragonBones.DragonBonesAtlasAsset'), _dec2 = type(Texture2D), _dec(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Asset) {
      ...
      }(Asset), _class3.preventDeferredLoadDependents = void 0, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "_atlasJson", [serializable], {
        configurable: true,
        enumerable: true,
        writable: true,
