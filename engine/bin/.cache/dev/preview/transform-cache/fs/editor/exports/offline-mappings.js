System.register("q-bundled:///fs/editor/exports/offline-mappings.js", ["../../cocos/core/gfx/define.js", "../../cocos/core/renderer/core/constants.js", "../../cocos/core/pipeline/define.js", "../../cocos/core/utils/murmurhash2_gc.js", "../../cocos/core/renderer/core/sampler-lib.js"], function (_export, _context) {
  "use strict";

  var Address, BlendFactor, BlendOp, ColorMask, ComparisonFunc, CullMode, DynamicStateFlagBit, Filter, Format, FormatInfos, FormatType, GetTypeSize, PolygonMode, PrimitiveMode, ShadeModel, ShaderStageFlagBit, StencilOp, Type, DescriptorType, RenderQueue, RenderPassStage, RenderPriority, SetIndex, murmurhash2_32_gc, SamplerInfoIndex, genSamplerHash, typeMap, isSampler, isPaddedMatrix, formatMap, getFormat, getShaderStage, getDescriptorType, isNormalized, passParams, effectStructure;
  return {
    setters: [function (_cocosCoreGfxDefineJs) {
      Address = _cocosCoreGfxDefineJs.Address;
      BlendFactor = _cocosCoreGfxDefineJs.BlendFactor;
      BlendOp = _cocosCoreGfxDefineJs.BlendOp;
      ColorMask = _cocosCoreGfxDefineJs.ColorMask;
      ComparisonFunc = _cocosCoreGfxDefineJs.ComparisonFunc;
      CullMode = _cocosCoreGfxDefineJs.CullMode;
      DynamicStateFlagBit = _cocosCoreGfxDefineJs.DynamicStateFlagBit;
      Filter = _cocosCoreGfxDefineJs.Filter;
      Format = _cocosCoreGfxDefineJs.Format;
      FormatInfos = _cocosCoreGfxDefineJs.FormatInfos;
      FormatType = _cocosCoreGfxDefineJs.FormatType;
      GetTypeSize = _cocosCoreGfxDefineJs.GetTypeSize;
      PolygonMode = _cocosCoreGfxDefineJs.PolygonMode;
      PrimitiveMode = _cocosCoreGfxDefineJs.PrimitiveMode;
      ShadeModel = _cocosCoreGfxDefineJs.ShadeModel;
      ShaderStageFlagBit = _cocosCoreGfxDefineJs.ShaderStageFlagBit;
      StencilOp = _cocosCoreGfxDefineJs.StencilOp;
      Type = _cocosCoreGfxDefineJs.Type;
      DescriptorType = _cocosCoreGfxDefineJs.DescriptorType;
    }, function (_cocosCoreRendererCoreConstantsJs) {
      RenderQueue = _cocosCoreRendererCoreConstantsJs.RenderQueue;
    }, function (_cocosCorePipelineDefineJs) {
      RenderPassStage = _cocosCorePipelineDefineJs.RenderPassStage;
      RenderPriority = _cocosCorePipelineDefineJs.RenderPriority;
      SetIndex = _cocosCorePipelineDefineJs.SetIndex;
    }, function (_cocosCoreUtilsMurmurhash2_gcJs) {
      murmurhash2_32_gc = _cocosCoreUtilsMurmurhash2_gcJs.murmurhash2_32_gc;
    }, function (_cocosCoreRendererCoreSamplerLibJs) {
      SamplerInfoIndex = _cocosCoreRendererCoreSamplerLibJs.SamplerInfoIndex;
      genSamplerHash = _cocosCoreRendererCoreSamplerLibJs.genSamplerHash;
    }],
    execute: function () {
      _export("typeMap", typeMap = {});
      ...
      typeMap[typeMap.samplerCube = Type.SAMPLER_CUBE] = 'samplerCube'; // variations
      ...
      _export("isSampler", isSampler = function isSampler(type) {
        return type >= Type.SAMPLER1D;
      });

      _export("isPaddedMatrix", isPaddedMatrix = function isPaddedMatrix(type) {
        return type >= Type.MAT2 && type < Type.MAT4;
      });

      _export("formatMap", formatMap = {
        bool: Format.R8,
        bvec2: Format.RG8,
        bvec3: Format.RGB8,
        bvec4: Format.RGBA8,
      ...
      _export("getFormat", getFormat = function getFormat(name) {
        return typeof name === 'string' && Format[name.toUpperCase()];
      });

      _export("getShaderStage", getShaderStage = function getShaderStage(name) {
        return typeof name === 'string' && ShaderStageFlagBit[name.toUpperCase()];
      });

      _export("getDescriptorType", getDescriptorType = function getDescriptorType(name) {
        return typeof name === 'string' && DescriptorType[name.toUpperCase()];
      });

      _export("isNormalized", isNormalized = function isNormalized(format) {
        var type = FormatInfos[format] && FormatInfos[format].type;
        return type === FormatType.UNORM || type === FormatType.SNORM;
      });

      _export("passParams", passParams = {
        // color mask
        NONE: ColorMask.NONE,
        R: ColorMask.R,
        G: ColorMask.G,
      ...
      _export("effectStructure", effectStructure = {
        $techniques: [{
          $passes: [{
            depthStencilState: {},
            rasterizerState: {},
      ...
      _export("SamplerInfoIndex", SamplerInfoIndex);

      _export("genSamplerHash", genSamplerHash);

      _export("RenderQueue", RenderQueue);

      _export("SetIndex", SetIndex);

      _export("RenderPriority", RenderPriority);

      _export("GetTypeSize", GetTypeSize);
    }
  };
});