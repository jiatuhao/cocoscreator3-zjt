System.register("q-bundled:///virtual/quick-compiler.babel-helpers.js", [], function (_export, _context) {
  "use strict";

  var REACT_ELEMENT_TYPE, id;

  function _typeof(obj) {
    "@babel/helpers - typeof";

    if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
      _export("typeof", _typeof = function (obj) {
        return typeof obj;
      });
    } else {
      _export("typeof", _typeof = function (obj) {
  ...
  function _extends() {
    _export("extends", _extends = Object.assign || function (target) {
  ...
  function _getPrototypeOf(o) {
    _export("getPrototypeOf", _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) {
  ...
  function _setPrototypeOf(o, p) {
    _export("setPrototypeOf", _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) {
      o.__proto__ = p;
      return o;
    });
  ...
  function _construct(Parent, args, Class) {
    if (_isNativeReflectConstruct()) {
      _export("construct", _construct = Reflect.construct);
    } else {
      _export("construct", _construct = function _construct(Parent, args, Class) {
        var a = [null];
        a.push.apply(a, args);
  ...
  function _wrapNativeSuper(Class) {
    ...
    _export("wrapNativeSuper", _wrapNativeSuper = function _wrapNativeSuper(Class) {
  ...
  function _get(target, property, receiver) {
    if (typeof Reflect !== "undefined" && Reflect.get) {
      _export("get", _get = Reflect.get);
    } else {
      _export("get", _get = function _get(target, property, receiver) {
  ...
  function _wrapRegExp(re, groups) {
    _export("wrapRegExp", _wrapRegExp = function (re, groups) {
