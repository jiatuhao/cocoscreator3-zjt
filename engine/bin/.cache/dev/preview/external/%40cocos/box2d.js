System.register(['../_commonjsHelpers-9cedf210.js', '../_rollupPluginBabelHelpers-77b9e6b6.js'], function (exports) {
  'use strict';
  var createCommonjsModule, commonjsGlobal, _construct, _createClass, _classCallCheck, _inherits, _possibleConstructorReturn, _getPrototypeOf, _get, _createForOfIteratorHelper;
  return {
    ...
    execute: function () {
      ...
      this.m_count--;var element=this.m_stack[this.m_count];this.m_stack[this.m_count]=null;if(element===null){throw new Error();}return element;}},{key:"GetCount",value:function GetCount(){return this.m_count;}}]);return b2GrowableStack;}();/*
        ...
        * misrepresented as being the original software.
        * 3. This notice may not be removed or altered from any source distribution.
        */var b2BlockAllocator=function b2BlockAllocator(){_classCallCheck(this,b2BlockAllocator);};/*
        * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
        *
        * This software is provided 'as-is', without any express or implied
        * warranty.  In no event will the authors be held liable for any damages
        ...
        * misrepresented as being the original software.
        * 3. This notice may not be removed or altered from any source distribution.
        */var b2StackAllocator=function b2StackAllocator(){_classCallCheck(this,b2StackAllocator);};/*
        * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
        *
        * This software is provided 'as-is', without any express or implied
        * warranty.  In no event will the authors be held liable for any damages
      ...
      var b2ShapeCastInput=function b2ShapeCastInput(){_classCallCheck(this,b2ShapeCastInput);this.proxyA=new b2DistanceProxy();this.proxyB=new b2DistanceProxy();this.transformA=new b2Transform();this.transformB=new b2Transform();this.translationB=new b2Vec2();};/// Output results for b2ShapeCast
      ...
      this.m_id=id;}_createClass(b2TreeNode,[{key:"Reset",value:function Reset(){this._userData=null;}},{key:"IsLeaf",value:function IsLeaf(){return this.child1===null;}},{key:"userData",get:function get(){if(this._userData===null){throw new Error();}return this._userData;},set:function set(value){if(this._userData!==null){throw new Error();}this._userData=value;}}]);return b2TreeNode;}();var b2DynamicTree=/*#__PURE__*/function(){function b2DynamicTree(){_classCallCheck(this,b2DynamicTree);this.m_root=null;// b2TreeNode* public m_nodes;
      ...
      var b2MassData=function b2MassData(){_classCallCheck(this,b2MassData);/// The mass of the shape, usually in kilograms.
      ...
      var b2PolygonShape=/*#__PURE__*/function(_b2Shape2){_inherits(b2PolygonShape,_b2Shape2);function b2PolygonShape(){var _this3;_classCallCheck(this,b2PolygonShape);_this3=_possibleConstructorReturn(this,_getPrototypeOf(b2PolygonShape).call(this,exports.b2ShapeType.e_polygonShape,b2_polygonRadius));_this3.m_centroid=new b2Vec2(0,0);_this3.m_vertices=[];_this3.m_normals=[];_this3.m_count=0;return _this3;}/// Implement b2Shape.
      ...
      var b2FixtureDef=function b2FixtureDef(){_classCallCheck(this,b2FixtureDef);/// Use this to store application specific fixture data.
      ...
      var b2BodyDef=function b2BodyDef(){_classCallCheck(this,b2BodyDef);/// The body type: static, kinematic, or dynamic.
      ...
      this.joint=joint;}_createClass(b2JointEdge,[{key:"Reset",value:function Reset(){this._other=null;this.prev=null;this.next=null;}},{key:"other",get:function get(){if(this._other===null){throw new Error();}return this._other;},set:function set(value){if(this._other!==null){throw new Error();}this._other=value;}}]);return b2JointEdge;}();/// Joint definitions are used to construct joints.
      var b2JointDef=function b2JointDef(type){_classCallCheck(this,b2JointDef);/// The joint type is set automatically for concrete joint types.
      ...
      var b2DistanceJointDef=/*#__PURE__*/function(_b2JointDef){_inherits(b2DistanceJointDef,_b2JointDef);function b2DistanceJointDef(){var _this6;_classCallCheck(this,b2DistanceJointDef);_this6=_possibleConstructorReturn(this,_getPrototypeOf(b2DistanceJointDef).call(this,exports.b2JointType.e_distanceJoint));_this6.localAnchorA=new b2Vec2();_this6.localAnchorB=new b2Vec2();_this6.length=1;_this6.frequencyHz=0;_this6.dampingRatio=0;return _this6;}_createClass(b2DistanceJointDef,[{key:"Initialize",value:function Initialize(b1,b2,anchor1,anchor2){this.bodyA=b1;this.bodyB=b2;this.bodyA.GetLocalPoint(anchor1,this.localAnchorA);this.bodyB.GetLocalPoint(anchor2,this.localAnchorB);this.length=b2Vec2.DistanceVV(anchor1,anchor2);this.frequencyHz=0;this.dampingRatio=0;}}]);return b2DistanceJointDef;}(b2JointDef);var b2DistanceJoint=/*#__PURE__*/function(_b2Joint){_inherits(b2DistanceJoint,_b2Joint);function b2DistanceJoint(def){var _this7;_classCallCheck(this,b2DistanceJoint);_this7=_possibleConstructorReturn(this,_getPrototypeOf(b2DistanceJoint).call(this,def));_this7.m_frequencyHz=0;_this7.m_dampingRatio=0;_this7.m_bias=0;// Solver shared
      ...
      var b2AreaJointDef=/*#__PURE__*/function(_b2JointDef2){_inherits(b2AreaJointDef,_b2JointDef2);function b2AreaJointDef(){var _this8;_classCallCheck(this,b2AreaJointDef);_this8=_possibleConstructorReturn(this,_getPrototypeOf(b2AreaJointDef).call(this,exports.b2JointType.e_areaJoint));_this8.bodies=[];_this8.frequencyHz=0;_this8.dampingRatio=0;return _this8;}_createClass(b2AreaJointDef,[{key:"AddBody",value:function AddBody(body){this.bodies.push(body);if(this.bodies.length===1){this.bodyA=body;}else if(this.bodies.length===2){this.bodyB=body;}}}]);return b2AreaJointDef;}(b2JointDef);var b2AreaJoint=/*#__PURE__*/function(_b2Joint2){_inherits(b2AreaJoint,_b2Joint2);function b2AreaJoint(def){var _this9;_classCallCheck(this,b2AreaJoint);_this9=_possibleConstructorReturn(this,_getPrototypeOf(b2AreaJoint).call(this,def));_this9.m_frequencyHz=0;_this9.m_dampingRatio=0;// Solver shared
      ...
      var b2FrictionJointDef=/*#__PURE__*/function(_b2JointDef3){_inherits(b2FrictionJointDef,_b2JointDef3);function b2FrictionJointDef(){var _this10;_classCallCheck(this,b2FrictionJointDef);_this10=_possibleConstructorReturn(this,_getPrototypeOf(b2FrictionJointDef).call(this,exports.b2JointType.e_frictionJoint));_this10.localAnchorA=new b2Vec2();_this10.localAnchorB=new b2Vec2();_this10.maxForce=0;_this10.maxTorque=0;return _this10;}_createClass(b2FrictionJointDef,[{key:"Initialize",value:function Initialize(bA,bB,anchor){this.bodyA=bA;this.bodyB=bB;this.bodyA.GetLocalPoint(anchor,this.localAnchorA);this.bodyB.GetLocalPoint(anchor,this.localAnchorB);}}]);return b2FrictionJointDef;}(b2JointDef);var b2FrictionJoint=/*#__PURE__*/function(_b2Joint3){_inherits(b2FrictionJoint,_b2Joint3);function b2FrictionJoint(def){var _this11;_classCallCheck(this,b2FrictionJoint);_this11=_possibleConstructorReturn(this,_getPrototypeOf(b2FrictionJoint).call(this,def));_this11.m_localAnchorA=new b2Vec2();_this11.m_localAnchorB=new b2Vec2();// Solver shared
      ...
      var b2GearJointDef=/*#__PURE__*/function(_b2JointDef4){_inherits(b2GearJointDef,_b2JointDef4);function b2GearJointDef(){var _this12;_classCallCheck(this,b2GearJointDef);_this12=_possibleConstructorReturn(this,_getPrototypeOf(b2GearJointDef).call(this,exports.b2JointType.e_gearJoint));_this12.ratio=1;return _this12;}return b2GearJointDef;}(b2JointDef);var b2GearJoint=/*#__PURE__*/function(_b2Joint4){_inherits(b2GearJoint,_b2Joint4);function b2GearJoint(def){var _this13;_classCallCheck(this,b2GearJoint);_this13=_possibleConstructorReturn(this,_getPrototypeOf(b2GearJoint).call(this,def));_this13.m_typeA=exports.b2JointType.e_unknownJoint;_this13.m_typeB=exports.b2JointType.e_unknownJoint;// Solver shared
      ...
      var b2MouseJointDef=/*#__PURE__*/function(_b2JointDef6){_inherits(b2MouseJointDef,_b2JointDef6);function b2MouseJointDef(){var _this16;_classCallCheck(this,b2MouseJointDef);_this16=_possibleConstructorReturn(this,_getPrototypeOf(b2MouseJointDef).call(this,exports.b2JointType.e_mouseJoint));_this16.target=new b2Vec2();_this16.maxForce=0;_this16.frequencyHz=5;_this16.dampingRatio=0.7;return _this16;}return b2MouseJointDef;}(b2JointDef);var b2MouseJoint=/*#__PURE__*/function(_b2Joint6){_inherits(b2MouseJoint,_b2Joint6);function b2MouseJoint(def){var _this17;_classCallCheck(this,b2MouseJoint);_this17=_possibleConstructorReturn(this,_getPrototypeOf(b2MouseJoint).call(this,def));_this17.m_localAnchorB=new b2Vec2();_this17.m_targetA=new b2Vec2();_this17.m_frequencyHz=0;_this17.m_dampingRatio=0;_this17.m_beta=0;// Solver shared
      ...
      var b2RevoluteJointDef=/*#__PURE__*/function(_b2JointDef9){_inherits(b2RevoluteJointDef,_b2JointDef9);function b2RevoluteJointDef(){var _this22;_classCallCheck(this,b2RevoluteJointDef);_this22=_possibleConstructorReturn(this,_getPrototypeOf(b2RevoluteJointDef).call(this,exports.b2JointType.e_revoluteJoint));_this22.localAnchorA=new b2Vec2(0,0);_this22.localAnchorB=new b2Vec2(0,0);_this22.referenceAngle=0;_this22.enableLimit=false;_this22.lowerAngle=0;_this22.upperAngle=0;_this22.enableMotor=false;_this22.motorSpeed=0;_this22.maxMotorTorque=0;return _this22;}_createClass(b2RevoluteJointDef,[{key:"Initialize",value:function Initialize(bA,bB,anchor){this.bodyA=bA;this.bodyB=bB;this.bodyA.GetLocalPoint(anchor,this.localAnchorA);this.bodyB.GetLocalPoint(anchor,this.localAnchorB);this.referenceAngle=this.bodyB.GetAngle()-this.bodyA.GetAngle();}}]);return b2RevoluteJointDef;}(b2JointDef);var b2RevoluteJoint=/*#__PURE__*/function(_b2Joint9){_inherits(b2RevoluteJoint,_b2Joint9);function b2RevoluteJoint(def){var _this23;_classCallCheck(this,b2RevoluteJoint);_this23=_possibleConstructorReturn(this,_getPrototypeOf(b2RevoluteJoint).call(this,def));// Solver shared
      ...
      var b2RopeJointDef=/*#__PURE__*/function(_b2JointDef10){_inherits(b2RopeJointDef,_b2JointDef10);function b2RopeJointDef(){var _this24;_classCallCheck(this,b2RopeJointDef);_this24=_possibleConstructorReturn(this,_getPrototypeOf(b2RopeJointDef).call(this,exports.b2JointType.e_ropeJoint));_this24.localAnchorA=new b2Vec2(-1,0);_this24.localAnchorB=new b2Vec2(1,0);_this24.maxLength=0;return _this24;}return b2RopeJointDef;}(b2JointDef);var b2RopeJoint=/*#__PURE__*/function(_b2Joint10){_inherits(b2RopeJoint,_b2Joint10);function b2RopeJoint(def){var _this25;_classCallCheck(this,b2RopeJoint);_this25=_possibleConstructorReturn(this,_getPrototypeOf(b2RopeJoint).call(this,def));// Solver shared
      ...
      /// when the local anchor points coincide in world space. Using local
      /// anchors and a local axis helps when saving and loading a game.
      var b2WheelJointDef=/*#__PURE__*/function(_b2JointDef12){_inherits(b2WheelJointDef,_b2JointDef12);function b2WheelJointDef(){var _this28;_classCallCheck(this,b2WheelJointDef);_this28=_possibleConstructorReturn(this,_getPrototypeOf(b2WheelJointDef).call(this,exports.b2JointType.e_wheelJoint));_this28.localAnchorA=new b2Vec2(0,0);_this28.localAnchorB=new b2Vec2(0,0);_this28.localAxisA=new b2Vec2(1,0);_this28.enableMotor=false;_this28.maxMotorTorque=0;_this28.motorSpeed=0;_this28.frequencyHz=2;_this28.dampingRatio=0.7;return _this28;}_createClass(b2WheelJointDef,[{key:"Initialize",value:function Initialize(bA,bB,anchor,axis){this.bodyA=bA;this.bodyB=bB;this.bodyA.GetLocalPoint(anchor,this.localAnchorA);this.bodyB.GetLocalPoint(anchor,this.localAnchorB);this.bodyA.GetLocalVector(axis,this.localAxisA);}}]);return b2WheelJointDef;}(b2JointDef);var b2WheelJoint=/*#__PURE__*/function(_b2Joint12){_inherits(b2WheelJoint,_b2Joint12);function b2WheelJoint(def){var _this29;_classCallCheck(this,b2WheelJoint);_this29=_possibleConstructorReturn(this,_getPrototypeOf(b2WheelJoint).call(this,def));_this29.m_frequencyHz=0;_this29.m_dampingRatio=0;// Solver shared
      ...
      this.contact=contact;}_createClass(b2ContactEdge,[{key:"Reset",value:function Reset(){this._other=null;this.prev=null;this.next=null;}},{key:"other",get:function get(){if(this._other===null){throw new Error();}return this._other;},set:function set(value){if(this._other!==null){throw new Error();}this._other=value;}}]);return b2ContactEdge;}();var b2Contact=/*#__PURE__*/function(){function b2Contact(){_classCallCheck(this,b2Contact);this.m_islandFlag=false;/// Used when crawling contact graph when forming islands.
      ...
      for(var i=0;i<this.m_manifold.pointCount;++i){var mp2=this.m_manifold.points[i];mp2.normalImpulse=0;mp2.tangentImpulse=0;var id2=mp2.id;for(var j=0;j<this.m_oldManifold.pointCount;++j){var mp1=this.m_oldManifold.points[j];if(mp1.id.key===id2.key){mp2.normalImpulse=mp1.normalImpulse;mp2.tangentImpulse=mp1.tangentImpulse;break;}}}if(touching!==wasTouching){bodyA.SetAwake(true);bodyB.SetAwake(true);}}this.m_touchingFlag=touching;if(!wasTouching&&touching&&listener){listener.BeginContact(this);}if(wasTouching&&!touching&&listener){listener.EndContact(this);}if(!sensor&&touching&&listener){listener.PreSolve(this,this.m_oldManifold);}}},{key:"ComputeTOI",value:function ComputeTOI(sweepA,sweepB){var input=b2Contact.ComputeTOI_s_input;input.proxyA.SetShape(this.GetShapeA(),this.m_indexA);input.proxyB.SetShape(this.GetShapeB(),this.m_indexB);input.sweepA.Copy(sweepA);input.sweepB.Copy(sweepB);input.tMax=b2_linearSlop;var output=b2Contact.ComputeTOI_s_output;b2TimeOfImpact(output,input);return output.t;}}]);return b2Contact;}();b2Contact.ComputeTOI_s_input=new b2TOIInput();b2Contact.ComputeTOI_s_output=new b2TOIOutput();/*
        ...
        * misrepresented as being the original software.
        * 3. This notice may not be removed or altered from any source distribution.
        */var b2CircleContact=/*#__PURE__*/function(_b2Contact){_inherits(b2CircleContact,_b2Contact);function b2CircleContact(){_classCallCheck(this,b2CircleContact);return _possibleConstructorReturn(this,_getPrototypeOf(b2CircleContact).apply(this,arguments));}_createClass(b2CircleContact,[{key:"Evaluate",value:function Evaluate(manifold,xfA,xfB){b2CollideCircles(manifold,this.GetShapeA(),xfA,this.GetShapeB(),xfB);}}],[{key:"Create",value:function Create(){return new b2CircleContact();}},{key:"Destroy",value:function Destroy(contact){}}]);return b2CircleContact;}(b2Contact);/*
        * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
        *
        * This software is provided 'as-is', without any express or implied
        * warranty.  In no event will the authors be held liable for any damages
        ...
        * misrepresented as being the original software.
        * 3. This notice may not be removed or altered from any source distribution.
        */var b2PolygonAndCircleContact=/*#__PURE__*/function(_b2Contact3){_inherits(b2PolygonAndCircleContact,_b2Contact3);function b2PolygonAndCircleContact(){_classCallCheck(this,b2PolygonAndCircleContact);return _possibleConstructorReturn(this,_getPrototypeOf(b2PolygonAndCircleContact).apply(this,arguments));}_createClass(b2PolygonAndCircleContact,[{key:"Evaluate",value:function Evaluate(manifold,xfA,xfB){b2CollidePolygonAndCircle(manifold,this.GetShapeA(),xfA,this.GetShapeB(),xfB);}}],[{key:"Create",value:function Create(){return new b2PolygonAndCircleContact();}},{key:"Destroy",value:function Destroy(contact){}}]);return b2PolygonAndCircleContact;}(b2Contact);/*
        * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
        *
        * This software is provided 'as-is', without any express or implied
        * warranty.  In no event will the authors be held liable for any damages
        ...
        * misrepresented as being the original software.
        * 3. This notice may not be removed or altered from any source distribution.
        */var b2EdgeAndCircleContact=/*#__PURE__*/function(_b2Contact4){_inherits(b2EdgeAndCircleContact,_b2Contact4);function b2EdgeAndCircleContact(){_classCallCheck(this,b2EdgeAndCircleContact);return _possibleConstructorReturn(this,_getPrototypeOf(b2EdgeAndCircleContact).apply(this,arguments));}_createClass(b2EdgeAndCircleContact,[{key:"Evaluate",value:function Evaluate(manifold,xfA,xfB){b2CollideEdgeAndCircle(manifold,this.GetShapeA(),xfA,this.GetShapeB(),xfB);}}],[{key:"Create",value:function Create(){return new b2EdgeAndCircleContact();}},{key:"Destroy",value:function Destroy(contact){}}]);return b2EdgeAndCircleContact;}(b2Contact);/*
        * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
        *
        * This software is provided 'as-is', without any express or implied
        * warranty.  In no event will the authors be held liable for any damages
      ...
      var b2DestructionListener=/*#__PURE__*/function(){function b2DestructionListener(){_classCallCheck(this,b2DestructionListener);}_createClass(b2DestructionListener,[{key:"SayGoodbyeJoint",/// Called when any joint is about to be destroyed due
      ...
      var b2ContactFilter=/*#__PURE__*/function(){function b2ContactFilter(){_classCallCheck(this,b2ContactFilter);}_createClass(b2ContactFilter,[{key:"ShouldCollide",/// Return true if contact calculations should be performed between these two shapes.
      ...
      var b2ContactImpulse=function b2ContactImpulse(){_classCallCheck(this,b2ContactImpulse);this.normalImpulses=b2MakeNumberArray(b2_maxManifoldPoints);this.tangentImpulses=b2MakeNumberArray(b2_maxManifoldPoints);this.count=0;};/// Implement this class to get contact information. You can use these results for
      ...
      var b2ContactListener=/*#__PURE__*/function(){function b2ContactListener(){_classCallCheck(this,b2ContactListener);}_createClass(b2ContactListener,[{key:"BeginContact",/// Called when two fixtures begin to touch.
      ...
      /// See b2World::Query
      var b2QueryCallback=/*#__PURE__*/function(){function b2QueryCallback(){_classCallCheck(this,b2QueryCallback);}_createClass(b2QueryCallback,[{key:"ReportFixture",/// Called for each fixture found in the query AABB.
      ...
      /// See b2World::RayCast
      var b2RayCastCallback=/*#__PURE__*/function(){function b2RayCastCallback(){_classCallCheck(this,b2RayCastCallback);}_createClass(b2RayCastCallback,[{key:"ReportFixture",/// Called for each fixture found in the query. You control how the ray cast
      ...
      this.warmStarting=step.warmStarting;return this;}}]);return b2TimeStep;}();var b2Position=/*#__PURE__*/function(){function b2Position(){_classCallCheck(this,b2Position);this.c=new b2Vec2();this.a=0;}_createClass(b2Position,null,[{key:"MakeArray",value:function MakeArray(length){return b2MakeArray(length,function(i){return new b2Position();});}}]);return b2Position;}();var b2Velocity=/*#__PURE__*/function(){function b2Velocity(){_classCallCheck(this,b2Velocity);this.v=new b2Vec2();this.w=0;}_createClass(b2Velocity,null,[{key:"MakeArray",value:function MakeArray(length){return b2MakeArray(length,function(i){return new b2Velocity();});}}]);return b2Velocity;}();var b2SolverData=function b2SolverData(){_classCallCheck(this,b2SolverData);this.step=new b2TimeStep();};/*
        * Copyright (c) 2006-2009 Erin Catto http://www.box2d.org
        *
        * This software is provided 'as-is', without any express or implied
        * warranty.  In no event will the authors be held liable for any damages
      ...
      };var b2ParticlePair=function b2ParticlePair(){_classCallCheck(this,b2ParticlePair);this.indexA=0;// Indices of the respective particles making pair.
      ...
      };var b2ParticleTriad=function b2ParticleTriad(){_classCallCheck(this,b2ParticleTriad);this.indexA=0;// Indices of the respective particles making triad.
      ...
      return b2_invalidParticleIndex;}}]);return b2ParticlePairSet;}(b2ParticleSystem_FixedSetAllocator);var b2ParticleSystem_ConnectionFilter=/*#__PURE__*/function(){function b2ParticleSystem_ConnectionFilter(){_classCallCheck(this,b2ParticleSystem_ConnectionFilter);}_createClass(b2ParticleSystem_ConnectionFilter,[{key:"IsNecessary",/**
             ...
             */},{key:"ShouldCreateTriad",value:function ShouldCreateTriad(a,b,c){return true;}}]);return b2ParticleSystem_ConnectionFilter;}();var b2ParticleSystem_DestroyParticlesInShapeCallback=/*#__PURE__*/function(_b2QueryCallback2){_inherits(b2ParticleSystem_DestroyParticlesInShapeCallback,_b2QueryCallback2);function b2ParticleSystem_DestroyParticlesInShapeCallback(system,shape,xf,callDestructionListener){var _this32;_classCallCheck(this,b2ParticleSystem_DestroyParticlesInShapeCallback);_this32=_possibleConstructorReturn(this,_getPrototypeOf(b2ParticleSystem_DestroyParticlesInShapeCallback).call(this));_this32.m_callDestructionListener=false;_this32.m_destroyed=0;_this32.m_system=system;_this32.m_shape=shape;_this32.m_xf=xf;_this32.m_callDestructionListener=callDestructionListener;_this32.m_destroyed=0;return _this32;}_createClass(b2ParticleSystem_DestroyParticlesInShapeCallback,[{key:"ReportFixture",value:function ReportFixture(fixture){return false;}},{key:"ReportParticle",value:function ReportParticle(particleSystem,index){if(particleSystem!==this.m_system){return false;}// DEBUG: b2Assert(index >= 0 && index < this.m_system.m_count);
      if(this.m_shape.TestPoint(this.m_xf,this.m_system.m_positionBuffer.data[index])){this.m_system.DestroyParticle(index,this.m_callDestructionListener);this.m_destroyed++;}return true;}},{key:"Destroyed",value:function Destroyed(){return this.m_destroyed;}}]);return b2ParticleSystem_DestroyParticlesInShapeCallback;}(b2QueryCallback);var b2ParticleSystem_JoinParticleGroupsFilter=/*#__PURE__*/function(_b2ParticleSystem_Con){_inherits(b2ParticleSystem_JoinParticleGroupsFilter,_b2ParticleSystem_Con);function b2ParticleSystem_JoinParticleGroupsFilter(threshold){var _this33;_classCallCheck(this,b2ParticleSystem_JoinParticleGroupsFilter);_this33=_possibleConstructorReturn(this,_getPrototypeOf(b2ParticleSystem_JoinParticleGroupsFilter).call(this));_this33.m_threshold=0;_this33.m_threshold=threshold;return _this33;}/**
             * An additional condition for creating a pair.
             ...
             * An additional condition for creating a triad.
             */},{key:"ShouldCreateTriad",value:function ShouldCreateTriad(a,b,c){return (a<this.m_threshold||b<this.m_threshold||c<this.m_threshold)&&(this.m_threshold<=a||this.m_threshold<=b||this.m_threshold<=c);}}]);return b2ParticleSystem_JoinParticleGroupsFilter;}(b2ParticleSystem_ConnectionFilter);var b2ParticleSystem_CompositeShape=/*#__PURE__*/function(_b2Shape5){_inherits(b2ParticleSystem_CompositeShape,_b2Shape5);function b2ParticleSystem_CompositeShape(shapes){var _this34;var shapeCount=arguments.length>1&&arguments[1]!==undefined?arguments[1]:shapes.length;_classCallCheck(this,b2ParticleSystem_CompositeShape);_this34=_possibleConstructorReturn(this,_getPrototypeOf(b2ParticleSystem_CompositeShape).call(this,exports.b2ShapeType.e_unknown,0));_this34.m_shapeCount=0;_this34.m_shapes=shapes;_this34.m_shapeCount=shapeCount;return _this34;}_createClass(b2ParticleSystem_CompositeShape,[{key:"Clone",value:function Clone(){// DEBUG: b2Assert(false);
      ...
      }}]);return b2ParticleSystem_CompositeShape;}(b2Shape);var b2ParticleSystem_ReactiveFilter=/*#__PURE__*/function(_b2ParticleSystem_Con2){_inherits(b2ParticleSystem_ReactiveFilter,_b2ParticleSystem_Con2);function b2ParticleSystem_ReactiveFilter(flagsBuffer){var _this35;_classCallCheck(this,b2ParticleSystem_ReactiveFilter);_this35=_possibleConstructorReturn(this,_getPrototypeOf(b2ParticleSystem_ReactiveFilter).call(this));_this35.m_flagsBuffer=flagsBuffer;return _this35;}_createClass(b2ParticleSystem_ReactiveFilter,[{key:"IsNecessary",value:function IsNecessary(index){return (this.m_flagsBuffer.data[index]&exports.b2ParticleFlag.b2_reactiveParticle)!==0;}}]);return b2ParticleSystem_ReactiveFilter;}(b2ParticleSystem_ConnectionFilter);var b2ParticleSystem_UpdateBodyContactsCallback=/*#__PURE__*/function(_b2FixtureParticleQue){_inherits(b2ParticleSystem_UpdateBodyContactsCallback,_b2FixtureParticleQue);function b2ParticleSystem_UpdateBodyContactsCallback(system){var _this36;var contactFilter=arguments.length>1&&arguments[1]!==undefined?arguments[1]:null;_classCallCheck(this,b2ParticleSystem_UpdateBodyContactsCallback);_this36=_possibleConstructorReturn(this,_getPrototypeOf(b2ParticleSystem_UpdateBodyContactsCallback).call(this,system));// base class constructor
      ...
      b2World.DrawDebugData_s_color=new b2Color(0,0,0);b2World.DrawDebugData_s_vs=b2Vec2.MakeArray(4);b2World.DrawDebugData_s_xf=new b2Transform();b2World.QueryFixtureShape_s_aabb=new b2AABB();b2World.RayCast_s_input=new b2RayCastInput();b2World.RayCast_s_output=new b2RayCastOutput();b2World.RayCast_s_point=new b2Vec2();b2World.DrawJoint_s_p1=new b2Vec2();b2World.DrawJoint_s_p2=new b2Vec2();b2World.DrawJoint_s_color=new b2Color(0.5,0.8,0.8);b2World.DrawJoint_s_c=new b2Color();b2World.DrawShape_s_ghostColor=new b2Color();b2World.SolveTOI_s_subStep=new b2TimeStep();b2World.SolveTOI_s_backup=new b2Sweep();b2World.SolveTOI_s_backup1=new b2Sweep();b2World.SolveTOI_s_backup2=new b2Sweep();b2World.SolveTOI_s_toi_input=new b2TOIInput();b2World.SolveTOI_s_toi_output=new b2TOIOutput();/*
         ...
         */var b2ControllerEdge=function b2ControllerEdge(controller,body){_classCallCheck(this,b2ControllerEdge);this.prevBody=null;///< the previous controller edge in the controllers's joint list
      ...
      /*
         ...
         * plane.
         */var b2BuoyancyController=/*#__PURE__*/function(_b2Controller){_inherits(b2BuoyancyController,_b2Controller);function b2BuoyancyController(){var _this38;_classCallCheck(this,b2BuoyancyController);_this38=_possibleConstructorReturn(this,_getPrototypeOf(b2BuoyancyController).apply(this,arguments));/**
      ...
      /*
         ...
         */ /**
         * Applies a force every frame
         */var b2ConstantForceController=/*#__PURE__*/function(_b2Controller3){_inherits(b2ConstantForceController,_b2Controller3);function b2ConstantForceController(){var _this40;_classCallCheck(this,b2ConstantForceController);_this40=_possibleConstructorReturn(this,_getPrototypeOf(b2ConstantForceController).apply(this,arguments));/**
                 * The force to apply
      ...
      /*
         ...
         */var b2GravityController=/*#__PURE__*/function(_b2Controller4){_inherits(b2GravityController,_b2Controller4);function b2GravityController(){var _this41;_classCallCheck(this,b2GravityController);_this41=_possibleConstructorReturn(this,_getPrototypeOf(b2GravityController).apply(this,arguments));/**
      ...
      /*
         ...
         */var b2TensorDampingController=/*#__PURE__*/function(_b2Controller5){_inherits(b2TensorDampingController,_b2Controller5);function b2TensorDampingController(){var _this42;_classCallCheck(this,b2TensorDampingController);_this42=_possibleConstructorReturn(this,_getPrototypeOf(b2TensorDampingController).apply(this,arguments));/// Tensor to use in damping model
      ...
      /*
        ...
        * 3. This notice may not be removed or altered from any source distribution.
        */ ///
      var b2RopeDef=function b2RopeDef(){_classCallCheck(this,b2RopeDef);///
      this.vertices=[];///
      this.count=0;///
      this.masses=[];///
