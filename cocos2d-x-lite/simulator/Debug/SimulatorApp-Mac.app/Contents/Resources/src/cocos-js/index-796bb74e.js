System.register(['./coordinates-converts-utils-66b3c6fc.js', './index-5105ded5.js', './json-asset-a4190905.js', './factory-b4ae7354.js', './sprite-frame-b5395794.js', './sprite-a03197dc.js', './renderable-2d-03c177c4.js', './graphics-25d2f02c.js', './vertex-format-2d59049f.js', './deprecated-90f4d66c.js', './deprecated-7610334f.js'], function (exports) {
    'use strict';
    var Vec3, Mat4, Color, Rect, Size, Vec2, addon, mixin, legacyCC, _createForOfIteratorHelperLoose, logID, errorID, _createClass, RecyclePool, CachedArray, Pool, SubModelPool, SubModelView, sys, UBOLocal, BufferInfo, BufferUsageBit, MemoryUsageBit, DSPool, ModelLocalBindings, DescriptorSetInfo, warnID, assetManager, Material, downloader, factory, dynamicAtlasManager, SpriteFrame, shareLabelInfo, Overflow$1, isUnicodeSpace, isUnicodeCJK, HorizontalTextAlignment, VerticalTextAlignment, LetterAtlas, computeHash, Label, safeMeasureText, fragmentText, BASELINE_RATIO, getBaselineOffset, BitmapFont, Sprite, TTFFont, StencilManager, Stage, LineJoin, LineCap, Point, PointFlags, Graphics, vfmtPosUvColor, getAttributeStride, LabelOutline, LabelShadow, Mask, MaskType, MeshBuffer, DrawBatch2D;
    return {
