System.register(['./coordinates-converts-utils-fa8f5fc5.js', './index-b656ef93.js', './renderable-component-7d3cd284.js', './find-c704a59e.js', './json-asset-17eaf8ce.js', './texture-buffer-pool-36a70aeb.js', './transform-utils-c1853224.js', './view-d66ebab1.js', './event-enum-cb046afa.js', './screen-0172c27e.js', './camera-component-4e2374cc.js', './factory-7b08f108.js', './index-cf8faf74.js', './create-mesh-4e3ca30e.js', './mesh-dc73eca6.js', './mesh-renderer-46fd0b14.js', './skeleton-a4f2c933.js'], function (exports) {
    'use strict';
    var ccclass, type, tooltip, executeInEditMode, _inheritsLoose, _createClass, _initializerDefineProperty, _assertThisInitialized, Vec4, PrimitiveMode, Color, Attribute, AttributeName, Format, legacyCC, Component, _applyDecoratedDescriptor, help, menu, toDegree, toRadian, serializable, Vec3, _createForOfIteratorHelperLoose, FormatInfos, BufferInfo, BufferUsageBit, MemoryUsageBit, IndirectBuffer, DrawInfo, DRAW_INFO_SIZE, Enum, lerp, EDITOR, editable, repeat, displayOrder, Vec2, pseudoRandom, Mat4, Quat, random, randomRange, randomRangeInt, sign, range, radian, formerlySerializedAs, pingPong, clamp, RecyclePool, Feature, Pool, displayName, visible, INT_MAX, executionOrder, instantiate, removeProperty, js, director, Director, Model, ModelType, MaterialInstance, RenderableComponent, Node, AnimationCurve, Texture2D, Material, builtinResMgr, RenderingSubMesh, ImageAsset, PixelFormat, Filter, WrapMode, Pass, override, createMesh, Mesh;
    return {
        setters: [function (module) {
            ...
            range = module.f4;
            radian = module.fE;
            formerlySerializedAs = module.fu;
            pingPong = module.d1;
            clamp = module.cQ;
        ...
        execute: function () {
            ...
            var Billboard = function (v) { return exports({ Billboard: v, BillboardComponent: v }), v; }((_dec = ccclass('cc.Billboard'), _dec2 = help('i18n:cc.Billboard'), _dec3 = menu('Effects/Billboard'), _dec4 = type(Texture2D), _dec5 = type(Texture2D), _dec6 = tooltip('billboard显示的贴图'), _dec7 = tooltip('billboard的高度'), _dec8 = tooltip('billboard的宽度'), _dec9 = tooltip('billboard绕中心点旋转的角度'), _dec(_class = _dec2(_class = _dec3(_class = executeInEditMode(_class = (_class2 = (_temp = function (_Component) {
            ...
            var Gradient = (_dec3$2 = ccclass('cc.Gradient'), _dec3$2(_class7 = (_class8 = (_temp3 = _class9 = function () {
              function Gradient() {
            ...
            var Line = function (v) { return exports({ Line: v, LineComponent: v }), v; }((_dec$4 = ccclass('cc.Line'), _dec2$4 = help('i18n:cc.Line'), _dec3$4 = menu('Effects/Line'), _dec4$3 = type(Texture2D), _dec5$3 = type(Texture2D), _dec6$2 = displayOrder(0), _dec7$1 = tooltip('线段中显示的贴图'), _dec8$1 = displayOrder(1), _dec9$1 = tooltip('线段中各个点的坐标采用哪个坐标系，勾选使用世界坐标系，不选使用本地坐标系'), _dec10 = type([Vec3]), _dec11 = type([Vec3]), _dec12 = displayOrder(2), _dec13 = tooltip('每个线段端点的坐标'), _dec14 = type(CurveRange), _dec15 = type(CurveRange), _dec16 = displayOrder(3), _dec17 = tooltip('线段宽度，如果采用曲线，则表示沿着线段方向上的曲线变化'), _dec18 = type(Vec2), _dec19 = displayOrder(4), _dec20 = tooltip('贴图平铺次数'), _dec21 = type(Vec2), _dec22 = displayOrder(5), _dec23 = tooltip('贴图坐标的偏移'), _dec24 = type(GradientRange), _dec25 = type(GradientRange), _dec26 = displayOrder(6), _dec27 = tooltip('线段颜色，如果采用渐变色，则表示沿着线段方向上的颜色渐变'), _dec$4(_class$4 = _dec2$4(_class$4 = _dec3$4(_class$4 = executeInEditMode(_class$4 = (_class2$4 = (_temp$4 = function (_Component) {
            ...
            var ForceOvertimeModule = (_dec$6 = ccclass('cc.ForceOvertimeModule'), _dec2$6 = displayOrder(0), _dec3$6 = type(CurveRange), _dec4$5 = range([-1, 1]), _dec5$4 = displayOrder(2), _dec6$3 = tooltip('X 轴方向上的加速度分量'), _dec7$2 = type(CurveRange), _dec8$2 = range([-1, 1]), _dec9$2 = displayOrder(3), _dec10$1 = tooltip('Y 轴方向上的加速度分量'), _dec11$1 = type(CurveRange), _dec12$1 = range([-1, 1]), _dec13$1 = displayOrder(4), _dec14$1 = tooltip('Z 轴方向上的加速度分量'), _dec15$1 = type(Space), _dec16$1 = displayOrder(1), _dec17$1 = tooltip('加速度计算时采用的坐标'), _dec$6(_class$6 = (_class2$6 = (_temp$6 = function (_ParticleModuleBase) {
            ...
            var LimitVelocityOvertimeModule = (_dec$7 = ccclass('cc.LimitVelocityOvertimeModule'), _dec2$7 = displayOrder(0), _dec3$7 = type(CurveRange), _dec4$6 = range([-1, 1]), _dec5$5 = displayOrder(4), _dec6$4 = tooltip('X 轴方向上的速度下限'), _dec7$3 = type(CurveRange), _dec8$3 = range([-1, 1]), _dec9$3 = displayOrder(5), _dec10$2 = tooltip('Y 轴方向上的速度下限'), _dec11$2 = type(CurveRange), _dec12$2 = range([-1, 1]), _dec13$2 = displayOrder(6), _dec14$2 = tooltip('Z 轴方向上的速度下限'), _dec15$2 = type(CurveRange), _dec16$2 = range([-1, 1]), _dec17$2 = displayOrder(3), _dec18$1 = tooltip('速度下限'), _dec19$1 = displayOrder(7), _dec20$1 = tooltip('当前速度与速度下限的插值'), _dec21$1 = displayOrder(2), _dec22$1 = tooltip('是否三个轴分开限制'), _dec23$1 = type(Space), _dec24$1 = displayOrder(1), _dec25$1 = tooltip('计算速度下限时采用的坐标系'), _dec$7(_class$7 = (_class2$7 = (_temp$7 = function (_ParticleModuleBase) {
            ...
            var RotationOvertimeModule = (_dec$8 = ccclass('cc.RotationOvertimeModule'), _dec2$8 = displayOrder(0), _dec3$8 = displayOrder(1), _dec4$7 = tooltip('是否三个轴分开设定旋转（暂不支持）'), _dec5$6 = type(CurveRange), _dec6$5 = range([-1, 1]), _dec7$4 = displayOrder(2), _dec8$4 = tooltip('绕 X 轴设定旋转'), _dec9$4 = type(CurveRange), _dec10$3 = range([-1, 1]), _dec11$3 = displayOrder(3), _dec12$3 = tooltip('绕 Y 轴设定旋转'), _dec13$3 = type(CurveRange), _dec14$3 = range([-1, 1]), _dec15$3 = displayOrder(4), _dec16$3 = tooltip('绕 Z 轴设定旋转'), _dec$8(_class$8 = (_class2$8 = (_temp$8 = function (_ParticleModuleBase) {
            ...
            var SizeOvertimeModule = (_dec$9 = ccclass('cc.SizeOvertimeModule'), _dec2$9 = displayOrder(0), _dec3$9 = displayOrder(1), _dec4$8 = tooltip('决定是否在每个轴上独立控制粒子大小'), _dec5$7 = type(CurveRange), _dec6$6 = displayOrder(2), _dec7$5 = tooltip('定义一条曲线来决定粒子在其生命周期中的大小变化'), _dec8$5 = type(CurveRange), _dec9$5 = displayOrder(3), _dec10$4 = tooltip('定义一条曲线来决定粒子在其生命周期中 X 轴方向上的大小变化'), _dec11$4 = type(CurveRange), _dec12$4 = displayOrder(4), _dec13$4 = tooltip('定义一条曲线来决定粒子在其生命周期中 Y 轴方向上的大小变化'), _dec14$4 = type(CurveRange), _dec15$4 = displayOrder(5), _dec16$4 = tooltip('定义一条曲线来决定粒子在其生命周期中 Z 轴方向上的大小变化'), _dec$9(_class$9 = (_class2$9 = (_temp$9 = function (_ParticleModuleBase) {
            ...
            var TextureAnimationModule = (_dec$a = ccclass('cc.TextureAnimationModule'), _dec2$a = formerlySerializedAs('numTilesX'), _dec3$a = formerlySerializedAs('numTilesY'), _dec4$9 = displayOrder(0), _dec5$8 = type(Mode$3), _dec6$7 = type(Mode$3), _dec7$6 = displayOrder(1), _dec8$6 = tooltip('设定粒子贴图动画的类型（暂只支持 Grid 模式）'), _dec9$6 = displayOrder(2), _dec10$5 = tooltip('X 方向动画帧数'), _dec11$5 = displayOrder(3), _dec12$5 = tooltip('Y 方向动画帧数'), _dec13$5 = type(Animation), _dec14$5 = displayOrder(4), _dec15$5 = tooltip('动画播放方式'), _dec16$5 = type(CurveRange), _dec17$3 = displayOrder(7), _dec18$2 = tooltip('一个周期内动画播放的帧与时间变化曲线'), _dec19$2 = type(CurveRange), _dec20$2 = displayOrder(8), _dec21$2 = tooltip('从第几帧开始播放，时间为整个粒子系统的生命周期'), _dec22$2 = displayOrder(9), _dec23$2 = tooltip('一个生命周期内播放循环的次数'), _dec24$2 = displayOrder(5), _dec25$2 = tooltip('随机从动画贴图中选择一行以生成动画。\n此选项仅在动画播放方式为 SingleRow 时生效'), _dec26$1 = displayOrder(6), _dec27$1 = tooltip('从动画贴图中选择特定行以生成动画。\n此选项仅在动画播放方式为 SingleRow 时且禁用 randomRow 时可用'), _dec$a(_class$a = (_class2$a = (_temp$a = function (_ParticleModuleBase) {
            ...
            var VelocityOvertimeModule = (_dec$b = ccclass('cc.VelocityOvertimeModule'), _dec2$b = displayOrder(0), _dec3$b = type(CurveRange), _dec4$a = range([-1, 1]), _dec5$9 = displayOrder(2), _dec6$8 = tooltip('X 轴方向上的速度分量'), _dec7$7 = type(CurveRange), _dec8$7 = range([-1, 1]), _dec9$7 = displayOrder(3), _dec10$6 = tooltip('Y 轴方向上的速度分量'), _dec11$6 = type(CurveRange), _dec12$6 = range([-1, 1]), _dec13$6 = displayOrder(4), _dec14$6 = tooltip('Z 轴方向上的速度分量'), _dec15$6 = type(CurveRange), _dec16$6 = range([-1, 1]), _dec17$4 = displayOrder(5), _dec18$3 = tooltip('速度修正系数（只支持 CPU 粒子）'), _dec19$3 = type(Space), _dec20$3 = displayOrder(1), _dec21$3 = tooltip('速度计算时采用的坐标系'), _dec$b(_class$b = (_class2$b = (_temp$b = function (_ParticleModuleBase) {
            ...
            var Burst = (_dec$c = ccclass('cc.Burst'), _dec2$c = type(CurveRange), _dec$c(_class$c = (_class2$c = (_temp$c = function () {
              _createClass(Burst, [{
                key: "time",
                get: function get() {
                  return this._time;
            ...
            var ShapeModule = (_dec$d = ccclass('cc.ShapeModule'), _dec2$d = displayOrder(13), _dec3$c = tooltip('粒子发射器位置'), _dec4$b = displayOrder(14), _dec5$a = tooltip('粒子发射器旋转角度'), _dec6$9 = displayOrder(15), _dec7$8 = tooltip('粒子发射器缩放比例'), _dec8$8 = displayOrder(6), _dec9$8 = tooltip('粒子发射器在一个扇形范围内发射'), _dec10$7 = displayOrder(5), _dec11$7 = tooltip('圆锥的轴与母线的夹角\n决定圆锥发射器的开合程度'), _dec12$7 = displayOrder(0), _dec13$7 = type(ShapeType), _dec14$7 = formerlySerializedAs('shapeType'), _dec15$7 = displayOrder(1), _dec16$7 = type(ShapeType), _dec17$5 = tooltip('粒子发射器类型'), _dec18$4 = type(EmitLocation), _dec19$4 = displayOrder(2), _dec20$4 = tooltip('粒子从发射器哪个部位发射'), _dec21$4 = displayOrder(16), _dec22$3 = tooltip('根据粒子的初始方向决定粒子的移动方向'), _dec23$3 = displayOrder(17), _dec24$3 = tooltip('粒子生成方向随机设定'), _dec25$3 = displayOrder(18), _dec26$2 = tooltip('表示当前发射方向与当前位置到结点中心连线方向的插值'), _dec27$2 = displayOrder(19), _dec28 = tooltip('粒子生成位置随机设定（设定此值为非 0 会使粒子生成位置超出生成器大小范围）'), _dec29 = displayOrder(3), _dec30 = tooltip('粒子发射器半径'), _dec31 = displayOrder(4), _dec32 = tooltip('粒子发射器发射位置（对 Box 类型的发射器无效）:\n - 0 表示从表面发射；\n - 1 表示从中心发射；\n - 0 ~ 1 之间表示在中心到表面之间发射。'), _dec33 = type(ArcMode), _dec34 = displayOrder(7), _dec35 = tooltip('粒子在扇形范围内的发射方式'), _dec36 = displayOrder(9), _dec37 = tooltip('控制可能产生粒子的弧周围的离散间隔'), _dec38 = type(CurveRange), _dec39 = displayOrder(10), _dec40 = tooltip('粒子沿圆周发射的速度'), _dec41 = displayOrder(11), _dec42 = tooltip('圆锥顶部截面距离底部的轴长\n决定圆锥发射器的高度'), _dec43 = displayOrder(12), _dec44 = tooltip('粒子发射器发射位置（针对 Box 类型的粒子发射器）'), _dec$d(_class$d = (_class2$d = (_temp$d = function () {
            ...
            var ParticleSystemRenderer = (_dec$e = ccclass('cc.ParticleSystemRenderer'), _dec2$e = type(RenderMode), _dec3$d = displayOrder(0), _dec4$c = tooltip('设定粒子生成模式'), _dec5$b = displayOrder(1), _dec6$a = tooltip('在粒子生成方式为 StrecthedBillboard 时,对粒子在运动方向上按速度大小进行拉伸'), _dec7$9 = displayOrder(2), _dec8$9 = tooltip('在粒子生成方式为 StrecthedBillboard 时,对粒子在运动方向上按粒子大小进行拉伸'), _dec9$9 = type(RenderMode), _dec10$8 = type(Mesh), _dec11$8 = displayOrder(7), _dec12$8 = tooltip('粒子发射的模型'), _dec13$8 = type(Material), _dec14$8 = displayOrder(8), _dec15$8 = tooltip('粒子使用的材质'), _dec16$8 = type(Material), _dec17$6 = displayOrder(9), _dec18$5 = tooltip('拖尾使用的材质'), _dec19$5 = displayOrder(10), _dec20$5 = tooltip('是否启用GPU粒子'), _dec$e(_class$e = (_class2$e = (_temp$e = function () {
            ...
            var TrailModule = (_dec$f = ccclass('cc.TrailModule'), _dec2$f = displayOrder(0), _dec3$e = type(TrailMode), _dec4$d = displayOrder(1), _dec5$c = tooltip('Particle在每个粒子的运动轨迹上形成拖尾效果'), _dec6$b = type(CurveRange), _dec7$a = displayOrder(3), _dec8$a = tooltip('拖尾的生命周期'), _dec9$a = displayOrder(5), _dec10$9 = tooltip('粒子每生成一个拖尾节点所运行的最短距离'), _dec11$9 = type(Space), _dec12$9 = displayOrder(6), _dec13$9 = tooltip('拖尾所在的坐标系，World在世界坐标系中运行，Local在本地坐标系中运行'), _dec14$9 = type(TextureMode), _dec15$9 = displayOrder(8), _dec16$9 = tooltip('贴图在拖尾上的展开形式，Stretch贴图覆盖在整条拖尾上，Repeat贴图覆盖在一段拖尾上'), _dec17$7 = displayOrder(9), _dec18$6 = tooltip('拖尾宽度继承自粒子大小'), _dec19$6 = type(CurveRange), _dec20$6 = displayOrder(10), _dec21$5 = tooltip('拖尾宽度，如果继承自粒子则是粒子大小的比例'), _dec22$4 = displayOrder(11), _dec23$4 = tooltip('拖尾颜色是否继承自粒子'), _dec24$4 = type(GradientRange), _dec25$4 = displayOrder(12), _dec26$3 = tooltip('拖尾颜色随拖尾自身长度的颜色渐变'), _dec27$3 = type(GradientRange), _dec28$1 = displayOrder(13), _dec29$1 = tooltip('拖尾颜色随时间的颜色渐变'), _dec30$1 = type(Space), _dec$f(_class$f = (_class2$f = (_temp$f = function () {
            ...
            var ParticleSystem = function (v) { return exports({ ParticleSystem: v, ParticleSystemComponent: v }), v; }((_dec$g = ccclass('cc.ParticleSystem'), _dec2$g = help('i18n:cc.ParticleSystem'), _dec3$f = menu('Effects/ParticleSystem'), _dec4$e = executionOrder(99), _dec5$d = displayOrder(1), _dec6$c = tooltip('粒子系统能生成的最大粒子数量'), _dec7$b = type(GradientRange), _dec8$b = displayOrder(8), _dec9$b = tooltip('粒子初始颜色'), _dec10$a = type(Space), _dec11$a = displayOrder(9), _dec12$a = tooltip('选择缩放坐标系'), _dec13$a = displayOrder(10), _dec14$a = tooltip('粒子初始大小'), _dec15$a = formerlySerializedAs('startSize'), _dec16$a = type(CurveRange), _dec17$8 = displayOrder(10), _dec18$7 = tooltip('粒子初始大小'), _dec19$7 = type(CurveRange), _dec20$7 = displayOrder(10), _dec21$6 = tooltip('粒子初始大小'), _dec22$5 = type(CurveRange), _dec23$5 = displayOrder(10), _dec24$5 = tooltip('粒子初始大小'), _dec25$5 = type(CurveRange), _dec26$4 = range([-1, 1]), _dec27$4 = displayOrder(11), _dec28$2 = tooltip('粒子初始速度'), _dec29$2 = displayOrder(12), _dec30$2 = tooltip('粒子初始旋转角度'), _dec31$1 = type(CurveRange), _dec32$1 = range([-1, 1]), _dec33$1 = displayOrder(12), _dec34$1 = tooltip('粒子初始旋转角度'), _dec35$1 = type(CurveRange), _dec36$1 = range([-1, 1]), _dec37$1 = displayOrder(12), _dec38$1 = tooltip('粒子初始旋转角度'), _dec39$1 = type(CurveRange), _dec40$1 = formerlySerializedAs('startRotation'), _dec41$1 = range([-1, 1]), _dec42$1 = displayOrder(12), _dec43$1 = tooltip('粒子初始旋转角度'), _dec44$1 = type(CurveRange), _dec45 = displayOrder(6), _dec46 = tooltip('粒子系统开始运行后，延迟粒子发射的时间'), _dec47 = type(CurveRange), _dec48 = displayOrder(7), _dec49 = tooltip('粒子生命周期'), _dec50 = displayOrder(0), _dec51 = tooltip('粒子系统运行时间'), _dec52 = displayOrder(2), _dec53 = tooltip('粒子系统是否循环播放'), _dec54 = displayOrder(3), _dec55 = tooltip('选中之后，粒子系统会以已播放完一轮之后的状态开始播放（仅当循环播放启用时有效）'), _dec56 = type(Space), _dec57 = displayOrder(4), _dec58 = tooltip('控制粒子坐标计算所在的坐标系'), _dec59 = displayOrder(5), _dec60 = tooltip('控制整个粒子系统的更新速度'), _dec61 = displayOrder(2), _dec62 = tooltip('粒子系统加载后是否自动开始播放'), _dec63 = type(CurveRange), _dec64 = range([-1, 1]), _dec65 = displayOrder(13), _dec66 = tooltip('粒子受重力影响的重力系数'), _dec67 = type(CurveRange), _dec68 = displayOrder(14), _dec69 = tooltip('每秒发射的粒子数'), _dec70 = type(CurveRange), _dec71 = displayOrder(15), _dec72 = tooltip('每移动单位距离发射的粒子数'), _dec73 = type([Burst]), _dec74 = displayOrder(16), _dec75 = tooltip('在某个时间点发射给定数量的粒子'), _dec76 = type(Material), _dec77 = displayName('Materials'), _dec78 = visible(false), _dec79 = type(ColorOvertimeModule), _dec80 = type(ColorOvertimeModule), _dec81 = displayOrder(23), _dec82 = tooltip('颜色模块'), _dec83 = type(ShapeModule), _dec84 = type(ShapeModule), _dec85 = displayOrder(17), _dec86 = tooltip('发射器模块'), _dec87 = type(SizeOvertimeModule), _dec88 = type(SizeOvertimeModule), _dec89 = displayOrder(21), _dec90 = tooltip('大小模块'), _dec91 = type(VelocityOvertimeModule), _dec92 = type(VelocityOvertimeModule), _dec93 = displayOrder(18), _dec94 = tooltip('速度模块'), _dec95 = type(ForceOvertimeModule), _dec96 = type(ForceOvertimeModule), _dec97 = displayOrder(19), _dec98 = tooltip('加速度模块'), _dec99 = type(LimitVelocityOvertimeModule), _dec100 = type(LimitVelocityOvertimeModule), _dec101 = displayOrder(20), _dec102 = tooltip('限速模块'), _dec103 = type(RotationOvertimeModule), _dec104 = type(RotationOvertimeModule), _dec105 = displayOrder(22), _dec106 = tooltip('旋转模块'), _dec107 = type(TextureAnimationModule), _dec108 = type(TextureAnimationModule), _dec109 = displayOrder(24), _dec110 = tooltip('贴图动画模块'), _dec111 = type(TrailModule), _dec112 = type(TrailModule), _dec113 = displayOrder(25), _dec114 = tooltip('拖尾模块'), _dec115 = type(ParticleSystemRenderer), _dec116 = displayOrder(26), _dec117 = tooltip('渲染模块'), _dec118 = displayOrder(27), _dec119 = tooltip('是否剔除非 enable 的模块数据'), _dec$g(_class$g = _dec2$g(_class$g = _dec3$f(_class$g = _dec4$e(_class$g = executeInEditMode(_class$g = (_class2$g = (_temp$g = function (_RenderableComponent) {
