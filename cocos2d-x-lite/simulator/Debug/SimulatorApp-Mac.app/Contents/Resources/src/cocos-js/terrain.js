System.register(['./coordinates-converts-utils-fa8f5fc5.js', './index-b656ef93.js', './renderable-component-7d3cd284.js', './find-c704a59e.js', './json-asset-17eaf8ce.js', './texture-buffer-pool-36a70aeb.js', './transform-utils-c1853224.js', './view-d66ebab1.js', './event-enum-cb046afa.js', './screen-0172c27e.js', './camera-component-4e2374cc.js', './factory-7b08f108.js', './terrain-asset-2a0aabc0.js'], function (exports) {
    'use strict';
    var clamp, Vec3, ccclass, _createClass, _applyDecoratedDescriptor, _inheritsLoose, legacyCC, Vec2, BufferInfo, BufferUsageBit, MemoryUsageBit, Attribute, AttributeName, Format, PrimitiveMode, Vec4, Rect, type, visible, CCBoolean, executeInEditMode, disallowMultiple, isValid, editable, _initializerDefineProperty, Size, serializable, help, _assertThisInitialized, Component, disallowAnimation, director, RenderableComponent, Model, Material, builtinResMgr, RenderingSubMesh, Texture2D, PixelFormat, Filter, WrapMode, EffectAsset, PrivateNode, TERRAIN_BLOCK_VERTEX_COMPLEXITY, TERRAIN_BLOCK_TILE_COMPLEXITY, TERRAIN_BLOCK_VERTEX_SIZE, TerrainAsset, TERRAIN_HEIGHT_FMAX, TERRAIN_HEIGHT_FMIN, TERRAIN_HEIGHT_BASE, TERRAIN_HEIGHT_FACTORY, TERRAIN_MAX_BLEND_LAYERS, TERRAIN_MAX_LAYER_COUNT, TerrainLayerInfo;
    return {
        setters: [function (module) {
            ...
            TERRAIN_HEIGHT_FMAX = module.d;
            TERRAIN_HEIGHT_FMIN = module.e;
            TERRAIN_HEIGHT_BASE = module.f;
            TERRAIN_HEIGHT_FACTORY = module.g;
            TERRAIN_MAX_BLEND_LAYERS = module.h;
            TERRAIN_MAX_LAYER_COUNT = module.i;
            TerrainLayerInfo = module.j;
            var _setter = {};
            ...
            _setter.TERRAIN_DATA_VERSION4 = module.s;
            _setter.TERRAIN_DATA_VERSION_DEFAULT = module.t;
            _setter.TERRAIN_EAST_INDEX = module.o;
            _setter.TERRAIN_HEIGHT_BASE = module.f;
            _setter.TERRAIN_HEIGHT_FACTORY = module.g;
            _setter.TERRAIN_HEIGHT_FMAX = module.d;
            _setter.TERRAIN_HEIGHT_FMIN = module.e;
            _setter.TERRAIN_MAX_BLEND_LAYERS = module.h;
            _setter.TERRAIN_MAX_LAYER_COUNT = module.i;
            _setter.TERRAIN_MAX_LEVELS = module.k;
            ...
            _setter.TerrainLayerInfo = module.j;
            exports(_setter);
        }],
        execute: function () {
              ...
              _proto3._buildImp = function _buildImp(restore) {
                ...
                if (!restore && terrainAsset !== null) {
                  ...
                  var _loop = function _loop(_i7) {
                    var layerInfo = terrainAsset.layerInfos[_i7];
                    var layer = new TerrainLayer();
                    layer.tileSize = layerInfo.tileSize;
                    legacyCC.assetManager.loadAny(layerInfo.detailMap, function (err, asset) {
                      layer.detailMap = asset;
                    });

                    if (layerInfo.normalMap !== '') {
                      legacyCC.assetManager.loadAny(layerInfo.normalMap, function (err, asset) {
                  ...
                  for (var _i7 = 0; _i7 < terrainAsset.layerInfos.length; ++_i7) {
                    _loop(_i7);
                  }
                }
                ...
                if (this._heights === null || this._heights.length !== vertexCount) {
                  ...
                  for (var _i8 = 0; _i8 < vertexCount; ++_i8) {
                    this._heights[_i8] = TERRAIN_HEIGHT_BASE;
                    this._normals[_i8 * 3 + 0] = 0;
                    this._normals[_i8 * 3 + 1] = 1;
                    this._normals[_i8 * 3 + 2] = 0;
                  }
                } else {
                  this._normals = new Array(vertexCount * 3);
                ...
                if (this._layerBuffer === null || this._layerBuffer.length !== layerBufferSize) {
                  ...
                  for (var _i9 = 0; _i9 < layerBufferSize; ++_i9) {
                    this._layerBuffer[_i9] = -1;
                  }
                }
