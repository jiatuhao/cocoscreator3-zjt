System.register(['./coordinates-converts-utils-fa8f5fc5.js', './index-b656ef93.js', './renderable-component-7d3cd284.js', './find-c704a59e.js', './json-asset-17eaf8ce.js', './transform-utils-c1853224.js', './view-d66ebab1.js', './event-enum-cb046afa.js', './screen-0172c27e.js', './camera-component-4e2374cc.js', './factory-7b08f108.js', './sprite-frame-0db90c47.js', './sprite-fcdd808f.js', './renderable-2d-4a5bf6ad.js', './deprecated-677319c2.js'], function (exports) {
  'use strict';
  var Color, ccenum, ccclass, type, displayOrder, tooltip, rangeMin, rangeMax, executeInEditMode, _inheritsLoose, lerp, Vec3, _createClass, _applyDecoratedDescriptor, help, executionOrder, menu, requireComponent, _initializerDefineProperty, _assertThisInitialized, Component, serializable, Enum, Mat4, legacyCC, contains, sys, macro, MINIGAME, JSB, RUNTIME_BASED, visible, Size, warn, range, Vec2, clamp01, slide, Event, _createForOfIteratorHelperLoose, logID, errorID, editable, editorOnly, warnID, array, js, EventHandler, director, Director, Node, TransformBit, override, ImageAsset, view, game, visibleRect, View, SystemEventType, EventTouch, screen, Scene, Camera, PrivateNode, SpriteFrame, Sprite, BitmapFont, Label, VerticalTextAlignment, Renderable2D, UITransform;
  return {
    ...
    execute: function () {
      ...
      var Button = function (v) { return exports({ Button: v, ButtonComponent: v }), v; }((_dec = ccclass('cc.Button'), _dec2 = help('i18n:cc.Button'), _dec3 = executionOrder(110), _dec4 = menu('UI/Button'), _dec5 = requireComponent(UITransform), _dec6 = type(Node), _dec7 = displayOrder(0), _dec8 = tooltip('指定 Button 背景节点，Button 状态改变时会修改此节点的 Color 或 Sprite 属性'), _dec9 = displayOrder(1), _dec10 = tooltip('按钮是否可交互，这一项未选中时，按钮处在禁用状态'), _dec11 = type(Transition), _dec12 = displayOrder(2), _dec13 = tooltip('按钮状态变化时的过渡类型'), _dec14 = tooltip('普通状态的按钮背景颜色'), _dec15 = tooltip('按下状态的按钮背景颜色'), _dec16 = tooltip('悬停状态的按钮背景颜色'), _dec17 = tooltip('禁用状态的按钮背景颜色'), _dec18 = rangeMin(0), _dec19 = rangeMax(10), _dec20 = tooltip('按钮颜色变化或者缩放变化的过渡时间'), _dec21 = tooltip('当用户点击按钮后，按钮会缩放到一个值，这个值等于 Button 原始 scale * zoomScale。'), _dec22 = type(SpriteFrame), _dec23 = tooltip('普通状态的按钮背景图资源'), _dec24 = type(SpriteFrame), _dec25 = tooltip('按下状态的按钮背景图资源'), _dec26 = type(SpriteFrame), _dec27 = tooltip('悬停状态的按钮背景图资源'), _dec28 = type(SpriteFrame), _dec29 = tooltip('禁用状态的按钮背景图资源'), _dec30 = type([EventHandler]), _dec31 = displayOrder(20), _dec32 = tooltip('按钮点击事件的列表。先将数量改为1或更多，就可以为每个点击事件设置接受者和处理方法'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = executeInEditMode(_class = (_class2 = (_temp = _class3 = function (_Component) {
      ...
      var EditBox = function (v) { return exports({ EditBox: v, EditBoxComponent: v }), v; }((_dec$1 = ccclass('cc.EditBox'), _dec2$1 = help('i18n:cc.EditBox'), _dec3$1 = executionOrder(100), _dec4$1 = menu('UI/EditBox'), _dec5$1 = requireComponent(UITransform), _dec6$1 = displayOrder(1), _dec7$1 = tooltip('输入框的初始输入内容，如果为空则会显示占位符的文本'), _dec8$1 = displayOrder(2), _dec9$1 = tooltip('输入框占位符的文本内容'), _dec10$1 = type(Label), _dec11$1 = displayOrder(3), _dec12$1 = tooltip('输入框输入文本节点上挂载的 Label 组件对象'), _dec13$1 = type(Label), _dec14$1 = displayOrder(4), _dec15$1 = tooltip('输入框占位符节点上挂载的 Label 组件对象'), _dec16$1 = type(SpriteFrame), _dec17$1 = displayOrder(5), _dec18$1 = tooltip('输入框的背景图片'), _dec19$1 = type(InputFlag), _dec20$1 = displayOrder(6), _dec21$1 = tooltip('指定输入标志位，可以指定输入方式为密码或者单词首字母大写'), _dec22$1 = type(InputMode), _dec23$1 = displayOrder(7), _dec24$1 = tooltip('指定输入模式: ANY 表示多行输入，其它都是单行输入，移动平台上还可以指定键盘样式'), _dec25$1 = type(KeyboardReturnType), _dec26$1 = displayOrder(8), _dec27$1 = tooltip('指定移动设备上面回车按钮的样式'), _dec28$1 = displayOrder(9), _dec29$1 = tooltip('输入框最大允许输入的字符个数'), _dec30$1 = displayOrder(10), _dec31$1 = tooltip('修改 DOM 输入元素的 tabIndex（这个属性只有在 Web 上面修改有意义）'), _dec32$1 = type([EventHandler]), _dec33 = displayOrder(11), _dec34 = tooltip('该事件在用户点击输入框获取焦点的时候被触发'), _dec35 = type([EventHandler]), _dec36 = displayOrder(12), _dec37 = tooltip('编辑文本输入框时触发的事件回调'), _dec38 = type([EventHandler]), _dec39 = displayOrder(13), _dec40 = tooltip('在单行模式下面，一般是在用户按下回车或者点击屏幕输入框以外的地方调用该函数。 如果是多行输入，一般是在用户点击屏幕输入框以外的地方调用该函数'), _dec41 = type([EventHandler]), _dec42 = displayOrder(14), _dec43 = tooltip('该事件在用户按下回车键的时候被触发, 如果是单行输入框，按回车键还会使输入框失去焦点'), _dec$1(_class$1 = _dec2$1(_class$1 = _dec3$1(_class$1 = _dec4$1(_class$1 = _dec5$1(_class$1 = executeInEditMode(_class$1 = (_class2$1 = (_temp$1 = _class3$1 = function (_Component) {
      ...
      }), _dec7$2 = tooltip('自动对齐。在 Type 为 Horizontal 或 Vertical 时按同个方向位置排列'), _dec8$2 = visible(function () {
        return this._layoutType === Type.VERTICAL;
      }), _dec9$2 = tooltip('自动对齐。在 Type 为 Vertical 时按同个方向位置排列'), _dec10$2 = type(Type), _dec11$2 = tooltip('自动布局模式，包括：\n 1. NONE，不会对子节点进行自动布局 \n 2. HORIZONTAL，横向自动排布子物体 \n 3. VERTICAL，垂直自动排布子物体\n 4. GRID, 采用网格方式对子物体自动进行布局'), _dec12$2 = type(ResizeMode), _dec13$2 = visible(function () {
        return this._layoutType !== Type.NONE;
      }), _dec14$2 = tooltip('缩放模式，包括：\n 1. NONE，不会对子节点和容器进行大小缩放 \n 2. CONTAINER, 对容器的大小进行缩放 \n 3. CHILDREN, 对子节点的大小进行缩放'), _dec15$2 = visible(function () {
        if (this.type === Type.GRID && this._resizeMode === ResizeMode.CHILDREN) {
          return true;
        }

        return false;
      }), _dec16$2 = tooltip('每个格子的大小，只有布局类型为 GRID 的时候才有效'), _dec17$2 = type(AxisDirection), _dec18$2 = tooltip('起始轴方向类型，可进行水平和垂直布局排列，只有布局类型为 GRID 的时候才有效'), _dec19$2 = tooltip('容器内左边距，只会在一个布局方向上生效'), _dec20$2 = tooltip('容器内右边距，只会在一个布局方向上生效'), _dec21$2 = tooltip('容器内上边距，只会在一个布局方向上生效'), _dec22$2 = tooltip('容器内下边距，只会在一个布局方向上生效'), _dec23$2 = tooltip('子节点之间的水平间距'), _dec24$2 = tooltip('子节点之间的垂直间距'), _dec25$2 = type(VerticalDirection), _dec26$2 = tooltip('垂直排列子节点的方向'), _dec27$2 = type(HorizontalDirection), _dec28$2 = tooltip('水平排列子节点的方向'), _dec29$2 = type(Constraint), _dec30$2 = visible(function () {
        return this.type === Type.GRID;
      }), _dec31$2 = tooltip('容器内布局约束'), _dec32$2 = visible(function () {
        return this._constraint !== Constraint.NONE;
      }), _dec33$1 = tooltip('容器内布局约束数值'), _dec34$1 = tooltip('子节点缩放比例是否影响布局'), _dec$2(_class$2 = _dec2$2(_class$2 = _dec3$2(_class$2 = _dec4$2(_class$2 = _dec5$2(_class$2 = executeInEditMode(_class$2 = (_class2$2 = (_temp$2 = _class3$2 = function (_Component) {
      ...
      Enum(Mode);
      var ProgressBar = function (v) { return exports({ ProgressBar: v, ProgressBarComponent: v }), v; }((_dec$3 = ccclass('cc.ProgressBar'), _dec2$3 = help('i18n:cc.ProgressBar'), _dec3$3 = executionOrder(110), _dec4$3 = menu('UI/ProgressBar'), _dec5$3 = requireComponent(UITransform), _dec6$3 = type(Sprite), _dec7$3 = tooltip('进度条显示用的 Sprite 节点，可以动态改变尺寸'), _dec8$3 = type(Mode), _dec9$3 = tooltip('进度条显示模式，目前支持水平和垂直两种'), _dec10$3 = tooltip('进度条在 progress 为 1 时的最大长度'), _dec11$3 = range([0, 1, 0.1]), _dec12$3 = tooltip('当前进度指示，范围从 0 到 1'), _dec13$3 = tooltip('是否反向驱动进度条'), _dec$3(_class$3 = _dec2$3(_class$3 = _dec3$3(_class$3 = _dec4$3(_class$3 = _dec5$3(_class$3 = (_class2$3 = (_temp$3 = _class3$3 = function (_Component) {
      ...
      ccenum(Direction);
      var ScrollBar = function (v) { return exports({ ScrollBar: v, ScrollBarComponent: v }), v; }((_dec$4 = ccclass('cc.ScrollBar'), _dec2$4 = help('i18n:cc.ScrollBar'), _dec3$4 = executionOrder(110), _dec4$4 = menu('UI/ScrollBar'), _dec5$4 = requireComponent(UITransform), _dec6$4 = type(Sprite), _dec7$4 = displayOrder(0), _dec8$4 = tooltip('作为当前滚动区域位置显示的滑块 Sprite'), _dec9$4 = type(Direction), _dec10$4 = displayOrder(1), _dec11$4 = tooltip('ScrollBar 的滚动方向'), _dec12$4 = displayOrder(2), _dec13$4 = tooltip('是否在没有滚动动作时自动隐藏 ScrollBar'), _dec14$3 = displayOrder(3), _dec15$3 = tooltip('没有滚动动作后经过多久会自动隐藏。\n注意：只要当 “enableAutoHide” 为 true 时，才有效。'), _dec$4(_class$4 = _dec2$4(_class$4 = _dec3$4(_class$4 = _dec4$4(_class$4 = _dec5$4(_class$4 = (_class2$4 = (_temp$4 = _class3$4 = function (_Component) {
      ...
      var ScrollView = function (v) { return exports({ ScrollView: v, ScrollViewComponent: v }), v; }((_dec$6 = ccclass('cc.ScrollView'), _dec2$6 = help('i18n:cc.ScrollView'), _dec3$5 = executionOrder(110), _dec4$5 = menu('UI/ScrollView'), _dec5$5 = requireComponent(UITransform), _dec6$5 = range([0, 10]), _dec7$5 = displayOrder(0), _dec8$5 = tooltip('回弹持续的时间，0 表示将立即反弹'), _dec9$5 = range([0, 1, 0.1]), _dec10$5 = displayOrder(1), _dec11$5 = tooltip('开启惯性后，在用户停止触摸后滚动多快停止，0 表示永不停止，1 表示立刻停止'), _dec12$5 = displayOrder(2), _dec13$5 = tooltip('是否允许滚动内容超过边界，并在停止触摸后回弹'), _dec14$4 = displayOrder(3), _dec15$4 = tooltip('是否开启滚动惯性'), _dec16$3 = type(Node), _dec17$3 = displayOrder(4), _dec18$3 = tooltip('可滚动展示内容的节点'), _dec19$3 = displayOrder(5), _dec20$3 = tooltip('是否开启水平滚动'), _dec21$3 = type(ScrollBar), _dec22$3 = displayOrder(6), _dec23$3 = tooltip('水平滚动的 ScrollBar'), _dec24$3 = displayOrder(7), _dec25$3 = tooltip('是否开启垂直滚动'), _dec26$3 = type(ScrollBar), _dec27$3 = displayOrder(8), _dec28$3 = tooltip('垂直滚动的 ScrollBar'), _dec29$3 = displayOrder(9), _dec30$3 = tooltip('滚动行为是否会取消子节点上注册的触摸事件'), _dec31$3 = type([EventHandler]), _dec32$3 = displayOrder(10), _dec33$2 = tooltip('滚动视图的事件回调函数'), _dec$6(_class$6 = _dec2$6(_class$6 = _dec3$5(_class$6 = _dec4$5(_class$6 = _dec5$5(_class$6 = (_class2$5 = (_temp$5 = _class3$5 = function (_ViewGroup) {
        ...
        _proto._moveContent = function _moveContent(deltaMove, canStartBounceBack) {
          ...
          _tempVec3$1.set(Math.floor(_tempVec3$1.x * TOLERANCE) * EPSILON, Math.floor(_tempVec3$1.y * TOLERANCE) * EPSILON, _tempVec3$1.z);
        ...
        _proto._processInertiaScroll = function _processInertiaScroll() {
          ...
          if (!bounceBackStarted && this.inertia) {
            ...
            if (!touchMoveVelocity.equals(_tempVec3$1, EPSILON) && this.brake < 1) {
      ...
      ccenum(Direction$1);
      var Slider = function (v) { return exports({ Slider: v, SliderComponent: v }), v; }((_dec$7 = ccclass('cc.Slider'), _dec2$7 = help('i18n:cc.Slider'), _dec3$6 = executionOrder(110), _dec4$6 = menu('UI/Slider'), _dec5$6 = requireComponent(UITransform), _dec6$6 = type(Sprite), _dec7$6 = tooltip('滑块按钮部件'), _dec8$6 = type(Direction$1), _dec9$6 = tooltip('滑动方向'), _dec10$6 = range([0, 1, 0.01]), _dec11$6 = tooltip('当前进度值，该数值的区间是 0 - 1 之间。'), _dec12$6 = type([EventHandler]), _dec13$6 = tooltip('滑动器组件事件回调函数'), _dec$7(_class$7 = _dec2$7(_class$7 = _dec3$6(_class$7 = _dec4$6(_class$7 = _dec5$6(_class$7 = (_class2$6 = (_temp$6 = _class3$6 = function (_Component) {
      ...
      var ToggleContainer = function (v) { return exports({ ToggleContainer: v, ToggleContainerComponent: v }), v; }((_dec$9 = ccclass('cc.ToggleContainer'), _dec2$9 = help('i18n:cc.ToggleContainer'), _dec3$8 = executionOrder(110), _dec4$8 = menu('UI/ToggleContainer'), _dec5$8 = tooltip('如果这个设置为 true， 那么 toggle 按钮在被点击的时候可以反复地被选中和未选中。'), _dec6$8 = type([EventHandler]), _dec7$8 = tooltip('选中事件。列表类型，默认为空，用户添加的每一个事件由节点引用，组件名称和一个响应函数组成。'), _dec$9(_class$9 = _dec2$9(_class$9 = _dec3$8(_class$9 = _dec4$8(_class$9 = executeInEditMode(_class$9 = (_class2$8 = (_temp$8 = function (_Component) {
      ...
      var Widget = function (v) { return exports({ Widget: v, WidgetComponent: v }), v; }((_dec$a = ccclass('cc.Widget'), _dec2$a = help('i18n:cc.Widget'), _dec3$9 = executionOrder(110), _dec4$9 = menu('UI/Widget'), _dec5$9 = requireComponent(UITransform), _dec6$9 = type(Node), _dec7$9 = tooltip('对齐目标'), _dec8$8 = tooltip('是否对齐上边'), _dec9$8 = tooltip('是否对齐下边'), _dec10$8 = tooltip('是否对齐左边'), _dec11$8 = tooltip('是否对齐右边'), _dec12$8 = tooltip('是否垂直方向对齐中点，开启此项会将垂直方向其他对齐选项取消'), _dec13$7 = tooltip('是否水平方向对齐中点，开启此选项会将水平方向其他对齐选项取消'), _dec14$5 = visible(false), _dec15$5 = visible(false), _dec16$4 = type(AlignMode), _dec17$4 = tooltip('指定 widget 的对齐方式，用于决定运行时 widget 应何时更新'), _dec$a(_class$a = _dec2$a(_class$a = _dec3$9(_class$a = _dec4$9(_class$a = _dec5$9(_class$a = executeInEditMode(_class$a = (_class2$9 = (_temp$9 = _class3$8 = function (_Component) {
        ...
        return Widget;
      }(Component), _class3$8.AlignMode = AlignMode, _temp$9), (_applyDecoratedDescriptor(_class2$9.prototype, "target", [_dec6$9, _dec7$9], Object.getOwnPropertyDescriptor(_class2$9.prototype, "target"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "isAlignTop", [_dec8$8], Object.getOwnPropertyDescriptor(_class2$9.prototype, "isAlignTop"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "isAlignBottom", [_dec9$8], Object.getOwnPropertyDescriptor(_class2$9.prototype, "isAlignBottom"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "isAlignLeft", [_dec10$8], Object.getOwnPropertyDescriptor(_class2$9.prototype, "isAlignLeft"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "isAlignRight", [_dec11$8], Object.getOwnPropertyDescriptor(_class2$9.prototype, "isAlignRight"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "isAlignVerticalCenter", [_dec12$8], Object.getOwnPropertyDescriptor(_class2$9.prototype, "isAlignVerticalCenter"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "isAlignHorizontalCenter", [_dec13$7], Object.getOwnPropertyDescriptor(_class2$9.prototype, "isAlignHorizontalCenter"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "isStretchWidth", [_dec14$5], Object.getOwnPropertyDescriptor(_class2$9.prototype, "isStretchWidth"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "isStretchHeight", [_dec15$5], Object.getOwnPropertyDescriptor(_class2$9.prototype, "isStretchHeight"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "editorTop", [editable], Object.getOwnPropertyDescriptor(_class2$9.prototype, "editorTop"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "editorBottom", [editable], Object.getOwnPropertyDescriptor(_class2$9.prototype, "editorBottom"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "editorLeft", [editable], Object.getOwnPropertyDescriptor(_class2$9.prototype, "editorLeft"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "editorRight", [editable], Object.getOwnPropertyDescriptor(_class2$9.prototype, "editorRight"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "editorHorizontalCenter", [editable], Object.getOwnPropertyDescriptor(_class2$9.prototype, "editorHorizontalCenter"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "editorVerticalCenter", [editable], Object.getOwnPropertyDescriptor(_class2$9.prototype, "editorVerticalCenter"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "isAbsoluteTop", [editable], Object.getOwnPropertyDescriptor(_class2$9.prototype, "isAbsoluteTop"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "isAbsoluteBottom", [editable], Object.getOwnPropertyDescriptor(_class2$9.prototype, "isAbsoluteBottom"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "isAbsoluteLeft", [editable], Object.getOwnPropertyDescriptor(_class2$9.prototype, "isAbsoluteLeft"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "isAbsoluteRight", [editable], Object.getOwnPropertyDescriptor(_class2$9.prototype, "isAbsoluteRight"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "isAbsoluteHorizontalCenter", [editable], Object.getOwnPropertyDescriptor(_class2$9.prototype, "isAbsoluteHorizontalCenter"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "isAbsoluteVerticalCenter", [editable], Object.getOwnPropertyDescriptor(_class2$9.prototype, "isAbsoluteVerticalCenter"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "alignMode", [_dec16$4, _dec17$4], Object.getOwnPropertyDescriptor(_class2$9.prototype, "alignMode"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "alignFlags", [editable], Object.getOwnPropertyDescriptor(_class2$9.prototype, "alignFlags"), _class2$9.prototype), _descriptor$9 = _applyDecoratedDescriptor(_class2$9.prototype, "_alignFlags", [serializable], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      var _dec$c, _dec2$c, _dec3$b, _dec4$b, _dec5$b, _dec6$b, _dec7$b, _dec8$a, _dec9$a, _dec10$a, _dec11$a, _dec12$9, _dec13$8, _dec14$6, _dec15$6, _dec16$5, _dec17$5, _dec18$4, _dec19$4, _dec20$4, _dec21$4, _dec22$4, _dec23$4, _dec24$4, _dec25$4, _dec26$4, _class$c, _class2$b, _descriptor$b, _descriptor2$b, _descriptor3$a, _descriptor4$9, _descriptor5$7, _descriptor6$5, _descriptor7$5, _descriptor8$5, _descriptor9$5, _descriptor10$5, _descriptor11$5, _descriptor12$4, _class3$a, _temp$b;
      ...
      var PageView = function (v) { return exports({ PageView: v, PageViewComponent: v }), v; }((_dec$c = ccclass('cc.PageView'), _dec2$c = help('i18n:cc.PageView'), _dec3$b = executionOrder(110), _dec4$b = menu('UI/PageView'), _dec5$b = type(SizeMode), _dec6$b = tooltip('页面视图中每个页面大小类型'), _dec7$b = type(Direction$3), _dec8$a = tooltip('页面视图滚动类型'), _dec9$a = range([0, 1, 0.01]), _dec10$a = tooltip('滚动临界值，默认单位百分比，当拖拽超出该数值时，松开会自动滚动下一页，小于时则还原'), _dec11$a = range([0, 1, 0.01]), _dec12$9 = tooltip('设置 PageView PageTurning 事件的发送时机'), _dec13$8 = type(PageViewIndicator), _dec14$6 = tooltip('页面视图指示器组件'), _dec15$6 = tooltip('快速滑动翻页临界值\n当用户快速滑动时，会根据滑动开始和结束的距离与时间计算出一个速度值\n该值与此临界值相比较，如果大于临界值，则进行自动翻页'), _dec16$5 = type(ScrollBar), _dec17$5 = visible(false), _dec18$4 = type(ScrollBar), _dec19$4 = visible(false), _dec20$4 = visible(false), _dec21$4 = visible(false), _dec22$4 = visible(false), _dec23$4 = type([EventHandler]), _dec24$4 = visible(false), _dec25$4 = type([EventHandler]), _dec26$4 = tooltip('滚动视图的事件回调函数'), _dec$c(_class$c = _dec2$c(_class$c = _dec3$b(_class$c = _dec4$b(_class$c = (_class2$b = (_temp$b = _class3$a = function (_ScrollView) {
      ...
      }), _applyDecoratedDescriptor(_class2$b.prototype, "verticalScrollBar", [_dec16$5, override, _dec17$5], Object.getOwnPropertyDescriptor(_class2$b.prototype, "verticalScrollBar"), _class2$b.prototype), _applyDecoratedDescriptor(_class2$b.prototype, "horizontalScrollBar", [_dec18$4, override, _dec19$4], Object.getOwnPropertyDescriptor(_class2$b.prototype, "horizontalScrollBar"), _class2$b.prototype), _descriptor2$b = _applyDecoratedDescriptor(_class2$b.prototype, "horizontal", [override, serializable, _dec20$4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3$a = _applyDecoratedDescriptor(_class2$b.prototype, "vertical", [override, serializable, _dec21$4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor4$9 = _applyDecoratedDescriptor(_class2$b.prototype, "cancelInnerEvents", [override, serializable, _dec22$4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor5$7 = _applyDecoratedDescriptor(_class2$b.prototype, "scrollEvents", [_dec23$4, serializable, override, _dec24$4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      var UICoordinateTracker = function (v) { return exports({ UICoordinateTracker: v, UICoordinateTrackerComponent: v }), v; }((_dec$e = ccclass('cc.UICoordinateTracker'), _dec2$e = help('i18n:cc.UICoordinateTracker'), _dec3$d = menu('UI/UICoordinateTracker'), _dec4$d = executionOrder(110), _dec5$d = type(Node), _dec6$c = tooltip('目标对象'), _dec7$c = type(Camera), _dec8$b = tooltip('照射相机'), _dec9$b = tooltip('是否是缩放映射'), _dec10$b = tooltip('距相机多少距离为正常显示计算大小'), _dec11$b = type([EventHandler]), _dec12$a = tooltip('映射数据事件。回调的第一个参数是映射后的本地坐标，第二个是距相机距离比'), _dec$e(_class$e = _dec2$e(_class$e = _dec3$d(_class$e = _dec4$d(_class$e = (_class2$c = (_temp$c = function (_Component) {
      ...
      var SubContextView = exports('SubContextView', (_dec$g = ccclass('cc.SubContextView'), _dec2$g = help('i18n:cc.SubContextView'), _dec3$f = executionOrder(110), _dec4$e = requireComponent(UITransform), _dec5$e = menu('Miscellaneous/SubContextView'), _dec6$d = tooltip('子域的设计分辨率，禁止在运行时动态更新'), _dec7$d = tooltip('主域更新子域贴图的频率'), _dec$g(_class$g = _dec2$g(_class$g = _dec3$f(_class$g = _dec4$e(_class$g = _dec5$e(_class$g = (_class2$d = (_temp$d = function (_Component) {
