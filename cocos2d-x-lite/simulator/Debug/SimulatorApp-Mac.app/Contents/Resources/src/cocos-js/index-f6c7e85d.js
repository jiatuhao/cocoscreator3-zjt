System.register(['./coordinates-converts-utils-66b3c6fc.js', './index-5105ded5.js', './renderable-component-48f15197.js', './find-2b085df6.js', './view-fe42d2a1.js', './camera-component-7b3db7ad.js', './mesh-5848e13d.js', './skeleton-dcbd785b.js', './collision-matrix-3d213b56.js', './terrain-asset-583c3d9a.js'], function (exports) {
    'use strict';
    var legacyCC, warn, errorID, ccclass, _inheritsLoose, _createClass, _initializerDefineProperty, _assertThisInitialized, Asset, _applyDecoratedDescriptor, editable, equals, serializable, Vec3, RecyclePool, Enum, type, displayOrder, tooltip, visible, executeInEditMode, disallowMultiple, help, menu, executionOrder, error, Component, displayName, Eventify, readOnly, absMax, requireComponent, formerlySerializedAs, director, Director, System, AABB, Sphere, game, Mesh, EColliderType, EConstraintType, PhysicsGroup, CollisionMatrix, ERigidBodyType, EAxisDirection, ESimplexType, TerrainAsset;
    return {
        ...
        execute: function () {
            ...
            var RigidBody = exports('R', (_dec$1 = ccclass('cc.RigidBody'), _dec2 = help('i18n:cc.RigidBody'), _dec3 = menu('Physics/RigidBody'), _dec4 = executionOrder(-1), _dec5 = type(PhysicsSystem.PhysicsGroup), _dec6 = displayOrder(-2), _dec7 = tooltip('设置分组'), _dec8 = type(ERigidBodyType), _dec9 = displayOrder(-1), _dec10 = tooltip('刚体的类型'), _dec11 = visible(function () {
              ...
              return this.isDynamic;
            }), _dec30 = displayOrder(7), _dec31 = tooltip('旋转速度的因子，可以用来控制每个轴方向上的旋转速度的缩放'), _dec$1(_class$1 = _dec2(_class$1 = _dec3(_class$1 = executeInEditMode(_class$1 = disallowMultiple(_class$1 = _dec4(_class$1 = (_class2$1 = (_temp$1 = _class3$1 = function (_Component) {
            ...
            var Collider = exports('C', (_dec$2 = ccclass('cc.Collider'), _dec2$1 = type(RigidBody), _dec3$1 = displayName('Attached'), _dec4$1 = displayOrder(-2), _dec5$1 = type(PhysicsMaterial), _dec6$1 = displayName('Material'), _dec7$1 = displayOrder(-1), _dec8$1 = tooltip('源材质'), _dec9$1 = displayOrder(0), _dec10$1 = tooltip('是否为触发器，触发器不会产生物理反馈'), _dec11$1 = type(Vec3), _dec12$1 = displayOrder(1), _dec13$1 = tooltip('形状的中心点（与所在 Node 中心点的相对位置）'), _dec14$1 = type(PhysicsMaterial), _dec$2(_class$2 = (_class2$2 = (_temp$2 = _class3$2 = function (_Eventify) {
            ...
            var BoxCollider = exports('B', (_dec$3 = ccclass('cc.BoxCollider'), _dec2$2 = help('i18n:cc.BoxCollider'), _dec3$2 = menu('Physics/BoxCollider'), _dec4$2 = type(Vec3), _dec5$2 = tooltip('盒的大小，即长、宽、高'), _dec$3(_class$3 = _dec2$2(_class$3 = _dec3$2(_class$3 = executeInEditMode(_class$3 = (_class2$3 = (_temp$3 = function (_Collider) {
            ...
            var SphereCollider = exports('S', (_dec$4 = ccclass('cc.SphereCollider'), _dec2$3 = help('i18n:cc.SphereCollider'), _dec3$3 = menu('Physics/SphereCollider'), _dec4$3 = tooltip('球的半径'), _dec$4(_class$4 = _dec2$3(_class$4 = _dec3$3(_class$4 = executeInEditMode(_class$4 = (_class2$4 = (_temp$4 = function (_Collider) {
            ...
            var CapsuleCollider = exports('b', (_dec$5 = ccclass('cc.CapsuleCollider'), _dec2$4 = help('i18n:cc.CapsuleCollider'), _dec3$4 = menu('Physics/CapsuleCollider'), _dec4$4 = tooltip('本地坐标系下胶囊体上的球的半径'), _dec5$3 = tooltip('本地坐标系下胶囊体上的圆柱体的高度'), _dec6$2 = type(EAxisDirection), _dec7$2 = tooltip('本地坐标系下胶囊体的朝向'), _dec$5(_class$5 = _dec2$4(_class$5 = _dec3$4(_class$5 = executeInEditMode(_class$5 = (_class2$5 = (_temp$5 = function (_Collider) {
            ...
            var CylinderCollider = exports('c', (_dec$6 = ccclass('cc.CylinderCollider'), _dec2$5 = help('i18n:cc.CylinderCollider'), _dec3$5 = menu('Physics/CylinderCollider'), _dec4$5 = tooltip('圆柱体上圆面的半径'), _dec5$4 = tooltip('圆柱体在相应轴向的高度'), _dec6$3 = type(EAxisDirection), _dec$6(_class$6 = _dec2$5(_class$6 = _dec3$5(_class$6 = executeInEditMode(_class$6 = (_class2$6 = (_temp$6 = function (_Collider) {
            ...
            var ConeCollider = exports('g', (_dec$7 = ccclass('cc.ConeCollider'), _dec2$6 = help('i18n:cc.ConeCollider'), _dec3$6 = menu('Physics/ConeCollider(beta)'), _dec4$6 = tooltip('圆锥体上圆面的半径'), _dec5$5 = tooltip('圆锥体在相应轴向的高度'), _dec6$4 = type(EAxisDirection), _dec$7(_class$7 = _dec2$6(_class$7 = _dec3$6(_class$7 = executeInEditMode(_class$7 = (_class2$7 = (_temp$7 = function (_Collider) {
            ...
            var MeshCollider = exports('M', (_dec$8 = ccclass('cc.MeshCollider'), _dec2$7 = help('i18n:cc.MeshCollider'), _dec3$7 = menu('Physics/MeshCollider'), _dec4$7 = type(Mesh), _dec$8(_class$8 = _dec2$7(_class$8 = _dec3$7(_class$8 = executeInEditMode(_class$8 = (_class2$8 = (_temp$8 = function (_Collider) {
            ...
            var ConstantForce = exports('e', (_dec$9 = ccclass('cc.ConstantForce'), _dec2$8 = help('i18n:cc.ConstantForce'), _dec3$8 = requireComponent(RigidBody), _dec4$8 = menu('Physics/ConstantForce'), _dec5$6 = displayOrder(0), _dec6$5 = tooltip('世界坐标系下的力'), _dec7$3 = displayOrder(1), _dec8$2 = tooltip('本地坐标系下的力'), _dec9$2 = displayOrder(2), _dec10$2 = tooltip('世界坐标系下的扭转力'), _dec11$2 = displayOrder(3), _dec12$2 = tooltip('本地坐标系下的扭转力'), _dec$9(_class$9 = _dec2$8(_class$9 = _dec3$8(_class$9 = _dec4$8(_class$9 = disallowMultiple(_class$9 = executeInEditMode(_class$9 = (_class2$9 = (_temp$9 = function (_Component) {
            ...
            var TerrainCollider = exports('T', (_dec$a = ccclass('cc.TerrainCollider'), _dec2$9 = help('i18n:cc.TerrainCollider'), _dec3$9 = menu('Physics/TerrainCollider(beta)'), _dec4$9 = type(TerrainAsset), _dec$a(_class$a = _dec2$9(_class$a = _dec3$9(_class$a = executeInEditMode(_class$a = (_class2$a = (_temp$a = function (_Collider) {
            ...
            var SimplexCollider = exports('h', (_dec$b = ccclass('cc.SimplexCollider'), _dec2$a = help('i18n:cc.SimplexCollider'), _dec3$a = menu('Physics/SimplexCollider'), _dec4$a = type(ESimplexType), _dec5$7 = visible(function () {
              return this._shapeType > 1;
            }), _dec6$6 = visible(function () {
              return this._shapeType > 2;
            }), _dec7$4 = visible(function () {
              return this._shapeType > 3;
            }), _dec$b(_class$b = _dec2$a(_class$b = _dec3$a(_class$b = executeInEditMode(_class$b = (_class2$b = (_temp$b = _class3$3 = function (_Collider) {
            ...
            var PlaneCollider = exports('i', (_dec$c = ccclass('cc.PlaneCollider'), _dec2$b = help('i18n:cc.PlaneCollider'), _dec3$b = menu('Physics/PlaneCollider(beta)'), _dec4$b = type(Vec3), _dec5$8 = tooltip('平面的法线'), _dec$c(_class$c = _dec2$b(_class$c = _dec3$b(_class$c = executeInEditMode(_class$c = (_class2$c = (_temp$c = function (_Collider) {
            ...
            var Constraint = exports('a', (_dec$d = ccclass('cc.Constraint'), _dec2$c = requireComponent(RigidBody), _dec3$c = type(RigidBody), _dec4$c = displayOrder(-2), _dec5$9 = type(RigidBody), _dec6$7 = displayOrder(-1), _dec7$5 = displayOrder(0), _dec8$3 = type(RigidBody), _dec$d(_class$d = _dec2$c(_class$d = (_class2$d = (_temp$d = _class3$4 = function (_Eventify) {
              ...
              return Constraint;
            }(Eventify(Component)), _class3$4.Type = EConstraintType, _temp$d), (_applyDecoratedDescriptor(_class2$d.prototype, "attachedBody", [_dec3$c, readOnly, _dec4$c], Object.getOwnPropertyDescriptor(_class2$d.prototype, "attachedBody"), _class2$d.prototype), _applyDecoratedDescriptor(_class2$d.prototype, "connectedBody", [_dec5$9, _dec6$7], Object.getOwnPropertyDescriptor(_class2$d.prototype, "connectedBody"), _class2$d.prototype), _applyDecoratedDescriptor(_class2$d.prototype, "enableCollision", [_dec7$5], Object.getOwnPropertyDescriptor(_class2$d.prototype, "enableCollision"), _class2$d.prototype), _descriptor$d = _applyDecoratedDescriptor(_class2$d.prototype, "_enableCollision", [serializable], {
              configurable: true,
              enumerable: true,
              writable: true,
              initializer: function initializer() {
            ...
            var _dec$e, _dec2$d, _dec3$d, _dec4$d, _dec5$a, _dec6$8, _dec7$6, _dec8$4, _dec9$3, _class$e, _class2$e, _descriptor$e, _descriptor2$b, _descriptor3$7, _temp$e;
            var HingeConstraint = exports('H', (_dec$e = ccclass('cc.HingeConstraint'), _dec2$d = help('i18n:cc.HingeConstraint'), _dec3$d = menu('Physics/HingeConstraint(beta)'), _dec4$d = type(Vec3), _dec5$a = type(Vec3), _dec6$8 = type(Vec3), _dec7$6 = formerlySerializedAs('axisA'), _dec8$4 = formerlySerializedAs('pivotA'), _dec9$3 = formerlySerializedAs('pivotB'), _dec$e(_class$e = _dec2$d(_class$e = _dec3$d(_class$e = (_class2$e = (_temp$e = function (_Constraint) {
            ...
            }(Constraint), _temp$e), (_applyDecoratedDescriptor(_class2$e.prototype, "pivotA", [_dec4$d], Object.getOwnPropertyDescriptor(_class2$e.prototype, "pivotA"), _class2$e.prototype), _applyDecoratedDescriptor(_class2$e.prototype, "pivotB", [_dec5$a], Object.getOwnPropertyDescriptor(_class2$e.prototype, "pivotB"), _class2$e.prototype), _applyDecoratedDescriptor(_class2$e.prototype, "axis", [_dec6$8], Object.getOwnPropertyDescriptor(_class2$e.prototype, "axis"), _class2$e.prototype), _descriptor$e = _applyDecoratedDescriptor(_class2$e.prototype, "_axis", [serializable, _dec7$6], {
              configurable: true,
              enumerable: true,
              writable: true,
              initializer: function initializer() {
            ...
            }), _descriptor2$b = _applyDecoratedDescriptor(_class2$e.prototype, "_pivotA", [serializable, _dec8$4], {
              configurable: true,
              enumerable: true,
              writable: true,
              initializer: function initializer() {
            ...
            }), _descriptor3$7 = _applyDecoratedDescriptor(_class2$e.prototype, "_pivotB", [serializable, _dec9$3], {
              configurable: true,
              enumerable: true,
              writable: true,
              initializer: function initializer() {
            ...
            var _dec$f, _dec2$e, _dec3$e, _dec4$e, _dec5$b, _class$f, _class2$f, _descriptor$f, _descriptor2$c, _temp$f;
            var PointToPointConstraint = exports('j', (_dec$f = ccclass('cc.PointToPointConstraint'), _dec2$e = help('i18n:cc.PointToPointConstraint'), _dec3$e = menu('Physics/PointToPointConstraint(beta)'), _dec4$e = type(Vec3), _dec5$b = type(Vec3), _dec$f(_class$f = _dec2$e(_class$f = _dec3$e(_class$f = (_class2$f = (_temp$f = function (_Constraint) {
            ...
            }(Constraint), _temp$f), (_applyDecoratedDescriptor(_class2$f.prototype, "pivotA", [_dec4$e], Object.getOwnPropertyDescriptor(_class2$f.prototype, "pivotA"), _class2$f.prototype), _applyDecoratedDescriptor(_class2$f.prototype, "pivotB", [_dec5$b], Object.getOwnPropertyDescriptor(_class2$f.prototype, "pivotB"), _class2$f.prototype), _descriptor$f = _applyDecoratedDescriptor(_class2$f.prototype, "_pivotA", [serializable], {
              configurable: true,
              enumerable: true,
              writable: true,
              initializer: function initializer() {
