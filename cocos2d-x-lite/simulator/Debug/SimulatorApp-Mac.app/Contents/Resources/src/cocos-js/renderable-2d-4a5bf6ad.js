System.register(['./coordinates-converts-utils-fa8f5fc5.js', './index-b656ef93.js', './renderable-component-7d3cd284.js', './find-c704a59e.js', './json-asset-17eaf8ce.js', './event-enum-cb046afa.js', './camera-component-4e2374cc.js'], function (exports) {
    'use strict';
    var _inheritsLoose, _createClass, Pool, Color, RecyclePool, Vec2, Mat4, Rect, ccclass, displayOrder, tooltip, disallowMultiple, executeInEditMode, legacyCC, Vec3, _createForOfIteratorHelperLoose, _applyDecoratedDescriptor, help, executionOrder, menu, _initializerDefineProperty, _assertThisInitialized, warnID, Component, serializable, Size, ComparisonFunc, DepthStencilState, StencilOp, ccenum, BlendFactor, visible, type, displayName, BlendTarget, requireComponent, BlendState, director, RenderableComponent, AABB, Material, builtinResMgr, override, SystemEventType;
    return {
        ...
        execute: function () {
            ...
            }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "_contentSize", [serializable], {
              configurable: true,
              enumerable: true,
              writable: true,
              initializer: function initializer() {
            ...
            }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "_anchorPoint", [serializable], {
              configurable: true,
              enumerable: true,
              writable: true,
              initializer: function initializer() {
            ...
            var _dec$1, _dec2$1, _dec3$1, _dec4$1, _dec5$1, _dec6$1, _dec7$1, _dec8$1, _dec9$1, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _class$1, _class2$1, _descriptor$1, _descriptor2$1, _descriptor3$1, _descriptor4, _descriptor5, _class3$1, _temp$1;
            ccenum(BlendFactor);
            ...
            var Renderable2D = exports('R', (_dec$1 = ccclass('cc.Renderable2D'), _dec2$1 = requireComponent(UITransform), _dec3$1 = visible(false), _dec4$1 = type(Material), _dec5$1 = type(Material), _dec6$1 = displayOrder(0), _dec7$1 = displayName('CustomMaterial'), _dec8$1 = visible(function () {
              if (this._customMaterial) {
                return false;
              }

              return true;
            }), _dec9$1 = type(BlendFactor), _dec10 = displayOrder(0), _dec11 = tooltip('Source blend factor'), _dec12 = visible(function () {
              if (this._customMaterial) {
                return false;
              }

              return true;
            }), _dec13 = type(BlendFactor), _dec14 = displayOrder(1), _dec15 = tooltip('destination blend factor'), _dec16 = displayOrder(2), _dec17 = tooltip('渲染颜色'), _dec$1(_class$1 = _dec2$1(_class$1 = disallowMultiple(_class$1 = executeInEditMode(_class$1 = (_class2$1 = (_temp$1 = _class3$1 = function (_RenderableComponent) {
            ...
            }), _applyDecoratedDescriptor(_class2$1.prototype, "customMaterial", [_dec5$1, _dec6$1, _dec7$1], Object.getOwnPropertyDescriptor(_class2$1.prototype, "customMaterial"), _class2$1.prototype), _applyDecoratedDescriptor(_class2$1.prototype, "srcBlendFactor", [_dec8$1, _dec9$1, _dec10, _dec11], Object.getOwnPropertyDescriptor(_class2$1.prototype, "srcBlendFactor"), _class2$1.prototype), _applyDecoratedDescriptor(_class2$1.prototype, "dstBlendFactor", [_dec12, _dec13, _dec14, _dec15], Object.getOwnPropertyDescriptor(_class2$1.prototype, "dstBlendFactor"), _class2$1.prototype), _applyDecoratedDescriptor(_class2$1.prototype, "color", [_dec16, _dec17], Object.getOwnPropertyDescriptor(_class2$1.prototype, "color"), _class2$1.prototype), _descriptor3$1 = _applyDecoratedDescriptor(_class2$1.prototype, "_srcBlendFactor", [serializable], {
              configurable: true,
              enumerable: true,
              writable: true,
              initializer: function initializer() {
