System.register(['./coordinates-converts-utils-66b3c6fc.js', './index-5105ded5.js', './renderable-component-48f15197.js', './find-2b085df6.js', './json-asset-a4190905.js', './texture-buffer-pool-7b8e83ba.js', './view-fe42d2a1.js', './event-enum-a28dcb7d.js', './screen-2fb2395b.js', './camera-component-7b3db7ad.js', './sprite-frame-b5395794.js', './sprite-a03197dc.js', './renderable-2d-03c177c4.js', './graphics-25d2f02c.js', './vertex-format-2d59049f.js', './deprecated-7610334f.js'], function (exports) {
  'use strict';
  var Mat4, Vec2, ccenum, ccclass, type, displayOrder, tooltip, visible, range, _inheritsLoose, _createClass, _initializerDefineProperty, _assertThisInitialized, Color, Vec3, legacyCC, BufferInfo, BufferUsageBit, MemoryUsageBit, PrimitiveMode, _applyDecoratedDescriptor, slide, help, executionOrder, menu, warnID, clamp, serializable, _createForOfIteratorHelperLoose, executeInEditMode, requireComponent, Component, Pool, assert, multiline, RenderPriority, InputAssemblerInfo, IAPool, NULL_HANDLE, Layers, BatchPool2D, BatchView2D, PassPool, editable, clampf, js, director, assetManager, MaterialInstance, Model, Node, builtinResMgr, RenderingSubMesh, override, Pass, Game, SystemEventType, PrivateNode, SpriteFrame, Label, HorizontalTextAlignment, Font, CacheMode, SpriteAtlas, TTFFont, Sprite, fragmentText, BASELINE_RATIO, isUnicodeCJK, isUnicodeSpace, VerticalTextAlignment, InstanceMaterialType, Stage, Renderable2D, UITransform, Graphics, getAttributeStride, vfmt, getComponentPerVertex, vfmtPosUvColor, UIComponent;
  return {
    ...
    execute: function () {
      ...
      var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _class3, _temp;
      ...
      var Mask = exports('a', (_dec = ccclass('cc.Mask'), _dec2 = help('i18n:cc.Mask'), _dec3 = executionOrder(110), _dec4 = menu('2D/Mask'), _dec5 = type(MaskType), _dec6 = displayOrder(10), _dec7 = tooltip('遮罩类型'), _dec8 = displayOrder(14), _dec9 = tooltip('反向遮罩'), _dec10 = visible(function () {
        ...
        return this.type === MaskType.IMAGE_STENCIL;
      }), _dec14 = range([0, 1, 0.1]), _dec15 = visible(false), _dec16 = visible(false), _dec17 = visible(false), _dec18 = visible(false), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (_class2 = (_temp = _class3 = function (_Renderable2D) {
      ...
      var RichText = exports('R', (_dec$2 = ccclass('cc.RichText'), _dec2$2 = help('i18n:cc.RichText'), _dec3$2 = executionOrder(110), _dec4$2 = menu('2D/RichText'), _dec5$2 = tooltip('富文本显示的文本内容'), _dec6$2 = type(HorizontalTextAlignment), _dec7$2 = tooltip('文本内容的水平对齐方式'), _dec8$1 = tooltip('富文本字体大小'), _dec9$1 = tooltip('富文本定制系统字体'), _dec10$1 = type(Font), _dec11$1 = tooltip('富文本定制字体'), _dec12$1 = tooltip('是否使用系统字体'), _dec13$1 = type(CacheMode), _dec14$1 = tooltip('文本缓存模式, 该模式只支持系统字体。'), _dec15$1 = tooltip('富文本的最大宽度'), _dec16$1 = tooltip('富文本行高'), _dec17$1 = type(SpriteAtlas), _dec18$1 = tooltip('对于 img 标签里面的 src 属性名称，都需要在 imageAtlas 里面找到一个有效的 spriteFrame，否则 img tag 会判定为无效'), _dec19 = tooltip('选中此选项后，RichText 将阻止节点边界框中的所有输入事件（鼠标和触摸），从而防止输入事件穿透到底层节点'), _dec$2(_class$2 = _dec2$2(_class$2 = _dec3$2(_class$2 = _dec4$2(_class$2 = executeInEditMode(_class$2 = (_class2$2 = (_temp$2 = _class3$1 = function (_UIComponent) {
      ...
      var _dec$4, _dec2$4, _dec3$4, _dec4$4, _dec5$3, _dec6$3, _dec7$3, _class$4, _class2$3, _temp$4;
      var UIStaticBatch = exports('b', (_dec$4 = ccclass('cc.UIStaticBatch'), _dec2$4 = help('i18n:cc.UIStaticBatch'), _dec3$4 = menu('2D/UIStaticBatch'), _dec4$4 = executionOrder(110), _dec5$3 = visible(false), _dec6$3 = visible(false), _dec7$3 = visible(false), _dec$4(_class$4 = _dec2$4(_class$4 = _dec3$4(_class$4 = _dec4$4(_class$4 = (_class2$3 = (_temp$4 = function (_Renderable2D) {
      ...
      }(Renderable2D), _temp$4), (_applyDecoratedDescriptor(_class2$3.prototype, "dstBlendFactor", [override, _dec5$3], Object.getOwnPropertyDescriptor(_class2$3.prototype, "dstBlendFactor"), _class2$3.prototype), _applyDecoratedDescriptor(_class2$3.prototype, "srcBlendFactor", [override, _dec6$3], Object.getOwnPropertyDescriptor(_class2$3.prototype, "srcBlendFactor"), _class2$3.prototype), _applyDecoratedDescriptor(_class2$3.prototype, "color", [override, _dec7$3], Object.getOwnPropertyDescriptor(_class2$3.prototype, "color"), _class2$3.prototype)), _class2$3)) || _class$4) || _class$4) || _class$4) || _class$4));

      var _dec$5, _dec2$5, _dec3$5, _dec4$5, _dec5$4, _dec6$4, _dec7$4, _dec8$2, _class$5, _class2$4, _descriptor$3, _descriptor2$3, _descriptor3$2, _temp$5;
      var LabelShadow = exports('c', (_dec$5 = ccclass('cc.LabelShadow'), _dec2$5 = help('i18n:cc.LabelShadow'), _dec3$5 = executionOrder(110), _dec4$5 = menu('UI/LabelShadow'), _dec5$4 = requireComponent(Label), _dec6$4 = tooltip('描边的颜色'), _dec7$4 = tooltip('字体与阴影的偏移'), _dec8$2 = tooltip('阴影的模糊程度'), _dec$5(_class$5 = _dec2$5(_class$5 = _dec3$5(_class$5 = _dec4$5(_class$5 = _dec5$4(_class$5 = executeInEditMode(_class$5 = (_class2$4 = (_temp$5 = function (_Component) {
      ...
      }), _applyDecoratedDescriptor(_class2$4.prototype, "color", [_dec6$4], Object.getOwnPropertyDescriptor(_class2$4.prototype, "color"), _class2$4.prototype), _applyDecoratedDescriptor(_class2$4.prototype, "offset", [_dec7$4], Object.getOwnPropertyDescriptor(_class2$4.prototype, "offset"), _class2$4.prototype), _applyDecoratedDescriptor(_class2$4.prototype, "blur", [_dec8$2], Object.getOwnPropertyDescriptor(_class2$4.prototype, "blur"), _class2$4.prototype)), _class2$4)) || _class$5) || _class$5) || _class$5) || _class$5) || _class$5) || _class$5));
