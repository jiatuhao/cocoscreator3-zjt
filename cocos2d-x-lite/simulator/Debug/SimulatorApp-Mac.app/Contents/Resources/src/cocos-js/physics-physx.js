System.register(['./coordinates-converts-utils-fa8f5fc5.js', './index-b656ef93.js', './renderable-component-7d3cd284.js', './find-c704a59e.js', './json-asset-17eaf8ce.js', './transform-utils-c1853224.js', './view-d66ebab1.js', './event-enum-cb046afa.js', './screen-0172c27e.js', './camera-component-4e2374cc.js', './factory-7b08f108.js', './mesh-dc73eca6.js', './skeleton-a4f2c933.js', './index-ae85fe5a.js', './collision-matrix-7aaaf8d8.js', './terrain-asset-2a0aabc0.js', './util-34db8da1.js', './tuple-dictionary-c7e9eb93.js', './cylinder-380fdfa7.js'], function () {
    'use strict';
    var Vec3, Quat, legacyCC, _createClass, fastRemoveAt, error, _inheritsLoose, absMax, AttributeName, TransformBit, AABB, PhysicsSystem, selector, ERigidBodyType, PhysicsGroup, EAxisDirection, shrinkPositions, VEC3_0, TriggerEventObject, CollisionEventObject, TupleDictionary, cylinder;
    return {
              ...
              _proto._switchActor = function _switchActor(isStaticBefore) {
                ...
                if (isStaticBefore) {
                  ...
                  for (var _i = 0; _i < this.wrappedShapes.length; _i++) {
                    center.subtract(this.wrappedShapes[_i].collider.center);
                  }
            ...
            var PhysXShape = function () {
              ...
              _proto.getSharedMaterial = function getSharedMaterial(v) {
                if (!PX.CACHE_MAT[v._uuid]) {
                  ...
                  PX.CACHE_MAT[v._uuid] = _mat;
                  return _mat;
                }

                var mat = PX.CACHE_MAT[v._uuid];
              ...
              _proto.getAABB = function getAABB(v) {
                var b3 = getShapeWorldBounds(this.impl, this._sharedBody.impl, 1);
