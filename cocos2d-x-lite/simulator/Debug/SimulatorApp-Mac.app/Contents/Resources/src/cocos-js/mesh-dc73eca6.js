System.register(['./coordinates-converts-utils-fa8f5fc5.js', './find-c704a59e.js', './json-asset-17eaf8ce.js'], function (exports) {
    'use strict';
    var _createClass, assertIsTrue, UBOMorph, legacyCC, assertIsNonNullable, warn, _createForOfIteratorHelperLoose, AttributeName, BufferInfo, BufferUsageBit, MemoryUsageBit, Feature, nextPow2, log2, UNIFORM_TANGENT_MORPH_TEXTURE_BINDING, UNIFORM_NORMAL_MORPH_TEXTURE_BINDING, UNIFORM_POSITION_MORPH_TEXTURE_BINDING, Vec3, ccclass, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, Quat, FormatInfos, getTypedArrayConstructor, Format, Asset, _applyDecoratedDescriptor, FormatType, murmurhash2_32_gc, warnID, Attribute, serializable, sys, AABB, ImageAsset, Texture2D, samplerLib, RenderingSubMesh;
    return {
        setters: [function (module) {
            _createClass = module.dS;
            assertIsTrue = module.fn;
            UBOMorph = module.fo;
            legacyCC = module.l;
            ...
            nextPow2 = module.fp;
            log2 = module.fq;
            UNIFORM_TANGENT_MORPH_TEXTURE_BINDING = module.fr;
            UNIFORM_NORMAL_MORPH_TEXTURE_BINDING = module.fs;
            UNIFORM_POSITION_MORPH_TEXTURE_BINDING = module.ft;
            Vec3 = module.cx;
            ccclass = module.dQ;
