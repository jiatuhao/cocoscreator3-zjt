System.register(['./coordinates-converts-utils-66b3c6fc.js', './index-5105ded5.js', './renderable-component-48f15197.js', './json-asset-a4190905.js', './texture-buffer-pool-7b8e83ba.js', './renderable-2d-03c177c4.js', './vertex-format-2d59049f.js'], function (exports) {
  'use strict';
  var ccenum, _inheritsLoose, Vec2, Color, Attribute, Format, ccclass, type, tooltip, visible, _createClass, _initializerDefineProperty, _assertThisInitialized, warnID, legacyCC, BufferInfo, BufferUsageBit, MemoryUsageBit, PrimitiveMode, _applyDecoratedDescriptor, editable, help, executionOrder, menu, serializable, director, Model, builtinResMgr, RenderingSubMesh, override, MeshRenderData, InstanceMaterialType, Renderable2D, vfmtPosColor, getComponentPerVertex, getAttributeStride;
  return {
    ...
    execute: function () {
      ...
      var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _class3, _temp;
      ...
      var Graphics = exports('G', (_dec = ccclass('cc.Graphics'), _dec2 = help('i18n:cc.Graphics'), _dec3 = executionOrder(110), _dec4 = menu('2D/Graphics'), _dec5 = type(LineJoin), _dec6 = tooltip('两条线相交时，所创建的拐角类型'), _dec7 = type(LineCap), _dec8 = tooltip('线条的结束端点样式'), _dec9 = tooltip('笔触的颜色'), _dec10 = tooltip('填充绘画的颜色'), _dec11 = tooltip('最大斜接长度'), _dec12 = visible(false), _dec13 = visible(false), _dec14 = visible(false), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (_class2 = (_temp = _class3 = function (_Renderable2D) {
