System.register(['./coordinates-converts-utils-fa8f5fc5.js', './index-b656ef93.js', './renderable-component-7d3cd284.js', './find-c704a59e.js', './json-asset-17eaf8ce.js', './transform-utils-c1853224.js', './view-d66ebab1.js', './event-enum-cb046afa.js', './screen-0172c27e.js', './camera-component-4e2374cc.js', './factory-7b08f108.js'], function (exports) {
    'use strict';
    var errorID, legacyCC, logID, CCObject, _inheritsLoose, _createClass, macro, _assertThisInitialized, warnID, warn, engineVersion, director, Director, System, RenderableComponent, easing;
    return {
                ...
                for (var name in props) {
                  ...
                  if (value.value !== undefined && (value.easing || value.progress)) {
                    if (typeof value.easing === 'string') {
                      ...
                      if (!_easing) warnID(1031, value.easing);
                    } else {
