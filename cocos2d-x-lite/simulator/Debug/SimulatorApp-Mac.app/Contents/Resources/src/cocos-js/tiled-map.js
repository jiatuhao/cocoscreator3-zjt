System.register(['./coordinates-converts-utils-fa8f5fc5.js', './index-b656ef93.js', './renderable-component-7d3cd284.js', './find-c704a59e.js', './json-asset-17eaf8ce.js', './transform-utils-c1853224.js', './view-d66ebab1.js', './event-enum-cb046afa.js', './screen-0172c27e.js', './camera-component-4e2374cc.js', './factory-7b08f108.js', './sprite-frame-0db90c47.js', './sprite-fcdd808f.js', './renderable-2d-4a5bf6ad.js', './deprecated-677319c2.js', './ZipUtils-48b64e37.js'], function (exports) {
  'use strict';
  var ccenum, Vec2, Color, Size, Rect, _createClass, logID, errorID, ccclass, type, CCInteger, _inheritsLoose, warn, _applyDecoratedDescriptor, help, menu, _initializerDefineProperty, _assertThisInitialized, Component, Mat4, Vec3, CCBoolean, BlendFactor, requireComponent, CCString, Asset, serializable, displayOrder, executeInEditMode, _createForOfIteratorHelperLoose, sys, editable, EDITOR, SAXParser, director, Node, TextAsset, SystemEventType, PrivateNode, SpriteFrame, Label, Sprite, MeshRenderData, Renderable2D, UITransform, codec, _p;
  return {
    ...
    execute: function () {
      ...
      var TMXMapInfo = function () {
        ...
        _proto.parseXMLString = function parseXMLString(xmlStr, tilesetFirstGid) {
          ...
          for (i = 0; i < tilesets.length; i++) {
            ...
            if (tsxName) {
              ...
              var fgid = tilesetFirstGid || parseInt(selTileset.getAttribute('firstgid')) || 0;
              var tilesetSize = new Size(0, 0);
              tilesetSize.width = parseFloat(selTileset.getAttribute('tilewidth'));
              tilesetSize.height = parseFloat(selTileset.getAttribute('tileheight'));
              var firstTileOffset = selTileset.getElementsByTagName('tileoffset')[0];
              var tileOffsetX = 0;
              var tileOffsetY = 0;
                ...
                if (!tileset || collection) {
                  ...
                  if (!collection) {
                    ...
                    if (!tileset.sourceImage) {
                      var shortName = TMXMapInfo.getShortName(firstImageName);
        ...
        TMXMapInfo.getShortName = function getShortName(name) {
          name = name.replace(/\\/g, '\/');
          var splashIndex = name.lastIndexOf('/') + 1;
      ...
      var TiledTile = exports('TiledTile', (_dec = ccclass('cc.TiledTile'), _dec2 = help('i18n:cc.TiledTile'), _dec3 = menu('TiledMap/TiledTile'), _dec4 = type(CCInteger), _dec5 = type(CCInteger), _dec6 = type(CCInteger), _dec7 = type(CCInteger), _dec8 = type(CCInteger), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = (_temp = function (_Component) {
        ...
        return TiledTile;
      }(Component), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "_x", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "_y", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _applyDecoratedDescriptor(_class2.prototype, "x", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "x"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "y", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "y"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "grid", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "grid"), _class2.prototype)), _class2)) || _class) || _class) || _class));
      ...
      var _dec$3, _dec2$3, _dec3$2, _dec4$2, _dec5$1, _dec6$1, _dec7$1, _dec8$1, _class$3, _class2$2, _descriptor$1, _descriptor2$1, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _class3$1, _temp$3;
      var TiledMapAsset = exports('TiledMapAsset', (_dec$3 = ccclass('cc.TiledMapAsset'), _dec2$3 = type([TextAsset]), _dec3$2 = type([CCString]), _dec4$2 = type([SpriteFrame]), _dec5$1 = type([SpriteFrame]), _dec6$1 = type([CCString]), _dec7$1 = type([CCString]), _dec8$1 = type([Size]), _dec$3(_class$3 = (_class2$2 = (_temp$3 = _class3$1 = function (_Asset) {
      ...
      }(Asset), _class3$1.preventDeferredLoadDependents = true, _temp$3), (_descriptor$1 = _applyDecoratedDescriptor(_class2$2.prototype, "tmxXmlStr", [serializable], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      var _dec$4, _dec2$4, _dec3$3, _dec4$3, _dec5$2, _dec6$2, _class$4, _class2$3, _descriptor$2, _descriptor2$2, _descriptor3$1, _class3$2, _temp$4;
      var TiledMap = exports('TiledMap', (_dec$4 = ccclass('cc.TiledMap'), _dec2$4 = help('i18n:cc.TiledMap'), _dec3$3 = menu('TiledMap/TiledMap'), _dec4$3 = requireComponent(UITransform), _dec5$2 = type(TiledMapAsset), _dec6$2 = displayOrder(7), _dec$4(_class$4 = _dec2$4(_class$4 = _dec3$3(_class$4 = _dec4$3(_class$4 = executeInEditMode(_class$4 = (_class2$3 = (_temp$4 = _class3$2 = function (_Component) {
        ...
        return TiledMap;
      }(Component), _class3$2.Orientation = Orientation, _class3$2.Property = Property, _class3$2.TileFlag = TileFlag, _class3$2.StaggerAxis = StaggerAxis, _class3$2.StaggerIndex = StaggerIndex, _class3$2.TMXObjectType = TMXObjectType, _class3$2.RenderOrder = RenderOrder, _temp$4), (_descriptor$2 = _applyDecoratedDescriptor(_class2$3.prototype, "_tmxFile", [serializable], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      function fillByTiledNode(tiledNode, color, vbuf, left, right, top, bottom, diamondTile) {
        ...
        Mat4.copy(_mat4_temp$1, tiledNode.matrix);
